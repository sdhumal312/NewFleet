...
$("#AxleDual1").click(function() {
    ...
    $("#AxleSelect").change(function() {
        var a = document.getElementById("Axle1"),
            b = document.getElementById("Axle1_Stepney"),
            c = document.getElementById("Axle2"),
            d = document.getElementById("Axle3"),
            e = document.getElementById("Axle4"),
            f = document.getElementById("Axle5"),
            g = $(this).val();
        switch (g) {
            case "1":
                "block" == a.style.display ? a.style.display = "block" : a.style.display = "block", "block" == b.style.display ? b.style.display = "block" : b.style.display = "block", "block" == c.style.display ? c.style.display = "none" : c.style.display = "none", "block" == d.style.display ? d.style.display = "none" : d.style.display = "none", "block" == e.style.display ? e.style.display = "none" : e.style.display = "none", "block" == f.style.display ? f.style.display = "none" : f.style.display = "none";
                break;
            case "2":
                "block" == a.style.display ? a.style.display = "block" : a.style.display = "block", "block" == b.style.display ? b.style.display = "block" : b.style.display = "block", "block" == c.style.display ? c.style.display = "block" : c.style.display = "block", "block" == d.style.display ? d.style.display = "none" : d.style.display = "none", "block" == e.style.display ? e.style.display = "none" : e.style.display = "none", "block" == f.style.display ? f.style.display = "none" : f.style.display = "none";
                break;
            case "3":
                "block" == a.style.display ? a.style.display = "block" : a.style.display = "block", "block" == b.style.display ? b.style.display = "block" : b.style.display = "block", "block" == c.style.display ? c.style.display = "block" : c.style.display = "block", "block" == d.style.display ? d.style.display = "block" : d.style.display = "block", "block" == e.style.display ? e.style.display = "none" : e.style.display = "none", "block" == f.style.display ? f.style.display = "none" : f.style.display = "none";
                break;
            case "4":
                "block" == a.style.display ? a.style.display = "block" : a.style.display = "block", "block" == b.style.display ? b.style.display = "block" : b.style.display = "block", "block" == c.style.display ? c.style.display = "block" : c.style.display = "block", "block" == d.style.display ? d.style.display = "block" : d.style.display = "block", "block" == e.style.display ? e.style.display = "block" : e.style.display = "block", "block" == f.style.display ? f.style.display = "none" : f.style.display = "none";
                break;
            case "5":
                "block" == a.style.display ? a.style.display = "block" : a.style.display = "block", "block" == b.style.display ? b.style.display = "block" : b.style.display = "block", "block" == c.style.display ? c.style.display = "block" : c.style.display = "block", "block" == d.style.display ? d.style.display = "block" : d.style.display = "block", "block" == e.style.display ? e.style.display = "block" : e.style.display = "block", "block" == f.style.display ? f.style.display = "block" : f.style.display = "block";
                break;
            default:
                "block" == a.style.display ? a.style.display = "none" : a.style.display = "none", "block" == b.style.display ? b.style.display = "none" : b.style.display = "none", "block" == c.style.display ? c.style.display = "none" : c.style.display = "none", "block" == d.style.display ? d.style.display = "none" : d.style.display = "none", "block" == e.style.display ? e.style.display = "none" : e.style.display = "none", "block" == f.style.display ? f.style.display = "none" : f.style.display = "none"
        }
    })
});
$(document).ready(function() {
