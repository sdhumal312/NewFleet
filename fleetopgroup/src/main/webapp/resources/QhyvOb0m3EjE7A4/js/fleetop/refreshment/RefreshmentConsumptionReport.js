...
$(document).ready(
		function($) {
			$('button[type=submit]').click(function(e) {
				...
				$.ajax({					
					url: "getRefreshmentConsumptionReport",
					type: "POST",
					dataType: 'json',
					data: jsonObject,
...
function renderReportData(resultData) {
	...
	if(resultData.refreshmentEntryList != undefined){
		...
		$("#reportHeader").html("Refreshment Consumption Report");
		...
		setSlickData(resultData.refreshmentEntryList, columnConfiguration, tableProperties);
