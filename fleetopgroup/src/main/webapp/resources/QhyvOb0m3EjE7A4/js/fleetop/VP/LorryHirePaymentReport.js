...
$(document).ready(
		function($) {
			$('button[type=submit]').click(function(e) {
				...
				$.ajax({					
					url: "getVendorLorryPaymentDetailsReport",
					type: "POST",
					dataType: 'json',
					data: jsonObject,
...
function renderReportData(resultData) {
	...
	if(resultData.paymentList != undefined){
		console.log("resultData.vendor",resultData.paymentList);
		...
		$('#reportHeader').html('<b>Vendor Lorry Hire Payment Report</b>');
		...
		setSlickData(resultData.paymentList, columnConfiguration, tableProperties);
