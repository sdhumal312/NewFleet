...
$(function(){
	...
	$.ajax({
		url: 'getDriverRenewalReminderReport',
		type: 'POST',
		dataType : 'json',
		data : jsonObject,
		success : function(data){
			renderReportData(data,dateRange);
		},
		error : function(e){
			console.log("error ",e);
...
function renderReportData(resultData,dateRange,statusId) {
	if(resultData.list != undefined){
		...
		$("#reportHeader").html("Driver Renewal Reminder Details ");
