...
<header class="main-header ">
	...
	<nav class="navbar navbar-static-top" role="navigation">
		...
		<div class="navbar-custom-menu">
			...
			<ul class="navbar navbar-dark navbar-right">
					...
					<div class="dropdown-menu has-caret">
						<div class="container-fluid row">
							...
							<sec:authorize access="!hasAuthority('VIEW_TRIPSHEET_ONLY')">
								...
								<sec:authorize access="hasAuthority('SHOW_VEHICLE_MANUFACTURER_MASTER')">			
									<li><a href="<c:url value="/vehicleManufacturer" />">Vehicle Manufacturer </a></li>	
								</sec:authorize>
								<sec:authorize access="hasAuthority('SHOW_VEHICLE_MODEL_MASTER')">			
