...
<header class="main-header ">
	<a href="<c:url value="/open.html"/>" class="logo logominhide"> <span
		class="logo-mini"><font color="#0F0F0F">F</font><font
			color="#F89219">T</font></span> <span class="logo-lg"> <img
			alt="fleetop.com" align="middle" width="150" height="40"
			src="<c:url value="/resources/QhyvOb0m3EjE7A4/css/FleetopLogo.png"/>"></span>
	</a>
								
	<nav class="navbar navbar-static-top navbar-expand-md" style="height: 50px;" role="navigation">
		...
		<div class="collapse navbar-collapse float-left" id="navbar-collapse">
			<form class="form-inline "
				...
				<div class="form-group">
					<input type="text" class="form-control" id="navbar-search-input" name="searchvehicle"
						required="required" placeholder="Search vehicles..">
				</div>
			</form>
		</div>
		<div class="navbar-custom-menu">
			...
			<li id="rrNotificationIcon" class="dropdown messages-menu hide">
				<a href="javascript:void(0)" id="unReadRRNotifications" class="dropdown-toggle"
					data-toggle="dropdown" aria-expanded="false"> 
					<i class="fa fa-bell"></i> 
					<span class="badge badge-pill badge-success" id="renewalNotificationCount" onclick="getRRNotificationList();"></span>
				</a>
			</li>
			</sec:authorize>
			...
			<li class="dropdown messages-menu"><a href="javascript:void(0)"
				...
				aria-expanded="false"> <i class="fa fa-info"></i> <span
					class="label label-success" style="top: -10px;" id="notificationCount" onclick="getUserNotificationList();"></span>
				</a>
			</li>
			<li class="dropdown messages-menu"><a href="javascript:void(0)"
				id="unReadMeassage" class="dropdown-toggle" data-toggle="dropdown"
				aria-expanded="false"> <i class="fa fa-envelope"></i> <span
					class="label label-success" style="top: -10px;" id="Unread">${unread}</span>
			</a>
						...
						<div class="container-fluid">
							...
							<sec:authorize access="hasAuthority('VIEW_PRIVILEGE')">
								...
								<ul class="col-md-3 col-sm-3 col-xs-3 mega-dd-col">
									...
									<li class="divider"></li>
									<li class="dropdown-header">Reminder Settings</li>
									<li><a href="<c:url value="/addRenewalType.in"/>">Renewal
											Types</a></li>
									<li><a href="<c:url value="/addRenewalSubType.in"/>">Renewal
											Sub Types</a></li>
									<li class="divider"></li>
									<li class="dropdown-header">Parts Settings</li>
						...
						<li class="user-footer">
							<div class="pull-left">
								<a href="<c:url value="/UserProfile"/>"
									class="btn btn-secondary btn-flat"><spring:message
