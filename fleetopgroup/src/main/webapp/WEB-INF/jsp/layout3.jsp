...
<link rel="stylesheet" href="resources/QhyvOb0m3EjE7A4/css/bootstrap/v4/bootstrap.min.css">
...
<script type="text/javascript"
	src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/fleetop.js" />"></script>
	 <!-- Popper.JS -->
    <script type="text/javascript" src="resources/QhyvOb0m3EjE7A4/js/bootstrap/v4/popper.min.js"></script>
<script type="text/javascript" src="resources/QhyvOb0m3EjE7A4/js/bootstrap/v4/bootstrap.js"></script>
<!-- Slimscroll -->
<script
