							...
							<form action="<c:url value="/SRIsearchCashBookShow.in"/>"
								...
								<div class="input-group">
									<span class="input-group-addon"> <span
										...
										min="1" required="required" placeholder="C-ID eg:67">
		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('VIEW_CASHBOOK')">
				<div class="main-body">
					...
					<c:url var="firstUrl" value="/SRICashBook/${SelectCashBook}/1" />
					<c:url var="lastUrl"
						value="/SRICashBook/${SelectCashBook}/${deploymentLog.totalPages}" />
					<c:url var="prevUrl"
						value="/SRICashBook/${SelectCashBook}/${currentIndex - 1}" />
					<c:url var="nextUrl"
						value="/SRICashBook/${SelectCashBook}/${currentIndex + 1}" />
					<div class="text-center">
						<ul class="pagination pagination-lg pager">
							...
							<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
								<c:url var="pageUrl" value="/SRICashBook/${SelectCashBook}/${i}" />
								<c:choose>
