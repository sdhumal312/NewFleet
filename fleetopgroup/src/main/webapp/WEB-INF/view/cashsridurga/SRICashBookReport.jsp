			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open"/>"><spring:message
						...
						href="<c:url value="/SRICashBook/1.in"/>">Cash Book</a> / <a
						href="<c:url value="/SRICashBookReport.in"/>">CashBook Report</a> / <span>
						Search Report</span>
				</div>
												...
												<td><c:if test="${CashBook.CASH_STATUS_ID == 1}">
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-right">
															...
															<li><sec:authorize access="hasAuthority('EDIT_CASHBOOK')">
																	<a
