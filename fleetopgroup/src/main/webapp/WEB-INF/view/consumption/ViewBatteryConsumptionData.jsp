		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					<a id="cancel" href="#">Consumption</a> / Battery Consumption
				</div>
		...
		<!-- <div class="col-md-7 "> -->
				...
				<div id="fuelConsumptionDiv" class="col-sm-3 stretch-card grid-margin">
					<div class="card bg-gradient-greenThree card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
								Battery Total Amount <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
			...
			<div class="row">
				...
				<div class="table-responsive">
					<table class="table">
					<thead>
						<tr class="bg-gradient-greenThree text-white">
							<th class="fit ar">Serial Number</th>
...
<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/consumption/viewBatteryConsumptionData.js"/>"></script>
