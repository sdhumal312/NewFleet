		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					<a id="cancel" href="#">Consumption</a> / WorkOrder Consumption
				</div>
					...
					<div class="card bg-gradient-success card-img-holder text-white  ">
						<div class="card-body">
							...
							<h4 class="font-weight-normal mb-3">	
							 WO-Part Entry Count <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
				...
				<div id="fuelConsumptionDiv" class="col-sm-3 stretch-card grid-margin">
					<div class="card bg-gradient-success card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
								WO-Part Total Consumption <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
				...
				<div id="fuelConsumptionDiv" class="col-sm-3 stretch-card grid-margin">
					<div class="card bg-gradient-success card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
								WO Total Amount <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
				...
				<div class="table-responsive">
					...
					<thead>
						<tr class="bg-gradient-success text-white">
							<th class="fit ar">WorkOrder Number</th>
...
<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/consumption/viewWorkOrderConsumptionData.js"/>"></script>
