		...
		<section class="content-header">
			<div class="box">
				<div class="box-body">
					<div class="pull-left">
						...
						<a id="cancel" href="#">Work Summary</a> / WorkOrder Summary
					</div>
					<div class="pull-right">
						
						<button class="btn btn-default btn-sm hide"
							onclick="advanceTableToExcel('tripCollectionExpenseList', 'WO Summary Data Report')"
							id="exportExcelBtn">
		  ...
		  <div class="row">
          		<div class="col-md-4 stretch-card grid-margin">
					...
					<i class="fa fa-file-text-o"></i> <span>WorkOrders Created</span>
                			</h4>
                			<h2 class="mb-4" id="workOrderCreatedCounts" ></h2>
              			</div>
            		</div>
          		</div>
    	  </div>
				              	...
				              	<div class="row1">
									...
									<div class="I-size">
										<div class="input-group">
											...
											style="cursor: pointer; padding: 5px 5px; border: 1px solid #ccc; width: 100%" onChange="getAllWorkOrderCountData();">
       		...
       		<div class="row" style="margin-top: 2%;">
             	...
             	<div class="col-md-6 stretch-card grid-margin">
               		<div class="card bg-gradient-test96 card-img-holder1 text-white" onclick="showTripDetails(1);">
						 ...
						 <i class="fa fa-file-text-o"></i> <span>Open</span>
                   			...
                   			<h2 class="mb-8" id="workOrderOpenCounts"></h2>
                 			</div>
               		</div>
             	</div>
             	
             	<div class="col-md-6 stretch-card grid-margin">
               		<div class="card bg-gradient-test95 card-img-holder1 text-white" onclick="showTripDetails(2);">
                			 <div class="card-body">
                   			<h4 class="font-weight-normal mb-7">
						 <i class="fa fa-file-text-o"></i> <span>In Process</span>
                   			</h4>
                   			<h2 class="mb-8" id="workOrderProcessCount"></h2>
                 			</div>
               		</div>
             	</div>
             	
             	<div class="col-md-6 stretch-card grid-margin">
               		<div class="card bg-gradient-test98 card-img-holder1 text-white" onclick="showTripDetails(3);">
                			 <div class="card-body">
                   			<h4 class="font-weight-normal mb-7">
						 <i class="fa fa-file-text-o"></i> <span>Hold</span>
                   			</h4>
                   			<h2 class="mb-8" id="workOrderHoldCount"></h2>
                 			</div>
               		</div>
             	</div>
             	...
             	<div class="col-md-6 stretch-card grid-margin">
               		<div class="card bg-gradient-test97 card-img-holder1 text-white" onclick="showTripDetails(4);">
                			 <div class="card-body">
                   			<h4 class="font-weight-normal mb-7">
						 		<i class="fa fa-file-text-o"></i> <span>Completed</span>
                   			</h4>
                   			<h2 class="mb-8" id="workOrderCloseCounts"></h2>
                 			</div>
               		</div>
             	</div>
						...
						<div class="box">
							<div class="box-body">
								<div class="row " style="margin-top: 2%;  padding:10px;">
									<table id="locationTable" class="table table-hover" width="100%">
									</table>
								</div>
							</div>
						</div>
					...
					<div class="box-body">
						...
						<div class="button hide" id="graphButton">
						 ...
						 <div class="chart-container" id="chartContainer">
							...
							<table id="workOrdersTableDataDetails" class="table table-hover hide table-bordered" width="100%">
							</table>
						</div>
			...
			<div class="row incomeExpense" style="margin-top: 2%;">
        			<span> Total Number Of Work Order Yet To Complete As Per Today ! </span>
        	</div>
        	
        	<div class="row" style="margin-top: 2%;">
        		
              	<div class="col-md-8 stretch-card grid-margin">
                	<div class="card bg-gradient-danger card-img-holder text-white" onclick="showTripDetails(5);">
               			 <div class="card-body">
               			 	<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" class="card-img-absolute">
							<h4 class="font-weight-normal mb-9"> <i class="fa fa-file-text-o"></i> Total OverDue Count
								<i class="mdi mdi-chart-line mdi-24px float-right"></i>
							</h4>
                  			<h2 class="mb-10" id="workOrderAllOpenCounts"></h2>
                		</div>
                	</div>
              	</div>
              	
              	<div class="col-md-8 stretch-card grid-margin">
                	<div class="card bg-gradient-primary card-img-holder text-white" onclick="showTripDetails(6);">
               			 <div class="card-body">
               			 	<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" class="card-img-absolute">
							<h4 class="font-weight-normal mb-9"> <i class="fa fa-file-text-o"></i> 0-7 Days
								<i class="mdi mdi-chart-line mdi-24px float-right"></i>
							</h4>
              	...
              	<div class="col-md-8 stretch-card grid-margin">
                	<div class="card bg-gradient-success card-img-holder text-white" onclick="showTripDetails(7);">
               			 <div class="card-body">
               			 	<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" class="card-img-absolute">
							<h4 class="font-weight-normal mb-9"> <i class="fa fa-file-text-o"></i> 8-15 Days
								<i class="mdi mdi-chart-line mdi-24px float-right"></i>
							</h4>
              	...
              	<div class="col-md-8 stretch-card grid-margin">
                	<div class="card bg-gradient-info card-img-holder text-white" onclick="showTripDetails(8);">
               			 <div class="card-body">
               			 	<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" class="card-img-absolute">
							<h4 class="font-weight-normal mb-9"> <i class="fa fa-file-text-o"></i> 15+ Days
								<i class="mdi mdi-chart-line mdi-24px float-right"></i>
							</h4>
...
<!-- <table width="100%">
	<tr>
		<td width="60%" valign="top"> -->
			<div class="row ">
				<div class="col-md-5 stretch-card grid-margin">
					<div class="card bg-gradient-blue  card-img-holder2 text-white"
						onclick="showTripDetails(0);">
						<div class="card-body">
							<h4 class="font-weight-normal title">
								<i class="fa fa-file-text-o"></i> <span>WorkOrders Created
								</span>
							</h4>
							<h2 class="count-size" id="workOrderCreatedCounts"></h2>
						</div>
					</div>
				</div>
				<div class="col-md-6" width="100%" style="padding-top:2%;">
					<div class="card bg-gradient-white card-img-holder1 text-white" valign="top">
						<div id="proBanner">
									...
									<div class="I-size">
										<div class="input-group">
											...
											<input type="text" id="dateRange" class="form-text"
												...
												onchange="getAllWorkOrderCountData();"> <input
			...
			<div class="row pendingLabel" style="margin-top: 2%;">
        			<span> Status & Location Wise Work Order Created Within Selected Date Range !</span>
        	</div>
				...
				<div class="col-md-4 stretch-card grid-margin">
					<div class="card bg-gradient-green card-img-holder text-white"
						...
						<div class="card-body">
							...
							<h2 class="count-size" id="workOrderOpenCounts"></h2>
						</div>
					</div>
				</div>
				<div class="col-md-4 stretch-card grid-margin">
					<div class="card bg-gradient-green card-img-holder text-white"
						...
						<div class="card-body">
							...
							<h2 class="count-size" id="workOrderProcessCount"></h2>
						</div>
					</div>
				</div>
				<div class="col-md-4 stretch-card grid-margin">
					<div class="card bg-gradient-green card-img-holder text-white"
						...
						<div class="card-body">
							...
							<h2 class="count-size" id="workOrderHoldCount"></h2>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4 stretch-card grid-margin">
					<div class="card bg-gradient-green card-img-holder text-white"
						...
						<div class="card-body">
							...
							<h2 class="count-size" id="workOrderCloseCounts"></h2>
						</div>
					</div>
				</div>
			</div>
			...
			<!-- <div class="row " style="margin-top: 2%;  padding:10px;">
				<div class="col-md-12" >
					<div  style="padding: 10px; overflow-x: scroll;display: block; margin-left: -28px;" >
						<table class="card bg-gradient-green card-img-holder text-white" style="overflow-wrap: anywhere;" id="locationTable" border="2" ></table> 
					</div>
				</div>
			</div> -->
			...
			<!-- <section class="table-content">
				<div class="box">
					<div class="box-body">
						...
						<div class="table-responsive scroll-box hide" id="tsTable">
							<table id="workOrdersTableDataDetails"
			...
			<div class="row incomeExpense" style="margin-top: 2%;">
        			<span> Total Number Of Work Order Yet To Complete As Per Current Date ! </span>
        	</div>
			...
			<div class="row" style="margin-top: 2%;  margin-left: -10px; margin-right: -6%; padding:15px;">
				<div class="col-md-4 stretch-card grid-margin">
					<div class="card bg-gradient-red card-img-holder text-white"
						...
						<div class="card-body">
							<h4 class="font-weight-normal title">
								<i class="fa fa-file-text-o"></i> <span>All Open</span>
							</h4>
							<h2 class="count-size" id="workOrderAllOpenCounts"></h2>
						</div>
					</div>
				</div>
				<div class="col-md-4 stretch-card grid-margin">
					<div class="card bg-gradient-red card-img-holder text-white"
						...
						<div class="card-body">
							<h4 class="font-weight-normal title">
								<i class="fa fa-file-text-o"></i> <span>0-7 Days</span>
							</h4>
				...
				<div class="col-md-4 stretch-card grid-margin">
					<div class="card bg-gradient-red card-img-holder text-white"
						...
						<div class="card-body">
							<h4 class="font-weight-normal title">
								<i class="fa fa-file-text-o"></i> <span>8-15 Days</span>
							</h4>
				...
				<div class="col-md-4 stretch-card grid-margin">
					<div class="card bg-gradient-red card-img-holder text-white"
						...
						<div class="card-body">
							<h4 class="font-weight-normal title">
								<i class="fa fa-file-text-o"></i> <span>15+ Days</span>
							</h4>
		...
		<!-- <td class="box" valign="top" style="margin-left: 2px;  height: 300px;" width="40%">
			<section class="table-content">
			<div class="box">
				<div class="box-body">
					<div class="button hide" id="graphButton">
 ...
 --%>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/summary/workOrderSummary.js"/>"></script>
