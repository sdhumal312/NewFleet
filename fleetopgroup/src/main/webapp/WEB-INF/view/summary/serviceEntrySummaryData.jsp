...
<div class="content-wrapper">
					...
					<div class="box">
						<div class="box-body">
							<div class="pull-left">
								...
								<a id="cancel" href="#">Work Summary</a> / ServiceEntry Summary
							</div>
							<div class="pull-right">
								
								<button class="btn btn-default btn-sm hide"
									onclick="advanceTableToExcel('tripCollectionExpenseList', 'SE Summary Data Report')"
									id="exportExcelBtn">
                		...
                		<div class="card bg-gradient-test99 card-img-holder text-white" onclick="showTripDetails(0);">
                 			 <div class="card-body">
                    			<h4 class="font-weight-normal mb-3">
									<i class="fa fa-bell-slash"></i> <span>ServiceEntries Created</span>
                    			</h4>
                    			<h2 class="mb-4" id="SECreatedCounts" ></h2>
                  			</div>
                		</div>
              		</div>
        		</div>
											...
											title="required">*</abbr></label>
												<div class="I-size">
													<div class="input-group">
														...
														style="cursor: pointer; padding: 5px 5px; border: 1px solid #ccc; width: 100%" onChange="getAllserviceEntryCountData();">
        		...
        		<div class="row" style="margin-top: 2%;">
              		...
              		<div class="col-md-6 stretch-card grid-margin">
                		<div class="card bg-gradient-test96 card-img-holder1 text-white" onclick="showTripDetails(1);">
							 ...
							 <i class="fa fa-bell-slash"></i> <span>Open</span>
                    			</h4>
                    			<h2 class="mb-8" id="SEOpenCounts"></h2>
                  			</div>
                		</div>
              		</div>
              		...
              		<div class="col-md-6 stretch-card grid-margin">
                		<div class="card bg-gradient-test95 card-img-holder1 text-white" onclick="showTripDetails(2);">
                 			 <div class="card-body">
                    			<h4 class="font-weight-normal mb-7">
							 <i class="fa fa-bell-slash"></i> <span>In Process</span>
                    			</h4>
                    			<h2 class="mb-8" id="SEProcessCount"></h2>
                  			</div>
                		</div>
              		</div>
              		...
              		<div class="col-md-6 stretch-card grid-margin">
                		<div class="card bg-gradient-test98 card-img-holder1 text-white" onclick="showTripDetails(3);">
                 			 <div class="card-body">
                    			<h4 class="font-weight-normal mb-7">
							 <i class="fa fa-bell-slash"></i> <span>Complete</span>
                    			</h4>
                    			<h2 class="mb-8" id="SECloseCounts"></h2>
                  			</div>
                		</div>
              		</div>
        		...
        		<div class="row" >
	        		<div class="row incomeExpense" style="margin-top: 2%;">
	        			<span> Service Entry Payment Due As Per Today !</span>
	        		</div>
	        	</div>
	        	...
	        	<div class="row" style="margin-top: 2%;">
              		...
              		<div class="col-md-7 stretch-card grid-margin">
                		<div class="card bg-gradient-test97 card-img-holder1 text-white" onclick="showTripDetails(4);">
                 			 <div class="card-body">
                    			<h4 class="font-weight-normal mb-7A">
							 <i class="fa fa-bell-slash"></i> <span>Due Payment Count & Amount</span>
                    			</h4>
                    			<h2 class="mb-49" id="duePaymentCount"></h2>
                    			<h2 class="mb-49B" id="duePaymentAmount"></h2>
                  			</div>
                		</div>
              		</div>
						...
						<div class="box-body">
							...
							<div class="button hide" id="graphButton">
							 ...
							 <div class="chart-container" id="chartContainer">
								...
								<table id="serviceEntrryTableDataDetails" class="table table-hover hide table-bordered " width="100%">
								</table>
							</div>
				...
				<div class="row" >
	        		<div class="row incomeExpense1" style="margin-top: 2%;">
	        			<span> Service Entry Pending Work As Per Today !</span>
	        		</div>
	        	</div>	
        		...
        		<div class="row" style="margin-top: 2%;">
              		...
              		<div class="col-md-8 stretch-card grid-margin">
                		<div class="card bg-gradient-danger card-img-holder text-white" onclick="showTripDetails(5);">
                 			 <div class="card-body">
								...
								<h4 class="font-weight-normal mb-9"> <i class="fa fa-bell-slash"></i> Total OverDue Count
									<i class="mdi mdi-chart-line mdi-24px float-right"></i>
								</h4>
                    			<h2 class="mb-10" id="SEAllOpenCounts"></h2>
                  			</div>
                		</div>
              		</div>
              		...
              		<div class="col-md-8 stretch-card grid-margin">
                		<div class="card bg-gradient-primary card-img-holder text-white" onclick="showTripDetails(6);">
                 			 <div class="card-body">
                 			 	<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" class="card-img-absolute">
								<h4 class="font-weight-normal mb-9"> <i class="fa fa-bell-slash"></i> 0-7 Days
									<i class="mdi mdi-chart-line mdi-24px float-right"></i>
								</h4>
              		...
              		<div class="col-md-8 stretch-card grid-margin">
                		<div class="card bg-gradient-success card-img-holder text-white" onclick="showTripDetails(7);">
                 			 <div class="card-body">
                 			 	<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" class="card-img-absolute">
								<h4 class="font-weight-normal mb-9"> <i class="fa fa-bell-slash"></i> 8-15 Days
									<i class="mdi mdi-chart-line mdi-24px float-right"></i>
								</h4>
              		...
              		<div class="col-md-8 stretch-card grid-margin">
                		<div class="card bg-gradient-info card-img-holder text-white" onclick="showTripDetails(8);">
                 			 <div class="card-body" id="oldestTrip">
                 			 	<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" class="card-img-absolute">
								<h4 class="font-weight-normal mb-9"> <i class="fa fa-bell-slash"></i> 15+ Days
									<i class="mdi mdi-chart-line mdi-24px float-right"></i>
								</h4>
...
<%-- <table width="100%">
	<tr>
		<td width="60%" valign="top">
					...
					<div class="card bg-gradient-blue  card-img-holder text-white"
						...
						<div class="card-body">
							<h4 class="font-weight-normal title">
								<i class="fa fa-bell-slash"></i> <span>ServiceEntries Created
								</span>
							</h4>
							<h2 class="count-size" id="SECreatedCounts"></h2>
						</div>
					</div>
				</div>
									...
									<div class="I-size">
										<div class="input-group">
											...
											<input type="text" id="dateRange" class="form-text"
												...
												onchange="getAllserviceEntryCountData();"> <input
			...
			<div class="row pendingLabel" style="margin-top: 2%;">
        			<span> Status Of Service Entries Created Within Selected Date Range !</span>
        	</div>
			...
			<div class="row" style="margin-top: 2%;  margin-left: -18px; margin-right: -6%; padding:15px;">
				<div class="col-lg-4 stretch-card grid-margin" style="width:28.2%;">
					<div class="card bg-gradient-green card-img-holder text-white" style="padding-rigth:10px	"
						onclick="showTripDetails(1);">
						<div class="card-body">
							<h4 class="font-weight-normal title">
								<i class="fa fa-bell-slash"></i> <span>Open</span>
							</h4>
							<h2 class="count-size" id="SEOpenCounts"></h2>
						</div>
					</div>
				</div>
				<div class="col-lg-4 stretch-card grid-margin" style="width:28.2%;">
					...
					onclick="showTripDetails(2);">
						<div class="card-body">
							...
							<h2 class="count-size" id="SEProcessCount"></h2>
						</div>
					</div>
				</div>
				<div class="col-lg-4 stretch-card grid-margin" style="width:28.2%;">
					...
					onclick="showTripDetails(3);">
						<div class="card-body">
							...
							<h2 class="count-size" id="SECloseCounts"></h2>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row incomeExpense" style="margin-top: 2%;">
        			<span> Total Number Of Service Entries Yet To Complete As Per Current Date ! </span>
        	</div>
			...
			<div class="row" style="margin-top: 2%;  margin-left: -10px; margin-right: -6%; padding:15px;">
				<div class="col-md-4 stretch-card grid-margin">
					<div class="card bg-gradient-red card-img-holder text-white"
						...
						<div class="card-body">
							<h4 class="font-weight-normal title">
								<i class="fa fa-bell-slash"></i> <span>All Open</span>
							</h4>
							<h2 class="count-size" id="SEAllOpenCounts"></h2>
						</div>
					</div>
				</div>
				<div class="col-md-4 stretch-card grid-margin">
		...
		<!-- 	<div class="box"> -->
				<div class="box-body">
					...
					<div class="table-responsive scroll-box hide" id="tsTable">
						<table id="serviceEntrryTableDataDetails"
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/summary/serviceEntrySummary.js"/>"></script>
