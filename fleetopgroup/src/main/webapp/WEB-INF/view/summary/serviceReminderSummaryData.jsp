...
<div class="content-wrapper">
			...
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'SR Summary Data Report')" id="exportExcelBtn">
						...
						<div class="I-size">
							<div class="input-group">
								...
								<input type="hidden" id="dateRange" class="form-text" 
									...
									style="cursor: pointer; padding: 5px 5px; border: 1px solid #ccc; width: 100%" onchange="getServiceReminderData();">
									<input type ="hidden" id="preDateRange" value="${DateRange}">
							</div>
						</div>
					</div>
					
					<input type="hidden" id="dateRange" class="form-text" name="tripEndDateTimeStr" required="required" readonly=""
					style="cursor: pointer; padding: 5px 5px; border: 1px solid #ccc; width: 100%" onchange="getServiceReminderData();">
					<input type ="hidden" id="preDateRange" value="${DateRange}">
       			 </div>
			</div>
	...
	<!-- </section> -->	
				...
				<div class="row" >
					<div class="row pendingLabel" >
	        			<span> Service Reminder Details As Per Today ! </span>
	        		</div>
	        	</div>			
				...
				<div class="row" style="margin-top: 1%;">
              		...
              		<div class="col-md-3 stretch-card grid-margin">
                		<div class="card  card-img-holder text-white " onclick="showSRDetails(1);">
                 			 <div class="card-body">
                 			 	<table>
                 			 		<tr>
                 			 			<td>
                 			 			...
                 			 			<td>
                 			 				<h6 class="mb-3">Vehicles With SR</h6>
                 			 			</td>
                 			 		</tr>
                 			 	</table>
                 			
	                 			 <div class="row">
	                    			<h6 class="mb-4" id="serviceCreatedCount"></h6>
	                 			 </div>
              		...
              		<div class="col-md-3 stretch-card grid-margin">
                		<div class="card  card-img-holder text-white" onclick="showSRDetails(2);">
                 			 <div class="card-body">
                    			<table>
                 			 		<tr>
                 			 			<td>
                 			 			...
                 			 			<td>
                 			 				<h6 class="mb-5">Vehicles Without SR</h6>
                 			 			</td>
                 			 		</tr>
                 			 	</table>
                 			
	                 			 <div class="row">
	                    			<h6 class="mb-6" id="todaysServiceCount"></h6>
	                 			 </div>
                  			</div>
                		</div>
              		</div>
        		...
        		<div class="row" style="margin-top: 2%;">
              		...
              		<div class="col-md-3A stretch-card grid-margin">
                		<div class="card  bg-gradient-test96 card-img-holder2 text-white" onclick="showSRDetails(3);">
                 			 <div class="card-body">
                 			 	<h4 class="font-weight-normal mb-48">
							 		<i class="fa fa-bell-slash"></i> <span>Due Soon</span>
                    			</h4>
                    			<h2 class="mb-49" id="totalDueSoonCount"></h2>
                  			</div>
                		</div>
              		</div>
        		...
        		<div class="row" style="margin-top: 2%;">
              		...
              		<div class="col-md-2 stretch-card grid-margin">
                		<div class="card  bg-gradient-test98 card-img-holder2 text-white" onclick="showSRDetails(4);">
                 			 <div class="card-body">
              		...
              		<div class="col-md-2 stretch-card grid-margin">
                		<div class="card  bg-gradient-test98 card-img-holder2 text-white" onclick="showSRDetails(5);">
                 			 <div class="card-body">
                 			 	<h4 class="font-weight-normal mb-50">
              		...
              		<div class="col-md-2 stretch-card grid-margin">
                		<div class="card  bg-gradient-test98 card-img-holder2 text-white" onclick="showSRDetails(6);">
                 			 <div class="card-body">
                 			 	<h4 class="font-weight-normal mb-50">
              		...
              		<div class="col-md-2 stretch-card grid-margin">
                		<div class="card  bg-gradient-test98 card-img-holder2 text-white" onclick="showSRDetails(7);">
                 			 <div class="card-body">
                 			 	<h4 class="font-weight-normal mb-50">
					...
					<div class="box-body">
						...
						<div class="button hide" id="graphButton">
							<a class="btn bg-gradient-danger btn-sm text-white buttonStyle " onclick="backToGraph();">
		  					...
		  					<button id="printBtn" class="btn btn-default hide" onclick="printDiv('srTable')">
						 ...
						 <div class="chart-container" id="chartContainer">
		   				 ...
		   				 <div class="table-responsive scroll-box hide" id="srTable">
							<table id="srTableDataDetails" class="table table-hover hide table-bordered" width="100%">
							</table>
						</div>
						
						<!-- <div class="table-responsive scroll-box hide" id="srTable1">
							<table id="srTableDataDetails1" class="table table-hover hide " width="100%">
							</table>
						</div>
						
						<div class="table-responsive scroll-box hide" id="srTable2">
							<table id="srTableDataDetails2" class="table table-hover hide " width="100%">
							</table>
						</div> -->
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/summary/serviceReminderSummaryData.js"/>"></script>
