		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					<a id="cancel" href="#">Work Summary</a> / Tripsheet Pick And Drop Summary
				</div>
				<div class="pull-right">
					
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Fleetop')"
						id="exportExcelBtn">
		...
		<input type="hidden" id="companyId">
				...
				<div class="row">
              		<div class="col-md-4 stretch-card grid-margin">
                		<div class="card bg-gradient-test99 card-img-holder text-white" onclick="showPickDropDetails(0);">
                 			 <div class="card-body">
                    			<h4 class="font-weight-normal mb-3">
									<i class="fa fa-car"></i> <span>Pick And Drop Trips Created</span>
                    			</h4>
                    			<h2 class="mb-4" id="pickDropCreatedCounts" ></h2>
                  			</div>
                		</div>
              		</div>
        		</div>
					              	...
					              	<div class="row1">
										...
										<div class="I-size">
											<div class="input-group">
												...
												style="cursor: pointer; padding: 5px 5px; border: 1px solid #ccc; width: 100%" onChange="getAllPickAndDropCountData();">
        		...
        		<div class="row" style="margin-top: 2%;">
              		...
              		<div class="col-md-6 stretch-card grid-margin">
                		<div class="card bg-gradient-test96 card-img-holder1 text-white" onclick="showPickDropDetails(1);">
                 			 <div class="card-body">
                    			<h4 class="font-weight-normal mb-7">
							 <i class="fa fa-car"></i> <span>Vehicles With Pick And Drop </span>
                    			</h4>
                    			<h2 class="mb-8" id="vehiclesWithPickDrop"></h2>
                  			</div>
                		</div>
              		</div>
              		<div class="col-md-6 stretch-card grid-margin">
                		<div class="card bg-gradient-test95 card-img-holder1 text-white" onclick="showPickDropDetails(2);">
                 			 <div class="card-body">
                    			<h4 class="font-weight-normal mb-7">
							 <i class="fa fa-car"></i> <span>Vehicles Without Pick And Drop</span>
                    			</h4>
                    			<h2 class="mb-8" id="vehiclesWithoutPickDrop"></h2>
                  			</div>
                		</div>
              		</div>
              		<div class="col-md-6 stretch-card grid-margin">
                		<div class="card bg-gradient-test98 card-img-holder1 text-white" onclick="showPickDropDetails(3);">
                 			 <div class="card-body">
                    			<h4 class="font-weight-normal mb-7">
							 <i class="fa fa-car"></i> <span>Total Expense</span>
                    			</h4>
                    			<h2 class="mb-8" id="totalAmount"></h2>
                  			</div>
                		</div>
              		</div>
				...
				<div class="row" style="margin-top: 2%;">
              		...
              		<div class="col-md-7 stretch-card grid-margin">
                		<div class="card bg-gradient-test97 card-img-holder1 text-white" onclick="showPickDropDetails(4);">
                 			 <div class="card-body">
                    			<h4 class="font-weight-normal mb-7">
							 <i class="fa fa-car"></i> <span>Total Pick Up Trips</span>
                    			</h4>
                    			<h2 class="mb-8" id="totalPickUps"></h2>
                  			</div>
                		</div>
              		</div>
              		
              		<div class="col-md-7 stretch-card grid-margin">
                		<div class="card bg-gradient-test100 card-img-holder1 text-white" onclick="showPickDropDetails(5);">
                 			 <div class="card-body">
                    			<h4 class="font-weight-normal mb-7">
							 <i class="fa fa-car"></i> <span>Total Drop Trips</span>
                    			</h4>
                    			<h2 class="mb-8" id="totalDrops"></h2>
                  			</div>
                		</div>
              		</div>
						...
						<div class="box-body">
							...
							<div class="button hide" id="graphButton">
							 ...
							 <div class="chart-container" id="chartContainer">
								...
								<table id="rrTableDataDetails" class="table table-hover hide " width="100%">
								</table>
							</div>
        		...
        		<div class="row" style="margin-top: 2%;">
              		...
              		<div class="col-md-8 stretch-card grid-margin">
                		<div class="card bg-gradient-primary card-img-holder text-white" onclick="showTripDetails(8);">
                 			 <div class="card-body">
                 			 	<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" class="card-img-absolute">
								<h4 class="font-weight-normal mb-9"> <i class="fa fa-exclamation-circle"></i> 0-7 Days
									<i class="mdi mdi-chart-line mdi-24px float-right"></i>
								</h4>
...
<%-- <table width="100%">
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/summary/pickAndDropSummaryData.js"/>"></script>
