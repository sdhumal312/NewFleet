...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/WOR.in"/>">WorkOrder Report</a> / <span>Old Part Received Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Old Part Received Report')" id="exportExcelBtn">
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/oldPartReceivedReport.js" />"></script>
	<script
