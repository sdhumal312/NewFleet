...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/WOR.in"/>">WorkOrder Report</a> / <span>Old Part Not Received Report</span>
				</div>
				<div class="pull-right">
					<button id="printButton" style="display: none;" class="btn btn-default btn-sm"
						onclick="printDiv('div_print')">
						<span class="fa fa-print"> Print</span>
					</button>					
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Old Part Not Received Report')" id="exportExcelBtn">
								...
								<div class="table-responsive">
									...
									<div class="row invoice-info">
										<table id="advanceTable"
											...
											<caption style="text-align: center; font-weight: bold; font-size: 20px;" id="reportDetails"></caption>
											<thead id="tHeadId">
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/oldPartNotReceivedReport.js" />"></script>
	<script
