...
<div class="content-wrapper">
			...
			<div class="box-body">
				...
				<div class="pull-right">
					<%-- <div style="display: inline-block;">
						<form action="DailyClosedTSAllAdvanceReport" method="post">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Sheet Daily Closed Report')">
	...
	<section class="content">
		...
		<!--SRS Travels Closed Wise Trip Sheet Advances Report By Dev Yogi Start-->
				<sec:authorize access="hasAuthority('VIEW_CL_TS_AD_REPORT')">
					<!-- Tripsheet closed wise report -->
					<div class="tab-pane" id="TSReport">
						<div class="panel box box-primary">
							<div class="box-header with-border">
								<h4 class="box-title">
									<a data-toggle="collapse" data-parent="#accordion"
										href="#TripsheetDailyClosed">Closed wise TripSheet
										Advances Report </a>
								</h4>
							</div>
							<!-- <div id="TripsheetDailyClosed" class="panel-collapse collapse"> -->
								<div class="box-body">
									<form action="DailyClosedTSAllAdvanceReport" method="post">
													...
													<div class="I-size">
														<div class="pull-left">
															<button type="submit" name="commit"
																class="btn btn-success"  onclick="return validateClosedWiseTripSheetAdvancesReport();">
		...
		<!--SRS Travels Closed Wise Trip Sheet Advances Report By Dev Yogi End-->
		<sec:authorize access="hasAuthority('VIEW_TRIPSHEET')">
			<div id="div_print">
								...
								<c:if test="${!empty TripSheet}">
									...
									<div class="row invoice-info">
										<table id="advanceTable"
											...
											<caption>Daily Closed TripSheet Advance Report
												-${SearchDate}</caption>
											<thead>
												<tr>
													<th class="fit">No</th>
													...
													<th style="text-align: right;">Closed Date</th>
												</tr>
											</thead>
											<tbody>
												<%
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateClosedWiseTripSheetAdvancesReport.js"/>"></script>
	<script type="text/javascript" 
