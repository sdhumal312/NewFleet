...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/RRR.in"/>">Renewal </a> / <span id="reportHead">Renewal Sub Type Wise Expiry Report  </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Renewal Sub Type Wise Expiry Report')" id="exportExcelBtn">
					...
					<div class="panel box box-primary">
							<div class="box-body" id="ElementDiv">
									<div class="form-horizontal ">
										<div class="row1">
											<label class="L-size control-label">Renewal SubType : </label>
											<div class="I-size">
												<input type="hidden" id="renewalSubType" name="renewalSubType"
													style="width: 100%;" />
										...
										<!-- Date range -->
										<div class="row1">
												<label class="L-size control-label">To Date
													<abbr title="required">*</abbr>
												</label>
												<div class="I-size">
													<div class="input-group input-append date" id="renewal_to">
														<input type="text" class="form-text" name="CASH_DATE" id="renewalToDate"
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/RenewalReminderExpiryReport.js"/>"></script>
