...
<div class="content-wrapper">
						...
						<div class="box-header with-border">
							<h4 class="box-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#collapseDWAR">Depot Wise Advance Report </a>
							</h4>
						</div>
						<!-- <div id="collapseDWAR" class="panel-collapse collapse"> -->
							<div class="box-body">
								<form action="DepotWiseAdvanceReport" method="post">
									<div class="form-horizontal ">
										<div class="row1">
											...
											<div class="I-size">
												<div class="input-group">
													...
													<input type="text" id="rangeFuelMileage4" class="form-text"
										...
										<div class="row1">
											...
											<div class="I-size">
												<input type="hidden" id="SelectFuelGroup4"
												...
												<div class="I-size">
													<div class="pull-left">
														<button type="submit" name="commit"
															class="btn btn-success" onclick="return validateDepotWiseAdvanceReport();">
												...
												<tbody>
													<tr>
														<td align="center"><span class="text-bold"> <c:out
																	value="${VEHICLE_NAME}" /> Daily Trip Time Report
													...
													%>
														...
														<c:forEach items="${DSAdvance}" var="DSAdvance">
															...
															<tr data-object-id="" class="closeAmount">
																...
																<td><c:out
																			value="${DSAdvance.driver_empnumber} - " /><c:out
																			value="${DSAdvance.driver_firstname} " /><c:out
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateDepotWiseAdvanceReport.js" />"></script>
	<script type="text/javascript">
