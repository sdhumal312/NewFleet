...
<div class="content-wrapper">
	<section class="content-header">
		<div class="box">
			<div class="box-body">
			<input type="hidden" id="vendorPaymentReportIdentity" value="${configuration.showtotalAmountVendorPaymentReport}" />
			
				<div class="pull-left">
					<a href="<c:url value="/open"/>"><spring:message
							code="label.master.home" /></a> / <a href="<c:url value="/Report"/>">Report</a>
					/ <a href="<c:url value="/VENREP.in"/>">Vendor Report</a> / <span>Vendor Payment Report</span>
				</div>
												...
												<div class="I-size">
													<div class="pull-left">
														<button type="submit" name="commit"
															class="btn btn-success" id="btn-search" onclick="return validateVendorPaymentReport();">
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/VP/VendorPaymentReport.js"/>"></script>
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/Print/print.js"/>"></script>
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateVendorPaymentReport.js"/>"></script>
</div>