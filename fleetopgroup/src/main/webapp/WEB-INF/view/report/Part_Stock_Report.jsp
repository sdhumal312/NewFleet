...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/PR.in"/>">part </a> / <span id="reportHead">Part Stock Report </span>
				</div>
									...
									<div class="form-horizontal ">
										<div class="row1">
											<label class="L-size control-label">Search Parts
												Number : </label>
											<div class="I-size">
												<input type="hidden" id="searchpartPartstockReport" name="multipleParts" 
													style="width: 100%;" required="required" placeholder="All" />
											</div>
										</div>
										<!-- location -->
										<div class="row1">
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/part/partStockReport.js"/>"></script>
