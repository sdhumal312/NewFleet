...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/batteryReport.in"/>">Battery Reports</a> / Battery Stock Report
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('batteryStockDetails', 'Battery Stock Report')" id="exportExcelBtn">
							...
							<div class="col-xs-12">
								<div class="table-responsive">
									<div id="sorttable-div" align="center" style="font-size: 10px"
										...
										<div class="row invoice-info">
											<table id="batteryStockDetails" style="width: 95%;"
	...
	<script type="text/javascript"
		src="<c:url value="resources/QhyvOb0m3EjE7A4/js/fleetop/report/BatteryStock.js"/>"></script>
	<script type="text/javascript" 
