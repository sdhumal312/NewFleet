		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					<span>Renewal Reminder Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'RR Compliance Report')">
								...
								<div class="table-responsive">
									...
									<div class="row invoice-info">
										<table id="advanceTable" class="table table-hover table-bordered table-striped">
											<caption>Renewal Reminder Report</caption>
											...
											<tbody>
													...
													<c:forEach items="${renewal}" var="renewal">
														<tr data-object-id="" class="ng-scope">
															...
															<td><fmt:formatNumber maxFractionDigits="2" value="${renewal.renewal_Amount}" /></td>
															<td><c:out value="${renewal.renewal_paidby}" /><br>
													...
													<tr class="workorder_repair_totals">
														...
														<td><i class="fa fa-inr"></i><fmt:formatNumber maxFractionDigits="2" value="${RRAmount}" /> </td>
														<td colspan="2"><i class="fa fa-inr"></td>
													</tr>
												</c:if>
