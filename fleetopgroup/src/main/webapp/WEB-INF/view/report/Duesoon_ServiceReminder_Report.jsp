		...
		<div class="box">
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Service Reminder Report')">
		...
		<sec:authorize access="hasAuthority('VIEW_DU_SR_REPORT')">
			<div class="panel box box-primary">
				<div class="box-header with-border">
					<h4 class="box-title">
						<a data-toggle="collapse" data-parent="#accordion" href="#SRTwo">
							DueSoon Service Reminder Report </a>
					</h4>
				</div>
					...
					<form action="DuesoonServiceReport" method="post">
						<div class="form-horizontal ">
							...
							<div class="row1">
								...
								<div class="I-size">
									<div class="col-md-9">
										<input type="hidden" id="DuesoonSRJOB" name="serviceTypeId"
											style="width: 100%;"
							...
							<div class="row1">
								...
								<div class="I-size">
									<div class="input-group input-append date" id="SRDuesoondate">
