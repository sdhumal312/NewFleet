...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'RR Vehicle Report')">
									...
									<div class="form-horizontal ">
										...
										<form action="RRVehicleComplianceReport" method="post">
											...
											<div class="row1">
												...
												<div class="I-size">
													<input type="hidden" id="fromRRV" name="renewalTypeId"
														style="width: 100%;"
													...
													<div class="I-size">
														<div class="pull-left">
															<button type="submit" name="commit"
																class="btn btn-success" onclick="return validateTotalVehicleWiseComplianceReport();"
																>
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateTotalVehicleWiseComplianceReport.js"/>"></script>
