...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/UR.in"/>">Upholstery </a> / <span id="reportHead"> Upholstery Stock Transfer Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Upholstery Stock Transfer Report')" id="exportExcelBtn">
				...
				<div class="form-horizontal ">
					...
					<div class="row1" id="grppartLocation" class="form-group">
						<label class="L-size control-label" for="warehouselocation">
							From Warehouse location : </label>
						<div class="I-size">
							<input type="hidden" name="WAREHOUSE_LOCATION_ID"
								id="fromWarehouselocation" style="width: 100%;" required="required"
					...
					<div class="row1" id="grppartLocation" class="form-group">
						<label class="L-size control-label" for="warehouselocation">
						To Warehouse location : </label>
						<div class="I-size">
							<input type="hidden" name="WAREHOUSE_LOCATION_ID"
								id="toWarehouselocation" style="width: 100%;" required="required"
								placeholder="All" /> <span id="partLocationIcon" class=""></span>
							<div id="partLocationErrorMsg" class="text-danger"></div>
						</div>
					</div>
					...
					<div class="row1">
						<label class="L-size control-label">Status 												
						</label>
						<div class="I-size">
							<select class="form-text"
								id="statusOfUpholstery" required="required">
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/upholstery/upholsteryStockTransferReport.js"/>"></script>
