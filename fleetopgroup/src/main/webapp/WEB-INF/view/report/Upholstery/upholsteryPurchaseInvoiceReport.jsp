...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/UR.in"/>">Upholstery </a> / <span id="reportHead">Upholstery Purchase Invoice Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('tripCollExpenseName', 'Upholstery Purchase Invoice Report')" id="exportExcelBtn">
					...
					<div class="panel box box-primary">
							<div class="box-body" id="ElementDiv">
									<div class="form-horizontal ">
										<div class="row1">
											<label class="L-size control-label">Upholstery
												Types : </label>
											<div class="I-size">
										...
										<div class="row1">
												<label class="L-size control-label">Cloth Vendor :</label>
												<div class="I-size">
													<input type="hidden" id="clothVendor" name="clothVendor"
									...
									<div id="sorttable-div" align="center" style="font-size: 10px"
										...
										<div id="invoicePurchase" style="display: none;">
												<table class="" style="width:95%">
													<tr>
														<td style="font-size: 12px;" >Upholstery Type :  <a  id="UpholsteryTypeId" href="#"></a></td>
													</tr>
													<tr>
														<td style="font-size: 12px;" >Cloth Vendor :  <a  id="clothVendorId" href="#"></a></td>
													</tr>
													<tr>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/upholstery/upholsteryPurchaseInvoiceReport.js"/>"></script>
