...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/UR.in"/>">Upholstery </a> / <span id="reportHead"> Upholstery Sent To Laundry Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Upholstery Sent To Laundry Report')" id="exportExcelBtn">
				...
				<div class="form-horizontal ">
					...
					<div class="row1" id="grppartLocation" class="form-group">
						<label class="L-size control-label" for="warehouselocation">
						 Location : </label>
						<div class="I-size">
							<input type="hidden" name="warehouselocation"
					...
					<div class="form-horizontal ">
						<div class="row1">
							<label class="L-size control-label">Laundry Vendor Name :</label>
							<div class="I-size">
								<input type="hidden" id="laundryVendor" name="laundryVendor"
					...
					<div class="row1">
						...
						<div class="I-size">
							<div class="input-group">
								...
								<input type="text" id="laundryDateRange" class="form-text"
									name="laundryDateRange" required="required"
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/upholstery/upholsterySentToLaundryReport.js"/>"></script>
