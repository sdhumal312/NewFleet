...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/TSR.in"/>">Trip Sheet Report</a> /<span> Route Wise Trip Sheet</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('advanceTable', 'Route Wise Trip Sheet')" id="exportExcelBtn">
									...
									<div class="form-horizontal ">
										...
										<div class="row1">
											...
											<div class="I-size">
												...
												<input type="hidden" id="TripRouteList" name="TRIP_ROUTE" required="required"
											...
											<div class="I-size">
												<div class="input-group">
													...
													<input type="text" id="LocWorkOrder" class="form-text"
														name="TripDateRange" required="required"
							...
							<div class="col-xs-12">
								<div class="table-responsive">
									<div id="sorttable-div" align="center" style="font-size: 10px"
										...
										<div class="row invoice-info">
											<table id="tripSheetDetails" style="width: 95%"
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/TSR/RouteWiseTripSheet.js"/>"></script>
	<script type="text/javascript"
