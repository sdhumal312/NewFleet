			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open"/>"><spring:message
						...
						href="<c:url value="/newTripDaily.in"/>">Trip Collection</a> / <span>Search
						...
						<form action="searchTripDaily.in" method="post">
							<div class="input-group">
								<input class="form-text" id="tripStutes" name="tripStutes"
									...
									required="required" placeholder="TS-ID, Vehicle No" maxlength="20">
						...
						<div class="row">
							...
							<div class="box box-success">
								...
								<div class="box-body no-padding">
									<form action="TripDailyReport.in" method="post">
										<div class="form-horizontal ">
											<fieldset>
												<div class="row1">
													...
													<div class="I-size">
														<input type="hidden" id="RenewalSelectVehicle"
															name="VEHICLEID" style="width: 100%;" required="required"
												...
												<div class="row1">
													...
													<div class="I-size">
														<select name="TRIP_STATUS_ID" id="closeTripStatus"
															style="width: 100%;">
															<option value=""></option>
													...
													<div class="I-size">
														<div class="pull-left">
															<button type="submit" name="commit"
																...
																<span id="subm">Search All</span>
															</button>
															<a href="<c:url value="/newTripDaily.in"/>"
