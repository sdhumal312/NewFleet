...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/SER.in"/>">Service Entries Report</a> / <span>Vendor Wise Service Entries Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Vendor Wise Service Entries Report')">
		...
		<sec:authorize access="hasAuthority('VIEW_VEN_SE_REPORT')">
			<div class="panel box box-primary">
				<div class="box-header with-border">
					<h4 class="box-title">
						<a data-toggle="collapse" data-parent="#accordion" href="#SEOne">
							Vendor Wise Service Entries Report </a>
					</h4>
				</div>
						...
						<div class="form-horizontal ">
							...
							<div class="row1">
								...
								<div class="I-size" id="vendorSelect">
									<input type="hidden" id="ServiceVendorList" name="VENDOR_ID"
							...
							<div class="row1">
								...
								<div class="I-size">
									<select class="form-text select2" name="PAYMENT_TYPE"
									...
									<div class="I-size">
										<div class="pull-left">
											<button type="submit" name="commit" class="btn btn-success"
												onclick="return validateVendorWiseServiceEntriesReport();">
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateVendorWiseServiceEntriesReport.js"/>"></script>
	<script type="text/javascript">
