...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/UreaReport.in"/>">Urea </a> / <span id="reportHead">Date Wise Urea Entry Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Date Wise Urea Entry Report')" id="exportExcelBtn">
	...
	<script type="text/javascript" 
	src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ureaReport/DateWiseUreaEntryReport.js"/>"></script>
