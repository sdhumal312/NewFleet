						...
						<div class="box-header with-border">
							<h4 class="box-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#collapseDriWPR">Driver / Conductor Wise Penalty
									Report </a>
							</h4>
						</div>
						<!-- <div id="collapseDriWPR" class="panel-collapse collapse"> -->
							<div class="box-body">
								<form action="DepotDriConPenaltyReport" method="post">
									<div class="form-horizontal ">
										...
										<div class="row1">
											...
											<div class="I-size">
												<input type="hidden" id="vehicleGrpId10"
										...
										<fieldset class="form-actions">
											<div class="row1">
												...
												<div class="I-size">
													<div class="pull-left">
														<button type="submit" name="commit" onclick="return validateDriverConductorWisePenaltyReport();"
