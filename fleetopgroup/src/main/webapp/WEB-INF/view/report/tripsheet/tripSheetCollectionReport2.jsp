...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'TripSheet Collection Report 2')" id="exportExcelBtn">
									...
									<div class="table-responsive">
										<div id="sorttable-div" align="center" style="font-size: 10px"
											...
											<div class="row invoice-info">
												...
												<div id="myGrid" style="height: 250px; width: 100%;" class="ag-theme-alpine"></div>
	...
	<script type="text/javascript" src="resources/QhyvOb0m3EjE7A4/js/slickgrid/slickgridwrapper3.js"></script>
