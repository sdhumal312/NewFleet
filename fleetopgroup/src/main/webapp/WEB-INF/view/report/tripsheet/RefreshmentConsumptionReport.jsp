...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/TSR.in"/>">TripSheet </a> / <span id="reportHead">Refreshment Consumption Report </span>
				</div>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/refreshment/RefreshmentConsumptionReport.js"/>"></script>
