...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/PR.in"/>">Part </a> / <span id="reportHead">Refreshment Consumption Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Refreshment Consumption Report')" id="exportExcelBtn">
		...
		<div class="panel box box-primary">
			<div class="box-body" id="ElementDiv">
				<div class="form-horizontal ">
					...
					<div class="row1">
						<label class="L-size control-label">Location : <abbr title="required">*</abbr></label>
						<div class="I-size">
					...
					<div class="row1">
						<label class="L-size control-label">Part Name : <abbr title="required">*</abbr></label>
						<div class="I-size">
											...
											<div class="row1">
												...
												<div class="I-size">
													<div class="input-group input-append date" id="renewal_to">
														<input type="text" class="form-text" name="CASH_DATE" id="stockDate"
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/refreshment/RefreshmentStockReport.js"/>"></script>
