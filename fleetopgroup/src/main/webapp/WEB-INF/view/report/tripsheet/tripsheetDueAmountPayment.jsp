...
<div class="content-wrapper">
			...
			<div class="box-body">
				<div class="pull-left">
					...
					/<a href="<c:url value="/TSR.in"/>">Trip sheet Report</a> / <span>Trip
						Sheet DueAmount Payment Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('tripCollExpenseName', 'TripSheet DueAmount Payment Report')" id="exportExcelBtn">
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/tripsheet/tripsheetDueAmountPayment.js"/>"></script>
	<script type="text/javascript" 
