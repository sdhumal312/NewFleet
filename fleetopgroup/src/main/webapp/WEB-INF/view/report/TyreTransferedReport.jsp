		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/TR.in"/>">Tyre Report</a> / Tyre Transfered Report
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tyreTransferDetails', 'Tyre Transfered Report')" id="exportExcelBtn">
							...
							<div class="box-body">
									<div class="form-horizontal ">
										...
										<div class="row1">
											...
											<div class="I-size">
												<select class="form-text" name="TRANSFER_STATUS" id="TransferStatus"
