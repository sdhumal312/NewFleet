...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/TR.in"/>">Tyre Report</a> / Tyre Sent For Retreading Report
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tyreTransferDetails', 'Tyre Sent For Retreading Report')" id="exportExcelBtn">
										...
										<div class="row1">
											...
											<div class="I-size">
												<input type="hidden" name="TYRE_SIZE"
													id="ReporttyreSize" value="0" style="width: 100%;" placeholder="All" />
											</div>
										</div>
										<div class="row1">
											<label class="L-size control-label">Warehouse
												location : </label>
											<div class="I-size">
												<input type="hidden" name="WORKORDER_LOCATION"
													id="WarehouseLocation" value="0" style="width: 100%;" placeholder="All" />
											</div>
										</div>
										<div class="row1">
											<label class="L-size control-label">Tyre Vendor : </label>
											<div class="I-size">
												<input type="hidden" name="TYRE_VENDOR"
													id="TyreRetreadVendor" value="0" style="width: 100%;" placeholder="All" />
											</div>
										</div>
							...
							<div class="col-xs-12">
								<div class="table-responsive">
									<div id="sorttable-div" align="center" style="font-size: 10px"
										...
										<div class="row invoice-info">
											<table id="tyreTransferDetails" style="width: 95%;"
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/IT/InventoryTyreSentForRethreadingReport.js"/>"></script>
	<script type="text/javascript"
