...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'RR Group Wise Compliance Report')">
										...
										<form action="RRGroupComplianceReport" method="post">
											...
											<div class="row1">
												<label class="L-size control-label">Renewal Type <abbr
													title="required">*</abbr></label>
												<div class="I-size">
													<input type="hidden" id="from3" name="renewalTypeId"
														style="width: 100%;"
													...
													<div class="I-size">
														<div class="pull-left">
															<button type="submit" name="commit"
																class="btn btn-success" onclick="return validateTotalGroupWiseComplianceReport();">
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateTotalGroupWiseComplianceReport.js"/>"></script>
	<script type="text/javascript">
