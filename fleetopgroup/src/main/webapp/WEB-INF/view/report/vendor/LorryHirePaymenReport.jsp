...
<div class="content-wrapper">
		...
		<div class="box">
			...
			<%-- <input type="hidden" id="vendorPaymentReportIdentity" value="${configuration.showtotalAmountVendorPaymentReport}" /> --%>
				...
				<div class="pull-left">
					...
					/ <a href="<c:url value="/VENREP.in"/>">Vendor Report</a> / <span>Vendor Lorry Hire Payment Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('advanceTable', 'Vendor Lorry Hire Payment Report')" id="exportExcelBtn">
							...
							<div class="box-body">
									<div class="form-horizontal ">
										...
										<div class="row1">
											...
											<div class="I-size">
												<input type="hidden" id="selectVendor" name="Vendor_id"  placeholder="All"
													style="width: 100%;" />
											</div>
										</div>										
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/VP/VendorPaymentHistoryReport.js"/>"></script>
	<script type="text/javascript"
