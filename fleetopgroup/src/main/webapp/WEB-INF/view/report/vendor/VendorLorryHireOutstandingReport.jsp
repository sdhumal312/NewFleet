...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('advanceTable', 'Fleetop')" id="exportExcelBtn">
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/VP/LorryHireOutstandingPaymentReport.js"/>"></script>
	<script type="text/javascript"
