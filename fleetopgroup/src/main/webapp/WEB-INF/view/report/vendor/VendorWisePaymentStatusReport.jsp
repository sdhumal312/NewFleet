...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					<a href="<c:url value="/VENREP.in"/>">Vendor Report</a> / 
					<span>Vendor Wise Payment Status Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Vendor Wise Payment Status Report')" id="exportExcelBtn">
		...
		<div class="panel box box-primary">
			<div class="box-body" id="ElementDiv">
				<div class="form-horizontal ">
							...
							<div class="row1">
								<label class="L-size control-label"> Vendor Type :<abbr
									title="required">*</abbr>
								</label>
								<div class="I-size">
									<select class="form-text select2" name="vendorType" id="vendorType"
										style="width: 100%;">
							...
							<div class="row1">
								...
								<div class="I-size">
									<select class="form-text select2" name="status" id="status"
										style="width: 100%;">
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/VP/VendorWisePaymentStatusReport.js"/>"></script>
