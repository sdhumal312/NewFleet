...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/DR.in"/>">Driver Report</a> <span id="reportHead"> /Driver Renewal Reminder Details </span>
				</div>
				...
				<div class="form-horizontal ">
					<div class="row">
						...
						<div class="col col-sm-4 col-md-4">
							...
							</select> <span style="color: #2e74e6; font-size: 15px;">DL Status</span>
							</label>
						</div>
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/driver/driverRenewalReminderReport.js"/>"></script>
