...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/CR.in"/>">Checking </a> / <span id="reportHead"> Conductor History Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Conductor History Report')" id="exportExcelBtn">
					...
					<div class="panel box box-primary">
							<div class="box-body" id="ElementDiv">
									<div class="form-horizontal ">
										<div class="row1">
											<label class="L-size control-label">Conductor
												Name : </label>
											<div class="I-size">
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/checking/conductorHistoryReport.js"/>"></script>
