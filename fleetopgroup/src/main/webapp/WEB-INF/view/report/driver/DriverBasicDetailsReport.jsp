...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/DR.in"/>">Driver </a> / <span id="reportHead">Driver Basic Details Report </span>
				</div>
			...
			<div class="box-body" id="ElementDiv">
				...
				<div class="row1">
					<label class="L-size control-label">Job Title : </label>
						<div class="I-size">
							<select class="form-text left-margin" id="driJobId">
					...
					<div class="row1">
						...
						<div class="I-size">
							<input type="hidden" id="driverTypeList" name="driverTypeList"
					...
					<div class="row1">
							...
							<div class="I-size">
								<input type="hidden" class="select" id="addDetailTypeId" style="width:100%"  placeholder="All">
							</div>
						</div>
						...
						<div class="I-size">
							<div class="input-group">
								...
								<input type="text" id="dateRangeReport" class="form-text"
									name="dateRangeReport" required="required" readonly="readonly"
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/DriverBasicDetailsReport.js"/>"></script>
	<script
