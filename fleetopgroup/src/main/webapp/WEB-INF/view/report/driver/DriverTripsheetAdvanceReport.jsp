...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/DR.in"/>">Driver Report</a> / <span>Driver Tripsheet Advance Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Driver Tripsheet Advance Report')" id="exportExcelBtn">
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/DriverTripsheetAdvanceReport.js" />"></script>
	<script
