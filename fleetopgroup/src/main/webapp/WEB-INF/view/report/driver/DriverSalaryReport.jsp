...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/DR.in"/>">Driver Report</a> / <span id="reportHead">
					Driver Salary Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Create Day Wise Salary Report')" id="exportExcelBtn">
								...
								<div class="row1">
										...
										<div class="I-size">
											<input type="hidden" id="driverId" name="DRIVER_ID"
												style="width: 100%;" placeholder="All" value="" />
										</div>
									</div>
												...
												<div class="I-size">
													<div class="pull-left">
														<button type="submit" name="commit"
															...
															<i class="fa fa-search"> Searchss</i>
														</button>
													</div>
												</div>
										</div>
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/driver/DriverSalaryReport.js"/>"></script>
