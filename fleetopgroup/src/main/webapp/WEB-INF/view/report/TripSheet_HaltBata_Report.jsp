...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/<a href="<c:url value="/DR.in"/>">Driver Report</a> / <span>Bata
						Date Range Halt Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Date Range Halt Report')">
	...
	<section class="content">
		...
		<!--SRS Travels TripSheet HaltBata Report Start -->
						...
						<div class="box-header with-border">
							<h4 class="box-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#RRCompThree">TripSheet HaltBata Report </a>
							</h4>
						</div>
						<!-- <div id="RRCompThree" class="panel-collapse collapse"> -->
							<div class="box-body">
								<div class="form-horizontal ">
									<form action="HaltDateRangeReport" method="post">
										<div class="row1">
											...
											<div class="I-size">
												<div class="input-group">
													...
													<input type="text" id="RenewalComRangeRRG"
														class="form-text" name="HALT_DATE_RANGE"
														required="required"
		...
		<!--SRS Travels TripSheet HaltBata Report End -->
		<sec:authorize access="hasAuthority('VIEW_TRIPSHEET')">
			<div id="div_print">
									...
									<c:if test="${!empty TripSheet}">
										...
										<div class="row invoice-info">
											<table id="advanceTable"
												...
												<caption>Beta Date Range Halt Report
													-${SearchDate}</caption>
												<thead>
													<tr>
														<th class="fit">No</th>
												...
												%>
													...
													<c:forEach items="${TripSheet}" var="TripSheet">
														<tr data-object-id="">
															...
															<td><c:out value="TS-${TripSheet.tripSheetNumber}" /></td>
															...
															<td style="text-align: right;"><fmt:formatNumber maxFractionDigits="2" value="${TripSheet.tripTotalexpense}" /></td>
