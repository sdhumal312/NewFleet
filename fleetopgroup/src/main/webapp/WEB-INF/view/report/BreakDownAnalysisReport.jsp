...
<div class="content-wrapper">
				...
				<div class="form-horizontal ">
					...
					<div class="row">
					  <div class="col col-sm-4 col-md-4">
						<label class="L-size control-label">Depot: 
						</label>
						<div class="I-size">
					...
					<div class="row">
						...
						<div class="col col-sm-4 col-md-3">
							...
							<label class="L-size control-label" for="categoryId">Category
								: </label>
							<div class="I-size">
						...
						<div class="col col-sm-4 col-md-4">
							<label class="L-size control-label">Avoidable  </label>
							<div class="I-size">
								<select class="form-text" name="avoidable" style="width: 100%;"
									id="avoidable">
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/IS/BreakDownAnalysisReport.js"/>"></script>
