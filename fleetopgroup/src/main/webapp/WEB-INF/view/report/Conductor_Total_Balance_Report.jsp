						...
						<div class="row invoice-info">
							<div class="col-sm-12 col-md-12 col-xs-12"
								...
								<div class="table-responsive">
									...
									<div class="row invoice-info">
										<table class="table table-hover table-bordered table-striped">
											<caption>Total Conductor Balance Report</caption>
											...
											<thead>
												<tr>
													...
													<th style="font-size: 10px; width: 15%;">Conductor Name</th>
													<th style="font-size: 10px; width: 10%; text-align: center;">Conductor Jama</th>
													<th style="font-size: 10px; width: 10%; text-align: center;">Conductor Advance</th>
												</tr>
											</thead>
											<tbody>
												<%
												...
												<c:if test="${!empty TripCol}">
													...
													<c:forEach items="${TripCol}" var="TripCol">
														<tr data-object-id="">
															...
															<td style="font-size: 10px; width: 15%;"><c:out value="${TripCol.TRIP_CONDUCTOR_NAME}" /></td>
