...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/ProfitAndLoss.in"/>">Profit And Loss Report</a> / Group wise Vehicle usage and movement report
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('batteryTransferDetails', 'Group wise Vehicle usage and movement report')" id="exportExcelBtn">
					...
					<div class="panel box box-primary">
							<div class="box-body">
									<div class="form-horizontal ">
										<div class="row1">
													<label class="L-size control-label">Group Name <abbr
														title="required">*</abbr>
													</label>
													<div class="I-size">
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/groupUsageReport.js" />"></script>
	<script
