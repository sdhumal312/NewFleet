			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open"/>">
						...
						<a href="<c:url value="/Report"/>">Report</a> /
					 	...
					 	<span>Vehicle Repair And Part Consumption Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Vehicle Repair And Part Consumption Report')" id="exportExcelBtn">
			...
			<div class="box-body" id="ElementDiv">
				<div class="form-horizontal ">
					<div class="row1">
						...
						<div class="I-size">
							<input type="hidden" id="SelectVehicleGroup" style="width: 100%;"
								placeholder="Please Select Vehicle Group" />
						</div>
					</div>
					<div class="row1">
						<label class="L-size control-label">Vehicle Name</label>
						<div class="I-size">
							<input type="hidden" id="vehicleId" name="vid" style="width: 100%;" required="required" placeholder="All" />
						</div>
					</div>
					<div class="row1">
						<label class="L-size control-label">Service Type </label>
						<div class="I-size">
							<select class="form-text select2" id="vehicleServiceType">
								<option value="1">All</option>
								<option value="2">Service Entries</option>
								<option value="3">Work Orders</option>
							</select>
						</div>
					</div>
					<div class="row1">
...
<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/vehicle/VehicleRepairAndPartConsumptionReport.js"/>"></script>
