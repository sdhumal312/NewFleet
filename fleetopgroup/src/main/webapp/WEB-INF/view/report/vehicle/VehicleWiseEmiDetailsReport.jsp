...
<div class="content-wrapper">
			...
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Vehicle Wise EMI Report')" id="exportExcelBtn">
					...
					<div class="box-body" id="ElementDiv">
						<div class="form-horizontal ">
								...
								<div class="row1">
									...
									<div class="I-size">
										<input type="hidden" id="vehicleId" name="vid" style="width: 100%;" required="required" placeholder="Please Select Vehicle" />
									</div>
								</div>
									...
									<div class="table-responsive">
										<div id="sorttable-div" align="center" style="font-size: 10px" class="table-responsive ">
											...
											<table style="width:100%;">
												<thead>
													<tr>
														<td colspan="5" style="display: none; font-weight: bold;" id="companyName"></td>
													</tr>
												</thead>
											</table>
											<div id="selectedData" style="text-align: left;">
												
												<table style="width:100%;" id="selectedReportDetails">
	...
	<script type="text/javascript" src="resources/QhyvOb0m3EjE7A4/js/slickgrid/slickgridwrapper2.js"></script>
		...
		<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/vehicle/VehicleWiseEmiDetailsReport.js"/>"></script>
<%-- 	
	<script type="text/javascript"
