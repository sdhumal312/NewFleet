		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/VR.in"/>">Vehicle Report</a> <span
						id="reportHead"> /Vehicle Basic incident Report </span>
				</div>
...
<script type="text/javascript"
	src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/vehicle/vehicleIncidentReport.js"/>"></script>
<script type="text/javascript"
