...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/batteryReport.in"/>">Battery Report</a> / <span>Battery
						Wise History Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('batteryHistoryDetails', 'Vehicle Wise Battery History Report')" id="exportExcelBtn">
				...
				<div class="panel box box-primary">
					<div class="box-body" id="ElementDiv">
						<div class="form-horizontal ">
								...
								<div class="row1">
									<label class="L-size control-label">Battery Number <abbr
										title="required">*</abbr>
									</label>
									<div class="I-size">
										<input type="hidden" id="batteryId"
											name="batteryId" style="width: 100%;"
											required="required"
											placeholder="All" />
									</div>
								</div>
						...
						<div class="row1">
							...
							<div class="row1">
								...
								<div class="I-size">
									<div class="pull-left">
										<button  name="commit" class="btn btn-success"
											id="btn-save">
									...
									<div class="table-responsive">
										<div id="sorttable-div" align="center" style="font-size: 10px"
											...
											<div id="selectedData" style="text-align: left;">
												...
												<table id="batteryHistoryDetails" style="width: 95%;"
	...
	<script type="text/javascript"
		...
		<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/battery/BatteryWiseHistoryReport.js"/>"></script>
