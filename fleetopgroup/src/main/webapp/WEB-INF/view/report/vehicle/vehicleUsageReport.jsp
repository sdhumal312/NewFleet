...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/ProfitAndLoss.in"/>">Profit And Loss Report</a> / Vehicle wise usage and movement report
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('batteryTransferDetails', 'Vehicle wise usage and movement report')" id="exportExcelBtn">
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/vehicleUsageReport.js" />"></script>
	<script
