...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<input type="hidden" id="showDateRangeInTyreAssignmentReport" value="${configuration.showDateRangeInTyreAssignmentReport}">
								<div class="row1">
					...
					<c:if test="${configuration.showDateRangeInTyreAssignmentReport}">
						<div class="row1">
	...
	<script type="text/javascript" src="resources/QhyvOb0m3EjE7A4/js/slickgrid/slickgridwrapper2.js"></script>
		...
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/vehicle/VehicleWiseTyreReport.js"/>"></script>
