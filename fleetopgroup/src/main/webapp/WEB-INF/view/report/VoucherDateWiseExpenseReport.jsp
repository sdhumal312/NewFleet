...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/TSR.in"/>">Tripsheet </a> / <span id="reportHead">Voucher Date Wise Expense Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Voucher Date Wise Expense Report')" id="exportExcelBtn">
			...
			<div class="box-body" id="ElementDiv">
				<div class="form-horizontal ">
					<div class="row1">
						...
						<div class="I-size">
							<input type="hidden" name="Expense_Name" id="ReportExpenseName"
								style="width: 100%;" placeholder="All" />
						</div>
					</div>

					<div class="row1">
						<label class="L-size control-label"> Tally Company : </label>
						<div class="I-size">
							<input type="hidden" name="tallyCompanyId" id="tallyCompanyId"
								style="width: 100%;" placeholder="All" />
						</div>
					</div>
					<c:if test="${configuration.showVendorInputField}">
										...
										<div id="sorttable-div" align="center" style="font-size: 10px"
											...
											<div id="invoicePurchase" style="display: none;">
												<table class="" style="width: 95%">
													<tr>
														<td style="font-size: 12px;">Driver : <a
															id="driver1Identity" href="#"></a></td>
													</tr>
													<c:if test="${configuration.showDriver2 }">
														<tr>
															<td style="font-size: 12px;">Driver 2 : <a
																id="driver2Identity" href="#"></a></td>
														</tr>
													</c:if>
													<c:if test="${configuration.showRoute }">
														<tr>
															<td style="font-size: 12px;">Route: <a
																id="routeIdentity" href="#"></a></td>
														</tr>
													</c:if>
													<tr>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/TSR/VoucherDateWiseExpenseReport.js"/>"></script>
