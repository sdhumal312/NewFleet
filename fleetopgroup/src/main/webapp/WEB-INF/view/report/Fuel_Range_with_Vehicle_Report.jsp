...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/FR.in"/>">Fuel Report</a>  /  <span>Vehicle Wise Fuel Range Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Vehicle Wise Fuel Range Report')">
								...
								<div class="table-responsive">
									...
									<div class="row invoice-info">
										<table id="advanceTable" class="table table-hover table-bordered table-striped">
											<caption>Vehicle Wise Fuel Range Report</caption>
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidationFuelRangeReport.js"/>"></script>
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidationFuelRangeReport1.js"/>"></script>
