		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/TDR.in"/>">Trip Collection Report</a> / <span>Depot
						...
						<div class="box-header with-border">
							<h4 class="box-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#TripCollectionFive">All Depot Wise Date Range
						...
						<!-- <div id="TripCollectionFive" class="panel-collapse collapse"> -->
							<div class="box-body">
								<div class="form-horizontal ">
									...
									<form action="DateWiseGroupTDReport" method="post">
										<!-- Date range -->
										<div class="row1">
													...
													<tbody>
														<tr>
															<td align="center"><span class="text-bold">
																	Depot Wise Trip Collection Report <c:out
												...
												<table id="advanceTable" style="width: 95%"
													...
													<tbody>
														...
														<%
															Integer hitsCount = 1;
														%>
														<c:forEach items="${TripDGroup}" var="TripDGroup">
															<tr data-object-id="" class="ng-scope closeAmount">
																...
																<td><a target="_blank" href="<c:url value="/#"/>"><c:out
																			value="${TripDGroup.TRIP_OPEN_DATE}" /></a></td>
																<td><c:out value="${TripDGroup.VEHICLE_GROUP}" /></td>

																<td><c:out value="${TripDGroup.TOTAL_USAGE_KM}" /></td>
																<td><c:out value="${TripDGroup.TOTAL_DIESEL}" /></td>
																<td><c:out
																		value="${TripDGroup.TOTAL_TOTALPASSNGER}" /></td>
																<td><c:out value="${TripDGroup.TOTAL_RFIDPASS}" /></td>
																<td><c:out value="${TripDGroup.TOTAL_COLLECTION}" /></td>
																<td><c:out value="${TripDGroup.TOTAL_EXPENSE}" /></td>
																<td><c:out value="${TripDGroup.TOTAL_OVERTIME}" /></td>
																<td><c:out value="${TripDGroup.TOTAL_BALANCE}" /></td>
															</tr>
														</c:forEach>
