...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/PR.in"/>">part </a> / <span id="reportHead">Part Requisition Status wise Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Part Stock Report')" id="exportExcelBtn">
							...
							<div class="box-body" id="ElementDiv">
									<div class="form-horizontal ">
										...
										<div class="row1">
											...
											<div class="I-size">
												<input type="hidden" id="createdByUser" name=userId placeholder="All"
													style="width: 100%;" />
											</div>
										</div>
										...
										<div class="row1">
											...
											<div class="I-size">
												<select class="form-text" name="status"
										...
										<div class="row1">
											<label class="L-size control-label">Requisition Location : </label>
											<div class="I-size">
										...
										<div class="row1">
											<label class="L-size control-label">Requisition Type : </label>
											<div class="I-size">
												<select class="form-text" name="ReqType"
													id="reqType" required="required">
													<option value="0">All</option>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/part/PartRequisitionStatusReport.js"/>"></script>
