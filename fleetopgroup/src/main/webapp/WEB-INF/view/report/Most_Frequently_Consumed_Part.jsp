...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/PR.in"/>">part </a> / <span>Most frequently consumed part </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('partConsumedList', 'Most frequently consumed part')" id="exportExcelBtn">
							...
							<div class="col-xs-12">
								<div class="table-responsive">
									<div id="sorttable-div" align="center" style="font-size: 10px"
										...
										<div class="row invoice-info">
											<table id="partConsumedList" style="width: 95%;"
	...
	<%-- <script type="text/javascript"
		...
		<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/MostFrequentlyConsumedPart.js"/>"></script>
		<script
