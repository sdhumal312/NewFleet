									...
									<form action="vehicleReport" method="post">
										<div class="form-horizontal ">
											<fieldset>
												...
												<div class="row1">
													<label class="L-size control-label"> Vehicle Status</label>
													<div class="I-size">
												...
												<c:if test="${!configuration.hideSomeVehicleReportOptions}">
												<div class="row1">
												...
												<div class="row1">
													<label class="L-size control-label" id="VehicleMaker">Vehicle
														Maker</label>
													<div class="I-size">
														<input id="vehicle_maker" placeholder="Please Enter 2 or more Location Name"
															name="vehicleMakerId" style="width: 100%;" type="hidden">
															
													</div>
												</div>
												
												<div class="row1">
													<label class="L-size control-label" id="vehicleBodyMaker">Vehicle
														Body Maker</label>
													<div class="I-size">
														<input id="bodyMakerSelect" placeholder="Please Enter 2 or more Location Name" 
															name="vehicleBodyMakerId" style="width: 100%;" type="hidden">
