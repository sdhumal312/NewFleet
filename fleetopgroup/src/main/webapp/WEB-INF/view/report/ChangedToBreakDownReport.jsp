...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/IR.in"/>">Issues Report</a> <span id="reportHead"> /Changed to breakdown report </span>
				</div>
		...
		<div class="panel box box-primary">
			<div class="box-body" id="ElementDiv">
				<div class="form-horizontal ">
					<div class="row">
						<div class="col col-sm-4 col-md-4">
							<label class="has-float-label"> <input type="hidden"
								id="depot" name="depot" style="width: 100%;" placeholder="ALL" />
								<span style="color: #2e74e6; font-size: 15px;">Depot</span>
							</label>
						</div>
						<div class="col col-sm-4 col-md-3">
							<label class="has-float-label"> <input type="hidden"
								id="routeList" name="routeID" style="width: 100%;"
								required="required" placeholder="All" /> <span
								style="color: #2e74e6; font-size: 15px;">Route</span></label>
						</div>
						<div class="col col-sm-4 col-md-4">
							<label class="has-float-label" for="partCategory"> <select
								name="categoryId" style="width: 100%;" id="partCategory">
							...
							</select> <span style="color: #2e74e6; font-size: 15px;">Category</span>
							</label>
						</div>
					</div>
					<div class="row">
						...
						<div class="col col-sm-4 col-md-3">
							<label class="has-float-label"> <input type="hidden"
								id="VehicleTypeSelect" style="width: 100%;" placeholder="All" /><span
								style="color: #2e74e6; font-size: 15px;">Vehicle Type</span>
							</label>
						</div>
						<div class="col col-sm-4 col-md-4">
							<label class="has-float-label" for="vehicleModelList"> <select
								id="vehicleModelList" style="width: 100%;">
									<option value="0">All</option>
									<c:forEach items="${modelList}" var="model">
										<option value="${model.vehicleModelId}">${model.vehicleModelName}
										</option>
									</c:forEach>
							</select> <span style="color: #2e74e6; font-size: 15px;">Vehicle
									Model</span>
							</label>
						</div>
					</div>
					<div class="row">
						<div class="col col-sm-4 col-md-4">
							<label class="has-float-label"> <input id="subscribe1"
								type="hidden" style="width: 100%" placeholder="All "> <span
								style="color: #2e74e6; font-size: 15px;">Assign To </span></label>
						</div>
						<div class="col col-sm-4 col-md-3">
							<label class="has-float-label"> <select
								name="ISSUES_TYPE_ID" id="issueLabel" style="width: 100%">
									<option value="0"> All </option>
							...
							</select> <span style="color: #2e74e6; font-size: 15px;"> Label</span></label>
						</div>
						<div class="col col-sm-4 col-md-4">
					...
					<div class="row">
						<div class="col col-sm-1 col-md-4">
							<label class="has-float-label"> <input type="hidden"
								id="driverId" class="browser-default" style="width: 100%;">
								<span style="color: #2e74e6; font-size: 15px;">Driver </span>
							</label>
						</div>
						<div class="col col-sm-4 col-md-3">
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/IS/changeToBreakDownReport.js"/>"></script>
