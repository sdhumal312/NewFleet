			...
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('vehicleTable', 'Vehicle Wise Repair Report')">
										...
										<form action="RepairReport" method="post">
											<div class="form-horizontal ">
												...
												<c:if test="${!configuration.showUserInVehicleRepairReport}">
													<input type="hidden" id="userId2" value="0" name="userId">
												</c:if>
												<c:if test="${configuration.showUserInVehicleRepairReport}">
													<div class="row1">
								...
								<table style="width: 95%">
											<tbody>
												<tr>
													...
													<c:if test="${configuration.showUserInVehicleRepairReport}">
														<td align="center"><span class="text-bold">
																User : <c:out value="${userName}" />
														</span></td>
													</c:if>
												</tr>
											</tbody>
										</table>
									<table class="table table-hover table-bordered table-striped" id="vehicleTable">
										<thead>
											<tr>
												<th>WO</th>
												<th>Status</th>
										...
										<tbody>
											<c:if test="${!empty vehicles}">
												<c:forEach items="${vehicles}" var="vehicles">
																...
																<tr>
																	...
																	<td><c:choose>
																			...
																			<c:when
																				...
																				<span class="no-wrap"> <span class="text-red"><i
																					...
																					<c:forEach items="${workordertask}"
																						...
																						<c:if
																							...
																							<tr>
																								...
																								<td><i class="fa fa-inr" data-toggle="tip"
																									data-original-title="Laber_cost"></i> <c:out
													...
													<tr class="workorder_repair_totals">
														<th class="text-right" colspan="8"><b> WorkOrders
																Total Amount :</b></th>
											...
											<!-- close Vehicle If -->
											<tr class="vehicle_repair_total">
												<th class="text-right" colspan="8"><b>
										...
										<tfoot>
											<tr class="workorder_repair_search_totals">
												<th class="text-right" colspan="8"><b> Total Amount
														:</b></th>
