...
<div class="content-wrapper">
							...
							<div class="box-header with-border">
								<h4 class="box-title">
									<a data-toggle="collapse" data-parent="#accordion"
										href="#TripsheetThree">Day wise Trip sheet Advances Report
									</a>
								</h4>
							</div>
							<!-- <div id="TripsheetThree" class="panel-collapse collapse"> -->
								<div class="box-body">
									<form action="TSAllAdvanceReport" method="post">
													...
													<div class="I-size">
														<div class="pull-left">
															<button type="submit" name="commit"
																class="btn btn-success" onclick="return validateDayWiseTripSheetAdvancesReport();">
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateDayWiseTripSheetAdvancesReport.js"/>"></script>
	<script type="text/javascript" 
