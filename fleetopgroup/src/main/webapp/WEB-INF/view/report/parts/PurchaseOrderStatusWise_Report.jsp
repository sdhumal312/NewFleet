...
<div class="content-wrapper">
							...
							<div class="box-body" id="ElementDiv">
									<div class="form-horizontal ">
										<div class="row1">
											...
											<div class="I-size">
												<input type="text" id="PartVendorList" name="partid"
										...
										<div class="row1">
											...
											<div class="I-size">
												<div class="input-group">
													...
													</div><!--  TripCollectionExpenseRange-->
													<input type="text" id="PoRange" class="form-text" 
									...
									<div id="sorttable-div" align="center" style="font-size: 10px"
										...
										<div id="invoicePurchase" style="display: none;">
												<table class="" style="width:100%">
													...
													<tr>
														<td style="font-size: 12px;" >Status :  <a  id="PoStatus" href="#"></a></td>
													</tr>
													<tr>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/part/PurchaseOrderStatusWise_report.js"/>"></script><!--partPurchaseInvoiceReport.js  -->
