...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/PR.in"/>">part </a> / <span id="reportHead">Part Wise Consumption part </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Part Wise Consumption Report 2')" id="exportExcelBtn">
									...
									<div class="row1">
													...
													<div class="I-size">
														<select class="form-text select2"
															name="repair_servicetype" id="serviceTypeId"
															required="required">
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/part/partWiseConsumtionReport2.js"/>"></script>
