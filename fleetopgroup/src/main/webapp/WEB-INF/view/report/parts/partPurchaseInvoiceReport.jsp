...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/PR.in"/>">part </a> / <span id="reportHead">Part Purchase Invoice Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('tripCollExpenseName', 'Part Purchase Invoice Report')" id="exportExcelBtn">
			...
			<input type="hidden" id="pendingStock" value="${configuration.showPendindStock}">
			<section class="content">
					<div class="panel box box-primary">
							<div class="box-body" id="ElementDiv">
									<div class="form-horizontal ">
										<div class="row1">
											<label class="L-size control-label">Parts
												Number : </label>
											<div class="I-size">
									...
									<div id="sorttable-div" align="center" style="font-size: 10px"
										...
										<div id="invoicePurchase" style="display: none;">
												<table class="" style="width:95%">
													...
													<tr>
														<td style="font-size: 12px;" >Part Number :  <a  id="PartNumber" href="#"></a></td>
													</tr>
													<tr>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/part/partPurchaseInvoiceReport.js"/>"></script>
