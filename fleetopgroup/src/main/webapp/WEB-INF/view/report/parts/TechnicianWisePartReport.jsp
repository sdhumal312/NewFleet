...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/PR.in"/>">Part </a> / <span id="reportHead">
					Technician Wise Part Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Technician Wise Part Report')" id="exportExcelBtn">
							...
							<div class="box-body" id="ElementDiv">
									<div class="form-horizontal ">
										...
										<div class="row1">
											...
											<div class="I-size">
												<input type="hidden" id="technicianId" name="technicianId" placeholder="All"
													style="width: 100%;" />
											</div>
										</div>
										...
										<div class="row1">
											<label class="L-size control-label">Parts
												Number : </label>
											<div class="I-size">
												<input type="hidden" id="searchpartPO" name="partid" placeholder="All"
													style="width: 100%;" />
											</div>
										</div>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/part/TechnicianWisePartReport.js"/>"></script>
