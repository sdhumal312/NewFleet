...
<div class="content-wrapper">
	<section class="content-header">
		<div class="box">
				...
				<div class="pull-left">
					<a href="<c:url value="/open"/>">
						...
						<a href="<c:url value="/Report"/>">Report</a> /
					 	...
					 	<span>Vehicle Route Change Report</span>
				</div>
			...
			<div class="box-body" id="ElementDiv">
				...
				<br>
					<div class="row1">
						<label class="L-size control-label" style="font-size: 126%">Vehicle : </label>

						<div class="I-size" style="width: 77.333%;">
							<input type="hidden" id="fuelVehicle" placeholder="ALL"  name="fuelVehicle"
								style="cursor: pointer; padding: 5px 5px; border: 1px solid #ccc; width: 70%;"  />
						</div>
					</div>
					<br>
					<div class="row1" align="center">
						<label class="L-size control-label" style="font-size: 126%">Date range: <abbr
						...
						<div class="I-size" style="width: 77.333%;">
							<div class="input-group">
								...
								<input type="text" id="dateRange" class="form-text"
									...
									style="cursor: pointer; padding: 5px 5px; border: 1px solid #ccc; width: 67%">
							</div>
						</div>
					</div>
					<br />
	...
	<script type="text/javascript" 
	src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/VehicleRouteChangeReport.js"/>"></script>
	<script
