...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Driver Attendance Report')">
				...
				<div class="box-header with-border">
					<h4 class="box-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#DAReport"> Driver Attendance Report </a>
					</h4>
				</div>
				<!-- <div id="DAReport" class="panel-collapse collapse"> -->
				<div class="box-body">
					<form action="DriverAttReport" method="post">
						<div class="form-horizontal ">
							<div class="row1">
								...
								<div class="I-size">
									<input type="hidden" id="driverAttendance" name="DRIVER_ID"
										style="width: 100%;"
									...
									<div class="I-size">
										<div class="pull-left">
											<button type="submit" name="commit" class="btn btn-success"
												onclick="return validateDriverAttendanceReport();">
									...
									<div class="table-responsive">
										...
										<div class="row invoice-info">
											<table id="advanceTable"
												...
												<caption>Driver Attendance Report -${SearchDate}</caption>
												<thead>
													<tr>
														<th class="fit">No</th>
														<th>Driver</th>
												...
												%>
													...
													<c:forEach items="${DA}" var="DA">
														<tr data-object-id="">
															...
															<td><c:out value="${DA.DRIVER_GROUP}" /></td>
															<td><c:out value="${DA.ATTENDANCE_DATE}" /></td>
															<td><c:if
																	test="${DA.TRIPSHEETID != 0 && DA.TRIPSHEETNUMBER != null}">
																	<c:if test="${DA.tripSheetFlavor == 1}">
																		<a target="_blank"
																			href="<c:url value="/showTripSheet.in?tripSheetID=${DA.TRIPSHEETID}"/>"
																			data-toggle="tip"
																			data-original-title="Click Tripsheet Details"><c:out
																				value="TS-${DA.TRIPSHEETNUMBER}" /> </a>
																	</c:if>
																	<c:if test="${DA.tripSheetFlavor == 2}">
																		<a target="_blank"
																			href="<c:url value="/showTripCol.in?ID=${DA.TRIPSHEETID}"/>"
																			data-toggle="tip"
																			data-original-title="Click Tripsheet Details"><c:out
																				value="TS-${DA.TRIPSHEETNUMBER}" /> </a>
																	</c:if>
																	<c:if test="${DA.tripSheetFlavor == 3}">
																		<a target="_blank"
																			href="<c:url value="/showTripDaily.in?ID=${DA.TRIPSHEETID}"/>"
																			data-toggle="tip"
																			data-original-title="Click Tripsheet Details"><c:out
																				value="TS-${DA.TRIPSHEETNUMBER}" /> </a>
																	</c:if>
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateDriverAttendanceReport.js" />"></script>
