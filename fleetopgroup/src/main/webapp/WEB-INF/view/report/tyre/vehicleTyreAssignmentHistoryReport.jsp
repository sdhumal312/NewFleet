...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/TR.in"/>">Tyre Report</a> / Vehicle Tyre Assignment History Report
				</div>
			...
			<div class="box-body" id="ElementDiv">
				<div class="form-horizontal ">
					...
					<div class="row1">
						...
						Vehicle :<abbr title="required">*</abbr> </label>
						<div class="I-size">
							<input type="hidden" id="ReportSelectVehicle" name="repair_vid"
								style="width: 100%;" required="required" />
						</div>
					</div>
					<c:if test="${configuration.showTyreAssignmentHistoryReportDateRange}">
					<div class="row1">
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/IT/vehicleTyreAssignmentHistoryReport.js"/>"></script>
