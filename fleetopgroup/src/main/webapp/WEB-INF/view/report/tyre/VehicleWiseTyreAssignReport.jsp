...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/TR.in"/>">Tyre Report</a> / <span>Vehicle
						Wise Tyre Report</span>
				</div>
					...
					<div class="box-body" id="ElementDiv">
						...
						<div class="col col-sm-4 col-md-4">
							<label class="has-float-label"> <input type="hidden"
								id="vehicleId" name="vehicleId" style="width: 100%;"
								placeholder="ALL" /><span
								style="color: #2e74e6; font-size: 15px;">Vehicle</span></label>
						</div>
						<div class="col col-sm-4 col-md-4" id="vehicleGroupDiv">
							<label class="has-float-label"> <input type="hidden"
								id="VehicleGroupSelect" style="width: 100%;"
								placeholder="ALL" /> <span
								style="color: #2e74e6; font-size: 15px;">Vehicle Group</span></label>
						</div>
						<div class="col col-sm-4 col-md-4">
								<div class="center">
									<button type="submit" name="commit" class="btn btn-success btn-lg"
										id="btn-save">
	...
	<script type="text/javascript" src="resources/QhyvOb0m3EjE7A4/js/slickgrid/slickgridwrapper2.js"></script>
		...
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/vehicle/vehicleWiseTyreAssignReport.js"/>"></script>
</div>