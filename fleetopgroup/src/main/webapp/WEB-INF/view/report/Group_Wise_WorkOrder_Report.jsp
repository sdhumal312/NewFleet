		...
		<div class="box">
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Group Wise WorkOrder Report')">
												...
												<div class="I-size">
													<div class="pull-left">
														<button type="submit" name="commit"
															class="btn btn-success" onclick="return validateGroupWiseWorkOrderReport();">
...
<script type="text/javascript"
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateGroupWiseWorkOrderReport.js"/>"></script>
	<script type="text/javascript">
