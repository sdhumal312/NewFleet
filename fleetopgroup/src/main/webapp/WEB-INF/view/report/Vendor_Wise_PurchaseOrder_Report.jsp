...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Vendor Wise Purchase Order Report')">
										...
										<div class="row1">
											...
											<div class="I-size">
												<input type="text" id="invoiceNo"
													name="INVOICE_NO" value="" class="form-text"
												...
												<div class="I-size">
													<div class="pull-left">
														<button type="submit" name="commit"
															class="btn btn-success" onclick="return validateVendorWisePurchaseOrderReport();">
												...
												<tbody>
													...
													<tr class="vehicle_repair_total">
														<th class="text-right" colspan="5"><b> Total
																Amount :</b></th>
														<td> <fmt:formatNumber pattern="#.##" value="${TotalAmount}"/></td>
														<td><fmt:formatNumber pattern="#.##" value="${TotalBalanceAmount}"/></td>
														<td colspan="3"></td>
													</tr>
												</tbody>
											</table>
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateVendorWisePurchaseOrderReport.js"/>"></script>
	<script type="text/javascript">
