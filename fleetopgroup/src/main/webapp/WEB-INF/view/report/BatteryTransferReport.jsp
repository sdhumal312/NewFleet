...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/batteryReport.in"/>">Battery Reports</a> / Battery Transfer Report
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('batteryTransferDetails', 'Battery Transfer Report')" id="exportExcelBtn">
									...
									<div class="form-horizontal ">
										...
										<div class="row1">
											<label class="L-size control-label">Warehouse
												location To : </label>
											<div class="I-size">
												<input type="hidden" name="BatteryLocationTo"
													id="BatteryLocationTo" value="0" style="width: 100%;" placeholder="All" />
											</div>
										</div>
										<div class="row1">
											...
											<div class="I-size">
												<select class="form-text" name="TransferStatus" id="TransferStatus"
	...
	<script type="text/javascript"
		src="<c:url value="resources/QhyvOb0m3EjE7A4/js/fleetop/report/BatteryTransferReport.js"/>"></script>
	<script type="text/javascript"
