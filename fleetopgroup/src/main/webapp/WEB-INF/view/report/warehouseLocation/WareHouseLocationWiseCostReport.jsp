...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/WLR.in"/>">Warehouse Location Report</a> / <span>WareHouse Location
						Wise Cost Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'WhereHouse Location Wise Cost Report')" id="exportExcelBtn">
								...
								<div class="row1">
									...
									<div class="I-size">
										<input type="hidden" id="locationId"
											name="locationName" style="width: 100%;"
											required="required"
											placeholder="All" />
									</div>
								</div>
			...
			<div class="modal-dialog" style="width:950px;">
				...
				<div class="modal-content">
						...
						<div class="modal-header">
							...
							<h4 class="modal-title" id="JobType">Work Order
								Details</h4>
						</div>
		...
		<div class="modal fade" id="serviceEntryDetails" role="dialog">
			<div class="modal-dialog" style="width:950px;">
				<!-- Modal content-->
				<div class="modal-content">
						...
						<div class="modal-header">
							...
							<h4 class="modal-title" id="JobType">Service Entries
								Details</h4>
						</div>
						<div class="modal-body">
							<div class="box">
	...
	<script type="text/javascript"
	src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/warehouseLocation/WareHouseLocationWiseCostReport.js"/>"></script>
