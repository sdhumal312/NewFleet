		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/DSEREPORT.in"/>">Dealer Service Report</a>
				</div>
...
<%-- 					<sec:authorize access="hasAuthority('VIEW_VEN_SE_REPORT')"> --%>
						<div class="panel box box-primary">
							<div class="box-header with-border">
								<h4 class="box-title">
										<a 
											href="<c:url value="/dealerServiceReport"/>">Dealer Service Report </a>
								</h4>
							</div>
						</div>
<%-- 				   </sec:authorize> --%>
...
<!-- 								<h4 class="box-title"> -->
<!-- 										<a  -->
<%-- 											href="<c:url value="/VehicleServiceEntriesReport"/>"> Vehicle Wise Service Entries Report </a> --%>
<!-- 								</h4> -->
<!-- 							</div> -->
<!-- 						</div> -->
<%-- 				</sec:authorize> --%>
