		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/TDR.in"/>">Trip Collection Report</a> / <span>Day
						Wise Trip Collection Report</span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Day Wise Trip Collection Report')">
						...
						<div class="box-header with-border">
							<h4 class="box-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#TripCollectionSix">Date Range Wise Trip Collection
									Report </a>
							</h4>
						</div>
						<!-- <div id="TripCollectionSix" class="panel-collapse collapse"> -->
							<div class="box-body">
								<div class="form-horizontal ">
									...
									<form action="DateWiseAllGroupTDReport" method="post">
										<!-- Date range -->
										<div class="row1">
													...
													<tbody>
														<tr>
															<td align="center"><span class="text-bold">
																	Day Wise Trip Collection Report <c:out
												...
												<table id="advanceTable" style="width: 95%"
													...
													<tbody>
														...
														<%
															Integer hitsCount = 1;
														%>
														<c:forEach items="${TDALLGroup}" var="TDALLGroup">
															<tr data-object-id="" class="ng-scope closeAmount">
																...
																<td><a target="_blank" href="<c:url value="/#"/>"><c:out
																			value="${TDALLGroup.TRIP_OPEN_DATE}" /></a></td>

																<td><c:out value="${TDALLGroup.TOTAL_USAGE_KM}" /></td>
																<td><c:out value="${TDALLGroup.TOTAL_DIESEL}" /></td>
																<td><c:out
																		value="${TDALLGroup.TOTAL_TOTALPASSNGER}" /></td>
																<td><c:out value="${TDALLGroup.RFIDCARD}" /></td>
																<td><c:out value="${TDALLGroup.RFIDRCG}" /></td>
																<td><c:out value="${TDALLGroup.RFIDUSAGE}" /></td>
																<td><c:out value="${TDALLGroup.BUSCOLLECTION}" /></td>
																<td><c:out value="${TDALLGroup.EXPENSE_DAY}" /></td>
																<td><c:out value="${TDALLGroup.TOTAL_OVERTIME}" /></td>
																<td><c:out value="${TDALLGroup.TOTAL_BALANCE}" /></td>
															</tr>
														...
														<tr class="closeGroupAmount">
															...
															<td><c:out value="${TotalRFIDCARD}" /></td>
															<td><c:out value="${TotalRFIDRCG}" /></td>
															<td><c:out value="${TotalRFIDUSAGE}" /></td>
