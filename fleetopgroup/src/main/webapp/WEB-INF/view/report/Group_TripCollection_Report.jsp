		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/TCR.in"/>">Trip Collection Report</a>  /  <span>Daily Trip Collection Report</span>
				</div>
												...
												<c:if test="${!empty TripGroupCol}">
													...
													<c:forEach items="${TripGroupCol}" var="TripGroupCol">
														...
														<tr data-object-id="">
															...
															<td><c:out value="${TripGroupCol.TRIP_OPEN_DATE}" /></td>
