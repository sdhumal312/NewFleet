...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/FR.in"/>">Fuel </a> / <span id="reportHead">All Vehicles Mileage Report </span>
				</div>
	...
	<script type="text/javascript" 
	src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/FU/AllVehiclesMileageReport.js"/>"></script>
	<script
