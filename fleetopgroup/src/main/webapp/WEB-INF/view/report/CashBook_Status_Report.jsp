...
<%-- 					<div style="display: inline-block;">${CASHBOOK_DATE}</div> --%>
					...
					<sec:authorize access="hasAuthority('DOWNLOAD_CASHBOOK')">
						...
						<button class="btn btn-default btn-sm"
							onclick="advanceTableToExcel('advanceTable', 'Cashbook Status Report')">
	...
	<section class="content">
		...
		<!--Below Code may be useful in future Doubtful  -->
												...
												<div class="I-size">
													<div class="pull-left">
														<button type="submit" name="commit"
															class="btn btn-success" onclick="return validateCashBookStatusReport();">
												...
												<tbody>
													...
													<c:forEach items="${CashBook}" var="CashBook">
														<tr>
															...
															<td><c:out value="${CashBook.CASH_REFERENCENO}" /></td>
...
<script type="text/javascript"
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateCashBookStatusReport.js"/>"></script>
</div>