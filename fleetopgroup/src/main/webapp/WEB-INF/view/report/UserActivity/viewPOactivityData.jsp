...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					<a id="cancel" href="#">UserActivity</a> / PO Activity
				</div>
	...
	<section>
			<div class="row">
			<br>
				<div id="poCreatedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourC" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							...
							<h4 class="font-weight-normal mb-3">	
								Purchase Order Created <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="CreatePoCount"></h2>
						</div>
					</div>
				</div>
				<div id="poModifiedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourM" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
								Purchase Order Modified <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="UpdatedPoCount"></h2>
						</div>
					</div>
				</div>
				<div id="poDeletedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourD" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
							Purchase Order Deleted <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="DeletedPoCount"></h2>
						</div>
					</div>
				</div>
			</div>
...
<!-- 				</div> -->
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/userActivity/viewPOactivityData.js"/>"></script>
