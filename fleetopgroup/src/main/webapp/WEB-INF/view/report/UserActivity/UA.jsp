		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/ <a href="<c:url value="/UA.in"/>">User Activity</a>
				</div>
	...
	<section class="content">
		<div class="row">
			...
			<div class="col-md-offset-2 col-md-8 col-sm-8 col-xs-12">
						<sec:authorize access="hasAuthority('SHOW_USER_ACTIVITY_REPORT')">
						<div class="panel box box-primary">
							<div class="box-header with-border">
								<h4 class="box-title">
										<a 
											href="<c:url value="/viewUserActivity"/>">User Wise Activity Report  </a>
								</h4>
							</div>
						</div>
						</sec:authorize>
