...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					<a id="cancel" href="#">UserActivity</a> / Trip Sheet Activity
				</div>
	...
	<section>
		<!-- <div class="col-md-7 "> -->
			<br>
			<div class="row">
				<div id="tsCreatedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourC" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							...
							<h4 class="font-weight-normal mb-3">	
								Trip Sheet Created <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="tsCreateCount"></h2>
						</div>
					</div>
				</div>
				<div id="tsModifiedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourM" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
								Trip Sheet  Modified <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="tsUpdatedCount"></h2>
						</div>
					</div>
				</div>
				<div id="tsDeletedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourD" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
							Trip Sheet  Deleted <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="tsDeletedCount"></h2>
						</div>
					</div>
				</div>
			</div>
				...
				<div align="center" style="font-size: 12px; font-weight: bold;">
					...
					<thead >
						<tr class="bg-gradient-blueOne card-img-holder text-white">
							<th class="fit ar">TS Number</th>
							<th class="fit ar">Vehicle</th>
							<th class="fit ar">Trip Open & Close Date</th>
...
<!-- 											</table> -->
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/userActivity/viewTSActivityData.js"/>"></script>
