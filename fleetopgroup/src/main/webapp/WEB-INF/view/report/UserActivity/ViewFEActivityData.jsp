...
<div class="content-wrapper">
	...
	<section>
		<!-- <div class="col-md-7 "> -->
			<div class="row">
			<br>
				<div id="feCreatedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourC" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							...
							<h4 class="font-weight-normal mb-3">	
								Fuel Entries Created <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="feCreateCount"></h2>
						</div>
					</div>
				</div>
				<div id="feModifiedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourM" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
								Fuel Entries Modified <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="feUpdatedCount"></h2>
						</div>
					</div>
				</div>
				<div id="feDeletedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourD" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
								Fuel Entries Deleted <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="feDeletedCount"></h2>
						</div>
					</div>
				</div>
			</div>
...
<!-- 											</table> -->
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/userActivity/viewFEActivityData.js"/>"></script>
