...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					<a id="cancel" href="#">UserActivity</a> / Issues Activity
				</div>
	...
	<section>
			<div class="row">
			<br>
				<div id="issuesCreatedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourC" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							...
							<h4 class="font-weight-normal mb-3">	
								Issues Created <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="issuesCreateCount"></h2>
						</div>
					</div>
				</div>
				<div id="issuesModifiedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourM" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
								Issues Modified <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="issuesUpdatedCount"></h2>
						</div>
					</div>
				</div>
				<div id="issuesDeletedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourD" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
							Issues Deleted <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
							<h2 class="mb-5" id="issuesDeletedCount"></h2>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="table-responsive" id="userActivityListTable" style="display: none;">
				...
				<div align="center" style="font-size: 12px; font-weight: bold;">
					...
					<thead >
						<tr class="bg-gradient-blueOne card-img-holder text-white">
							<th class="fit ar">Issue Number</th>
							<th class="fit ar">Summary</th>
							<th class="fit ar">Vehicle</th>
							<th class="fit ar">Issues Type</th>
							<th class="fit ar">Assign To</th>
							<th class="fit ar">Issue Status</th>
							<th class="fit ar">Created Date</th>
							<th id="deletedColoumName" class="fit ar">Last Modified Date</th>
						</tr>
					</thead>
					<tbody id="IssueActivityDataBody">
					</tbody>
					</table>
				</div>
...
<!-- 											</table> -->
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/userActivity/viewIssuesActivityData.js"/>"></script>
