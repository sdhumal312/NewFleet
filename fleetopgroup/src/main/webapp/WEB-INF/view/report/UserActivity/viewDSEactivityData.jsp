...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					<a id="cancel" href="#">UserActivity</a> / DSE Activity
				</div>
					...
					<div id="backgroudColourC" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							...
							<h4 class="font-weight-normal mb-3">	
								Dealer Service Created <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
				...
				<div id="poModifiedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourM" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
								Dealer Service Modified <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
				...
				<div id="poDeletedDiv" class="col-sm-4 stretch-card grid-margin">
					<div id="backgroudColourD" class="card bg-gradient-blueOne card-img-holder text-white  ">
						<div class="card-body">
							<img src="resources\QhyvOb0m3EjE7A4\images\summary\circle.svg" alt="Consumpetion" class="card-img-absolute">
							<h4 class="font-weight-normal mb-3">	
							Dealer Service Deleted <em class="mdi mdi-chart-line mdi-24px float-right"></em>
							</h4>
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/userActivity/viewDSEactivityData.js"/>"></script>
