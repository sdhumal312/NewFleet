...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<!--SRS Travels Branch Wise Trip Sheet Advances Report By Dev Yogi Start -->
					...
					<!-- Branch wise Trip sheet Report -->
					<div class="tab-pane" id="TSReport">
						<div class="panel box box-primary">
							<div class="box-header with-border">
								<h4 class="box-title">
									<a data-toggle="collapse" data-parent="#accordion"
										href="#TripsheetBranch">Branch Wise Trip sheet Advances
										Report </a>
								</h4>
							</div>
							<!-- <div id="TripsheetBranch" class="panel-collapse collapse"> -->
								<div class="box-body">
									<form action="BranchwiseTSAdvanceReport" method="post">
										<div class="form-horizontal ">
										<input type="hidden" id="validateGroup" value="${configuration.groupValidationinBranchWiseAdvanceReport}">
											<div class="row1">
												...
												<div class="I-size">
													<input class="" placeholder="Branch name"
														id="branchnamelist" type="hidden" style="width: 100%"
														name="TRIP_BRANCH"
											...
											<div class="row1">
												<label class="L-size control-label">Group:
												 <c:if test="${!configuration.groupValidationinBranchWiseAdvanceReport}">
													...
													<div class="I-size">
														<div class="pull-left">
															<button type="submit" name="commit"
																class="btn btn-success" onclick="return validateBranchWiseTripSheetAdvancesReport();">
	...
	<script
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/ValidateBranchWiseTripSheetAdvancesReport.js"/>"></script>
	<script type="text/javascript" 
