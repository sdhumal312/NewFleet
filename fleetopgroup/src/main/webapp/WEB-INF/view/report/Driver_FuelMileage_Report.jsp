		...
		<div class="box">
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('advanceTable', 'Driver Fuel Mileage Report')">
								...
								<form action="DriverWiseFuelMileageReport" method="post">
									<div class="form-horizontal ">
										...
										<div class="row1">
											...
											<div class="I-size">
												<input type="hidden" id="vehicleGrpId18"
													name="vehicleGrpId5" style="width: 100%;"
										...
										<div class="row1">
											...
											<div class="I-size">
												 <!-- <input type="hidden" id="DriverAdList" name="TRIP_DRIVER_ID"
													...
													<select style="width: 100%;" id="driverofdepot18"
														 name="TRIP_DRIVER_ID">
														</select> <span id="tyreModelIcon" class="">
													<label
													id="errorDriver2" class="error"> 
													</label>
											</div>
										</div>
										<!-- Date range -->
										...
										<fieldset class="form-actions">
											<div class="row1">
												...
												<div class="I-size">
													<div class="pull-left">
														<button type="submit" name="commit" onclick="return validateDriverWiseFuelMilageReport();"
													...
													%>
														<c:forEach items="${TripDaily}" var="TripDaily">
															<tr data-object-id="" class="ng-scope closeAmount">
																...
																<td><c:out value="${TripDaily.TRIP_DRIVER_NAME}" /></td>
																<td><a target="_blank"
