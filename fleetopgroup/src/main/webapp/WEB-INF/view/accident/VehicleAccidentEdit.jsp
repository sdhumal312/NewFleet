...
<div class="content-wrapper">
			  ...
			  <input type="hidden" id="accidentClaimConfig" value="${configuration.accidentClaim}">
			   <input type="hidden" name="status" id="status" />
						...
						<b>Other Vehicle Details (If any) <a class=" btn btn-default"
											...
											<div class="form-group column ">
					                         ...
					                         <div class="form-group column ">
					                            ...
					                            <div class="col-md-8 inputGroupContainer">
					                               ...
					                               <span class="input-group-addon"><i class="fa fa-book"></i></span>
					                             	 <input class="string required form-control"
														name="otherDriverMob" maxlength="50" type="text" id="otherDriverMob"
														onkeypress="return IsAdvanceRefence(event);"
														ondrop="return false;"> 
					                               </div>
					                            </div>
							...
							<div class="box">
									<div class="box-body">
								<div id="firDetails" style="display: none;">
									<div class="box">
										<div class="box-body">
											<div class="form-group column ">
										...
										<div class="box-body">
											<div class="form-group column ">
					                         ...
					                         <div class="form-group column ">
					                            ...
					                            <div class="col-md-4">
					                             <div class='btn-group'>
						                             <label id="yes" class='btn btn-default  btn-sm active' > Yes </label>  
						                             <label id="no" class='btn btn-default  btn-sm'> No </label> 
					                             </div>
								...
								<div class="row1">
									...
									<div class="pull-right">
										...
										<button type="submit" id="saveAccidentDetails" class="btn btn-success"
											onclick="return updateAccidentDetails();">Save</button>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/accident/VehicleAccidentEdit.js" />"></script>
	<script type="text/javascript"
