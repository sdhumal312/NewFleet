...
<div class="content-wrapper">
	...
	<section class="content">
					...
					<%-- <c:if test="${true}">
						...
						<div class="form-horizontal ">
											 ...
											 <div class="form-group">
					                            ...
					                            <div class="col-md-9 inputGroupContainer">
					                               ...
					                               <span class="input-group-addon">
					                              	 ...
					                              	 <input type="hidden" id="ServiceSelectVehicle" name="vid" style="width: 100%;" 
							...
							<div class="panel-footer">
								...
								<div class="I-size">
									<button type="submit" id="saveReminder" class="btn btn-success" onclick="createServiceReminder();">Create
				...
				setTimeout(function(){
					if(Number($('#vehicleId').val()) > 0){
						$('#ServiceSelectVehicle').select2('data', {
							id : $('#vehicleId').val(),
							text : '${vehicle.vehicle_registration}'
						});
						$("#ServiceSelectVehicle").select2("readonly", true);
					}	
	    ...
	    <script type="text/javascript"
			src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/SR/SeviceReminderAdd.js" />"></script>		
		<script
