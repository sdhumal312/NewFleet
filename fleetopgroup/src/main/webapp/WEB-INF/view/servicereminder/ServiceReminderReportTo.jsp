			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open"/>"><spring:message
						...
						Reminder</a> / <a href="<c:url value="/ServiceReminderReport.in"/>">
						Service Reminder Report</a> / <small>Search Service Reminder</small>
				</div>
				<div class="col-md-off-5">
					...
					<a href="<c:url value="/ServiceReminderReport.in"/>"> Cancel</a>
				</div>
			</div>
		</div>
	</section>
