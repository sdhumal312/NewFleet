		...
		<div class="box">
			<div class="box-body">
				...
				<div class="col-md-off-5">
					<div class="col-md-3">
						<form action="<c:url value="/searchServiceReminderShow.in"/>"
							method="post">
					...
					<sec:authorize access="hasAuthority('ADD_SERVICE_REMINDER')">
						<a class="btn btn-success btn-sm"
							href="<c:url value="/addServiceReminder.in"/>"> <span
					...
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">Overdue</span> <a data-toggle="tip"
								...
								href="<c:url value="/OverDueService/1.in"/>"><span
								class="info-box-number">${TodayOverDueServiceRemindercount}</span></a>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-3 col-xs-12">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">Due Soon</span> <a data-toggle="tip"
								...
								href="<c:url value="/DueSoonService.in"/>"><span
								class="info-box-number">${TodayDueServiceRemindercount}</span></a>
																...
																<c:choose>
																	<c:when test="${Service.servicestatus != 'INACTIVE'}">
																		<li><sec:authorize
																				...
																				<a
																					href="<c:url value="/addServiceWorkOrder.in?service_id=${Service.service_id}"/>">
																		...
																		<li><sec:authorize
																				...
																				<a
																					href="<c:url value="/VehicleServiceEdit.in?service_id=${Service.service_id}"/>">
																		...
																		<li><sec:authorize
																				...
																				<a
																					href="<c:url value="/deleteServiceReminder.in?service_id=${Service.service_id}"/>"
																					class="confirmation"
