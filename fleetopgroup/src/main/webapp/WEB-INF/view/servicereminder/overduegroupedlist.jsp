...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a style="font-size: 16px;" href="<c:url value="/open"/>"><spring:message
					...
					/ <span id="reportHead" style="font-size: 16px;" >OverDue Service Reminder Details </span>
				</div>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/SR/ViewOverDueOverdueList.js"/>"></script>
