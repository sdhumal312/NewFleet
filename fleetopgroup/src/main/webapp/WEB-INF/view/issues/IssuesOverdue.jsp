	...
	<section class="content">
		...
		<sec:authorize access="hasAuthority('VIEW_ISSUES')">
			...
			<div class="row">
				...
				<c:url var="firstUrl" value="/issuesOverdue/1" />
				<c:url var="lastUrl" value="/issuesOverdue/${deploymentLog.totalPages}" />
				<c:url var="prevUrl" value="/issuesOverdue/${currentIndex - 1}" />
				<c:url var="nextUrl" value="/issuesOverdue/${currentIndex + 1}" />
				<div class="text-center">
					<ul class="pagination pagination-lg pager">
						...
						<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
							<c:url var="pageUrl" value="/issuesOverdue/${i}" />
							<c:choose>
