			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open"/>"><spring:message
						...
						href="<c:url value="/issuesOpen/1.in"/>">Issues</a>
				</div>
	...
	<section class="content">
		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('VIEW_ISSUES')">
				...
				<!--pagination  -->	
				<c:url var="firstUrl" value="/${issueUrl}/1" />
				<c:url var="lastUrl" value="/${issueUrl}/${deploymentLog.totalPages}" />
				<c:url var="prevUrl" value="/${issueUrl}/${currentIndex - 1}" />
				<c:url var="nextUrl" value="/${issueUrl}/${currentIndex + 1}" />
				<div class="text-center">
					<ul class="pagination pagination-lg pager">
						...
						<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
							<c:url var="pageUrl" value="/${issueUrl}/${i}" />
							<c:choose>
