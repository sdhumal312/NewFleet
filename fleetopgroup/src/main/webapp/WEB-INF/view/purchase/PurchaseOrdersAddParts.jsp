...
<link rel="stylesheet"
	...
	<script src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/select/AddMore.js" />"></script>
<link rel="stylesheet"
				...
				<div class="pull-left">
					...
					<div class="pull-right">
						...
						<c:if test="${!empty PurchaseOrderPart}">
							<sec:authorize access="hasAuthority('APPROVE_BELOW_FIFTY')">
							 <c:if test="${PurchaseOrder.purchaseorder_totalcost <= 50000 && poConfiguration.poApprovalRequired && PurchaseOrder.approvalStatus == 0}">
								<button class="btn btn-info btn-sm" onclick="openApprovePopup();">
									Make Approval
								</button>
							</c:if>
							</sec:authorize>
							<sec:authorize access="hasAuthority('APPROVE_ABOVE_FIFTY')">
							 <c:if test="${PurchaseOrder.purchaseorder_totalcost > 50000 && poConfiguration.poApprovalRequired && PurchaseOrder.approvalStatus == 0}">
								<button class="btn btn-info btn-sm" onclick="openApprovePopup();">
									Make Approval
								</button>
					...
					<div class="col-md-6">
						<div class="row">
							<input type="hidden" id="statues" name="statues"
								...
								<input type="hidden" id="locationWisePartCount" name="locationWisePartCount" value="${poConfiguration.locationWisePartCount}">
								<input type="hidden" id="showSustitutePartCount" name="showSustitutePartCount" value="${poConfiguration.showSustitutePartCount}">
							
								<input type="hidden" id="fromTransfer" name="fromTransfer" value="${fromTransfer}">
								<input type="hidden" id="partFound" name="partFound" value="${partFound}">
								<input type="hidden" id="transactionName"  value="${rTransactionName}">
								<input type="hidden" id="transactionId" name="transactionId" value="${rTransactionId}">
								<input type="hidden" id="poOpenedOnDate" name="poOpenedOnDate" value="${PurchaseOrder.purchaseorder_created_on}">
				...
				<div class="row">
					<div class="col-md-3">
						<dl class="dl-horizontal">
							...
							<c:if test="${poConfiguration.poApprovalRequired}">
							<dt>Approved Status :</dt>
							<dd>
								<c:out value="${PurchaseOrder.approvalStatusStr}" />
							</dd>
							</c:if>
							<c:if test="${poConfiguration.poApprovalRequired && PurchaseOrder.approvedById != null}">
							<dt>Approved By :</dt>
							<dd>
								<c:out value="${PurchaseOrder.approvedBy}" />
							</dd>
							</c:if>
							<c:if test="${poConfiguration.poApprovalRequired && PurchaseOrder.approvalRemark != null}">
							<dt>Approved Status :</dt>
							<dd>
								<c:out value="${PurchaseOrder.approvalRemark}" />
							</dd>
							</c:if>
						</dl>
					</div>
				...
				<fieldset>
					...
					<div class="row">
						...
						<div class="col-md-11">
							...
							<input type="hidden" id="subtotalCost" value="${PurchaseOrder.purchaseorder_subtotal_cost}">
							<input type="hidden" id="locationId" value="${PurchaseOrder.purchaseorder_shiplocation_id}">
							<input type="hidden" id="makeApprovalApproval" value="${poConfiguration.makeApproval}">
							<input type="hidden" id="poApprovalRequired" value="${poConfiguration.poApprovalRequired}">
														...
														<c:choose>
															<c:when
																...
																<samp style="color: red;">
																	Already You have
																	${PurchaseOrderPart.inventory_all_quantity} ${PurchaseOrderPart.convertToStr} Quantity in
																	stock . <a
																		href="showInventory.in?inventory_all_id=${PurchaseOrderPart.inventory_all_id}"
														...
														<div class="btn-group">
															...
															<ul class="dropdown-menu pull-right">
																<li><sec:authorize
																		...
																		<c:if test="${!poConfiguration.poApprovalRequired || PurchaseOrder.approvalStatus == 0}">
																			<a
																	...
																	<li>
																	<sec:authorize
																		access="hasAuthority('DELETE_PURCHASE_AFTER_APPROVAL')">
																		<c:if test="${!poConfiguration.poApprovalRequired || PurchaseOrder.approvalStatus == 1}">
																			<a
																				href="deletePurchaseOrderToPart.in?purchaseorderto_partid=${PurchaseOrderPart.purchaseorderto_partid}"
																				class="confirmation"
																				onclick="return confirm('Are you sure? Delete ')">
																	...
																	<c:if test="${poConfiguration.editPartDetails}">
 																		<c:choose>
																			<c:when test="${PurchaseOrderPart.approvalPartStatusId == 1}">
																				<li>
																					<a href="#" onclick="editPurchaseOrderPartDetails('${PurchaseOrderPart.partid}', '${PurchaseOrderPart.purchaseorder_partname}','${PurchaseOrderPart.TYRE_MODEL_ID}', '${PurchaseOrderPart.TYRE_MODEL}','${PurchaseOrderPart.TYRE_SIZE_ID}', '${PurchaseOrderPart.TYRE_SIZE}','${PurchaseOrderPart.purchaseorderto_partid}','${PurchaseOrderPart.quantity}','${PurchaseOrderPart.parteachcost}','${PurchaseOrderPart.discount}','${PurchaseOrderPart.tax}','${PurchaseOrderPart.totalcost}')">Edit Part</a> 
																				</li>
																			</c:when>
																			<c:otherwise>
																			<li>
												...
												<div class="">
													<div id="changePart" style="display: none">
														<form id="formPOAddParts"
															action="<c:url value="/savePurchaseOrderPart.in"/>"
															...
															<div class="row" id="grppoParts" class="form-group">
																<div class="col-md-4">
																	...
																	<input type="hidden" name="partid" id="inventory_name"
																		...
																		required="required" onchange="getLastPartCostDetails(this.id)"
																...
																<div class="col-md-1">
																	...
																	<input type="text" class="form-text" placeholder="Qty" 
																		...
																		onkeyup="calculatePurchageOrder(this);getTotalCost();"
																		min="0.00"> <span id="quantityIcon" class=""></span>
																	<div id="quantityErrorMsg" class="text-danger"></div>
																</div>
																<div class="col-md-1">
																	<!--check text-->
																	<!-- onkeypress="return isNumberKeyEach(event);" --><!--Original-->
																	<input type="text" name="parteachcost" step="any" onpaste="return false"
																		class="form-text" placeholder="each cost"
														...
														<div class="help-block" id="lastPOpartDetails"></div>
															...
															<div class="row">
																...
																<div><button type="button"  class="btn btn-info addMorePartButton" style="background:lightseagreen;"><span class="fa fa-plus"></span></button></div>
															</div>
														<br>
														<br>
														<div class="row">
														<div class="col-md-5 col-md-offset-8">
															<label><b>Total Cost of all Parts : </b> </label>
															<input type="text" id="Ftotal" class="form-text" style="width: 200px;" value="0"  readonly />
															<br>
																	<button type="submit" id="savePart" onclick="return validatePartSave();" class="btn btn-success">Add Part</button>
																</div>
															</div>
														</form>
													</div>
									...
									<tfoot>
										<tr class="breadcrumb">
											<th colspan="8"><a id="addParts"
												...
												href="javascript:toggle2('changePart','addParts');"> Add
													Parts </a></th>
										</tr>
									</tfoot>
								</table>
											...
											<form action="OrderedPurchaseOrder.in" method="post"
												...
												<div class="form-horizontal ">
													...
													<div class="row1">
														...
														<div class="col-md-3">				
															<!--check id advanceAmount --> <!-- onkeypress="return IsNumericAmount(event);" -->
															<input type="text" class="form-text"
																name="purchaseorder_advancecost" required="required" onpaste="return false" 
																id="advanceAmount" onkeypress="return isNumberKeyWithDecimal(event,this.id)"
																value="0"
												...
												<c:if test="${PurchaseOrder.approvalStatus == 1}">	
													<fieldset class="form-actions">
														<div class="row">
															<div class="col-md-10 col-md-offset-2">

																<input class="btn btn-success" type="submit"
																	class="confirmation" id="sentPurchaseOrder"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="box">
					<div class="box-body">
						<div class="row1" id="grpselectVendor" class="form-group">
							<label class="L-size control-label" for="selectVendor">Part Name
								<abbr title="required">*</abbr>
							</label>
							<div class="I-size" >
								<!-- <input type="hidden"  style="width: 100%;" id="partName"  placeholder="Please Enter 2 or more Part Name" /> -->
								<input type="hidden" name="partid" id="partName"
									required="required" style="width: 100%;"
									required="required"
									placeholder="Please Enter 2 or more Part Name" /> <span
									id="PurchaseOrders_idIcon" class=""></span>
									...
									<c:when test="${PurchaseOrderPart.approvalPartStatusId == 1}">
										<tr data-object-id="" class="ng-scope">
													<td class="fit">
														...
														<input type="hidden" id="approvalPartId${PurchaseOrderPart.purchaseorderto_partid}" value="${PurchaseOrderPart.partid}" name="approvalPurchaseOrderPartId"> 
														<a href="#" onclick="getLocationWisePartQuantity(${PurchaseOrderPart.partid},${PurchaseOrderPart.purchaseorderto_partid});">
...
<div class="modal fade" id="locationPartDetailsModal" role="dialog">
	<div class="modal-dialog" style="width: 90%;">
		...
		<div class="modal fade" id="subPartDetails" role="dialog">
			<div class="modal-dialog" style="width: 980px;">
				<div class="modal-content">
						<div class="modal-header">
							...
							<h3 class="modal-title">Substitute parts :</h3>
						</div>
						<div class="modal-body">
		...
		<div class="modal fade" id="poApprovalModal" role="dialog">
			<div class="modal-dialog" style="width: 980px;">
				<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"
								...
								<div class="box">
									<div class="box-body">
										<div class="row1 form-group">
													<label class="L-size control-label" for="to">Remark<abbr title="required">*</abbr></label>
													<div class="I-size">
														<div class="col-md-8">
															<textarea class="form-text" id="approvalRemark"
																	name="approvalRemark" rows="5" maxlength="2240">	
																</textarea>
														</div>
													</div>
										</div>
						...
						<div class="modal-footer">
							<button type="submit" class="btn btn-success" onclick="approveStatusOfPO();" > Approve PO
							</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">
								<span id="Close"><spring:message code="label.master.Close" /></span>
							</button>
						...
						$("#advanceAmount")
								.keyup(
										function() {
											...
											if (advAmt > subAmt) {
												showMessage('info',
														'Advance Amount Can Not Be Greater Than Total Added Part Amount ');
												$("#advanceAmount").val(0);
												return false;
											}
