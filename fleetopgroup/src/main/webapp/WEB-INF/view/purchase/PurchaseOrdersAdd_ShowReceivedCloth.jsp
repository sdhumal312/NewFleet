				...
				<div class="pull-left">
					...
					<div class="pull-right">
						<sec:authorize access="hasAuthority('CHANGE_PO_FROM_RECEIVED_TO_ORDERED')">
							<a class="btn btn-warning btn-sm" onclick="changeUpholsteryPOToOrderedStatus()"
			...
			<sec:authorize access="hasAuthority('VIEW_PURCHASE')">
				...
				<fieldset>
					...
					<div class="row">
						...
						<input type="hidden" id="purchaseOrderNumber" value="${PurchaseOrder.purchaseorder_Number}">
											...
											<tbody>
												<c:if test="${!empty PurchaseOrderPart}">
													<c:forEach items="${PurchaseOrderPart}"
														...
														<c:if test="${PurchaseOrderPart.approvalPartStatusId == 2 && (PurchaseOrderPart.quantity - PurchaseOrderPart.received_quantity) >0}">
