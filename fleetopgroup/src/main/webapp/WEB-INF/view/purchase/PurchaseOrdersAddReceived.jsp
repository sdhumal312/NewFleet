	...
	<section class="content">
		<div class="box">
			...
			<sec:authorize access="hasAuthority('VIEW_PURCHASE')">
						...
						<div class="row">
							...
							<div id="work-order-statuses">
								<div id="work-order-statuses">
									 ...
									 <c:if test="${PurchaseOrder.purchaseorder_status == 'ORDERED'}"><a
										href="PurchaseOrders_PartsReEnter.in?ID=${PurchaseOrder.purchaseorder_id}"
									...
									<button type="button" class="btn btn-default"
										style="width: 15%" data-toggle="modal"
										data-target="#addPurchaseOrderDocument" data-whatever="@mdo">
								...
								<a class="btn btn-success" data-disable-with="..."
									href="work_orders_COMPLETE.in?PurchaseOrders_id=${PurchaseOrder.purchaseorder_id}">Complete</a>
							</div> --%>
				...
				<c:if test="${param.invalidReceivedQty eq true}">
					<div class="alert alert-success">
						<button class="close" data-dismiss="alert" type="button">x</button>
						Can Not Received More than Ordered Quantity.
					</div>
				</c:if>
				...
				<div class="row">
					...
					<input type="hidden" id="allowToReceivePartial" name="allowToReceivePartial" value="${allowToReceivePartial}">
					<input type="hidden" id="poStatusId" name="poStatusId" value="${PurchaseOrder.purchaseorder_statusId}">
					...
					<div class="col-md-3">
						...
						<dl class="dl-horizontal">
							...
							<dt>Notes :</dt>
							<dd style="word-wrap: break-word"> <!--latest  -->
													...
													<c:forEach items="${PurchaseOrderPart}"
														...
														<tr data-object-id="" class="ng-scope">
															...
															<td><c:out
																...
																<c:out
																	value="${PurchaseOrderPart.purchaseorder_partnumber}" />
																<br> <c:choose>
																	<c:when
																		test="${PurchaseOrderPart.inventory_all_quantity != 0.0}">
																		<samp style="color: red;">
																			Already You have
																			${PurchaseOrderPart.inventory_all_quantity} ${PurchaseOrderPart.convertToStr} Quantity
																			in stock . <a
															...
															<td  class="fit ar">${PurchaseOrderPart.quantity}
															<input type="hidden" id="quantity_${PurchaseOrderPart.purchaseorderto_partid}" name="quantity" value="${PurchaseOrderPart.quantity}">	
															<input type="hidden" id="remainingQuantity_${PurchaseOrderPart.purchaseorderto_partid}" name="remainingQuantity" value="${PurchaseOrderPart.quantity - PurchaseOrderPart.received_quantity}">	
															
															</td>
															<c:choose>
																<c:when test="${PurchaseOrderPart.approvalPartStatusId == 2}">
																	<td class="fit ar">
																		<a id="received${PurchaseOrderPart.purchaseorderto_partid}" data-remote="true"
																			href="javascript:toggleReceived_quantity('received_quantity${PurchaseOrderPart.purchaseorderto_partid}','received${PurchaseOrderPart.purchaseorderto_partid}');">
																			<i class="fa fa-cube" style="color: red"></i>
																		</a>
																	<a> ${PurchaseOrderPart.received_quantity}</a>
																		<sec:authorize access="hasAuthority('RECEIVED_PURCHASE')">
																			<div class="popup-edit hide-on-escape"
																				...
																				<form action="PurchaseOrdersUpdate_ReceivedQuantity.in" method="post">
																					<div class="row1">
																						<label class="control-label">Receive Quantity</label>
																						<div class="input float optional work_order_tax_cost">
																							<input name="purchaseorderto_partid" type="hidden" required="required" value="${PurchaseOrderPart.purchaseorderto_partid}">
																							<input class="form-text" name="received_quantity" maxlength="10" onpaste="return false" id="receivedQuantity1_${PurchaseOrderPart.purchaseorderto_partid}"
																								type="text" required="required" min="0" onkeyup=" return receiveQuantityValidation(this)" onkeypress="return isNumberKeyWithDecimal(event,this.id)"
																								max="${PurchaseOrderPart.quantity}"  value="${PurchaseOrderPart.received_quantity}">  <!-- step="0.01" -->
																						</div>
																					</div>
																					<div class="row1">
																						<label class="control-label">Receive Remark</label>
																						<div class="input float optional work_order_tax_cost">
																							<input class="form-text" name="received_quantity_remark" type="text" maxlength="199" placeholder="Remarks">
																						</div>
																					</div>
																					<div class="row1">
																						<input class="btn btn-success" name="commit" id="receivePart" onclick="return validatePartReceive();"
																...
																<c:otherwise>
																	<td class="fit ar">${PurchaseOrderPart.received_quantity}</td>
								...
								<div class="col-md-8">
									<div class="row">
										<div class="col-md-5">
											<div class="box box-success">
												<div class="box-body no-padding">
													<table class="table table-striped" style="table-layout: fixed; width: 100%"><!--check style-->
														<tbody>
															<tr class="row">
															...
															<tr class="row">
																...
																<th class="key">Remarks:</th><!--check style-->
										...
										<div class="col-md-5">
											<sec:authorize access="hasAuthority('RECEIVED_PURCHASE')">
												<c:if test="${!empty PurchaseOrderPart}">
													<form action="ReceivedPurchaseOrder.in" method="post"
														...
														<div class="form-horizontal ">
															...
															<div class="row1">
																...
																<div class="I-size">
																	<textarea class="text optional form-text"
																		id="initial_note" name="purchaseorder_received_remark"
																		rows="2" maxlength="500">
				                                                  </textarea>
																</div>
															</div>
															<div class="row1">
																<label class="L-size control-label">Invoice NO:
																	<abbr title="required">*</abbr>
																</label>
																<div class="I-size">
																	<input type="text" class="form-text" onpaste="return false" id="invoiceno"
																		name="purchaseorder_invoiceno" required="required" maxlength="250">

																</div>
															</div>
															<div class="row1">
																<label class="L-size control-label">Invoice
																...
																<div class="I-size">
																	<div class="input-group input-append date"
																		...
																		<input type="text" class="form-text"
																			name="purchaseorder_invoice_date"
															...
															<div class="row1">
																<label class="L-size control-label">Received By:
																	<abbr title="required">*</abbr>
																</label>
																<div class="I-size">
																	<input type="text" class="form-text"
																		readonly="readonly" name="purchaseorder_receivedby"
																		required="required" value="${CreatedBy}">
																...
																<div class="row">
																	<div class="col-md-10 col-md-offset-2">
																		...
																		<input class="btn btn-success" type="submit"
																			class="confirmation" id="receivePO"
																			onclick="return receivePurchaseOrder();"
																			value="Received"> <a class="btn btn-link"
...
<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/PO/PurchaseOrdersReceived.js" />"></script> 