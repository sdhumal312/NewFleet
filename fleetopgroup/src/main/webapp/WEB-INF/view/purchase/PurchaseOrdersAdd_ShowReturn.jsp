							...
							<div id="work-order-statuses">
								<div id="work-order-statuses">
									...
									<sec:authorize access="hasAuthority('DOWNLOND_PURCHASE')">
										<a style="width: 10%"
											href="PrintPurchaseReturn?id=${PurchaseOrder.purchaseorder_id}"
					...
					<div class="row">
						...
						<div class="col-md-11">
							<div class="box box-success">
								<h4>Debit Note No. ${PurchaseOrder.purchaseorder_Number}</h4>
															...
															<td class="fit ar"><a
																...
																<ul class="dropdown-menu pull-right">
																	<li><sec:authorize
																			...
																			<a
																				href="<c:url value="/deleteReturnPO.in?PDID=${PurchaseOrderDebitNote.purchaseorderto_debitnoteid}&ID=${PurchaseOrder.purchaseorder_id}"/>"
																				class="confirmation"
							...
							<div class="row">
								<div class="col-md-8">
									<div class="row">
										<div class="col-md-5">
											<div class="box box-success">
												<div class="box-body no-padding"><!--latest  table-striped-->
											...
											<table class="table table-striped">
												<tbody>
													...
													<tr class="row">
														<th class="key">Total Return :</th>
														<td class="value"><c:out value="${TotalReturn}" /></td>
													</tr>
												</tbody>
											</table>
										</div>
...
<script type="text/javascript"
	src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/select2.full.min.js" />"></script>
<script type="text/javascript"
