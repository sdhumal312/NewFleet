				...
				<div class="row">
					...
					<div class="pull-right">
						<sec:authorize access="hasAuthority('CHANGE_PO_FROM_RECEIVED_TO_ORDERED')">
							<a class="btn btn-warning btn-sm" onclick="changeTyrePOToOrderedStatus()"
					...
					<div class="row">
						...
						<c:if test="${param.SaveInventory eq true}">
							<div class="alert alert-success">
								<button class="close" data-dismiss="alert" type="button">x</button>
								This Purchase Order Received Tyre Successfully To Inventory.
							</div>
						</c:if>
											...
											<tbody>
												<c:if test="${!empty PurchaseOrderPart}">
													<c:forEach items="${PurchaseOrderPart}"
														...
														<c:if test="${PurchaseOrderPart.approvalPartStatusId == 1 || PurchaseOrderPart.approvalPartStatusId == 2 && (PurchaseOrderPart.quantity - PurchaseOrderPart.received_quantity) >0}">
