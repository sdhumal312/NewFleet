...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<sec:authorize access="hasAuthority('VIEW_PURCHASE')">
				...
				<div class="col-md-4 col-sm-5 col-xs-12">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">REQUISITION APPROVED</span> <span
			...
			<c:if test="${param.sequenceNotDefined eq true}">
				<div class="alert alert-danger">
					<button class="close" data-dismiss="alert" type="button">x</button>
					Sequence Not Defined Please contact to System Administrator!<br>
				</div>
			</c:if>
			...
			<div class="row">
				<div class="main-body">
									...
									<li role="presentation" ><a
								 	...
								 	<c:if test="${configuration.requisitionApproved}"> 
										<li role="presentation" class="active"><a
											href="<c:url value="/PurchaseOrders_APPROVED/1.in"/>"
									 ...
									 <li role="presentation"><a
										href="<c:url value="/PurchaseOrders_ORDERED/1.in"/>">ORDERED
										<span
											data-toggle="tip" title="" class="badge bg-yellow"
					...
					<c:if test="${!empty PurchaseOrder}">
								...
								<table id="PurchaseOrdersTable" class="table table-hover table-bordered">
									...
									<tbody>
										...
										<c:forEach items="${PurchaseOrder}" var="PurchaseOrder">
											...
											<c:if test="${PurchaseOrder.purchaseorder_statusId == 1}">		
												<td class="icon">
													<div class="btn-group ">
														...
														<ul class="dropdown-menu pull-right">
															<li><sec:authorize
																	access="hasAuthority('EDIT_PURCHASE')">
																	<a
						...
						<c:url var="firstUrl" value="/PurchaseOrders_APPROVED/1" />
						<c:url var="lastUrl"
							value="/PurchaseOrders_APPROVED/${deploymentLog.totalPages}" />
						<c:url var="prevUrl"
							value="/PurchaseOrders_APPROVED/${currentIndex - 1}" />
						<c:url var="nextUrl"
							value="/PurchaseOrders_APPROVED/${currentIndex + 1}" />
						<div class="text-center">
							<ul class="pagination pagination-lg pager">
								...
								<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
									<c:url var="pageUrl" value="/PurchaseOrders_APPROVED/${i}" />
									<c:choose>
