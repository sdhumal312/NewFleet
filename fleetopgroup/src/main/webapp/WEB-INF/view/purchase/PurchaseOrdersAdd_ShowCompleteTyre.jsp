						...
						<div class="panel panel-success">
							<div class="panel-body">
								<div class="col-md-11">
									...
									<div class="box box-success">
										<h4>
											<span class="label label-success">Order Tyre</span>
										</h4>
							...
							<h4>
								...
								<table class="table">
									...
									<div class="box box-success">
										<h4>
											<span class="label label-danger">Return Tyre</span>
										</h4>
										<div class="box-body no-padding">
											<div class="table-responsive">
												<table class="table" style="margin-bottom: 0px">
														...
														<c:if test="${!empty PurchaseOrderDebitNote}">
															...
															<c:forEach items="${PurchaseOrderDebitNote}"
																...
																<tr data-object-id="" class="ng-scope">
																	...
																	<!-- Tast table to assing part value table -->
																	<td><c:out
																			value="${PurchaseOrderDebitNote.TYRE_MANUFACTURER}" /><br>
																		<c:out value="${PurchaseOrderDebitNote.TYRE_MODEL}" /></td>
																	<td><c:out
																			value="${PurchaseOrderDebitNote.TYRE_SIZE}" /></td>
																	<td><c:out
