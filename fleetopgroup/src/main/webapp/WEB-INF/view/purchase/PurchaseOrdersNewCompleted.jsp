				...
				<div class="col-md-4 col-sm-5 col-xs-12">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">COMPLETED</span> <span
			...
			<div class="row">
				<div class="main-body">
							...
							<div class="row">
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation" class="active"><a
										href="<c:url value="/PurchaseOrders_COMPLETED/1.in"/>"
					...
					<c:if test="${!empty PurchaseOrder}">
						...
						<c:url var="firstUrl" value="/PurchaseOrders_COMPLETED/1" />
						<c:url var="lastUrl"
							value="/PurchaseOrders_COMPLETED/${deploymentLog.totalPages}" />
						<c:url var="prevUrl"
							value="/PurchaseOrders_COMPLETED/${currentIndex - 1}" />
						<c:url var="nextUrl"
							value="/PurchaseOrders_COMPLETED/${currentIndex + 1}" />
						<div class="text-center">
							<ul class="pagination pagination-lg pager">
								...
								<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
									<c:url var="pageUrl" value="/PurchaseOrders_COMPLETED/${i}" />
									<c:choose>
