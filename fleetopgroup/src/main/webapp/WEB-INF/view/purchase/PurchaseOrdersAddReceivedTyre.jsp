												...
												<c:if test="${!empty PurchaseOrderPart}">
													<c:forEach items="${PurchaseOrderPart}"
														...
														<c:choose>
															...
															<td><c:out value="${PurchaseOrderPart.TYRE_SIZE}" />
															</td>
															...
															<td class="fit ar"><c:if
																	...
																	<a
																		...
																		data-remote="true"
																		onclick="javascript:getMultiTyreInput('multilTyre${PurchaseOrderPart.purchaseorderto_partid}','${PurchaseOrderPart.notreceived_quantity}', '${PurchaseOrderPart.TYRE_SIZE}' );"
																	...
																	<div style="display: none;"
																		...
																		<form action="PurchaseOrdersaveTyreInfo.in"
																			method="post">
																			<div class="row">
																				...
																				<div class="col-md-10">
																					<div class="row">
																						...
																						<div class="col-md-3">
																							<label class="control-label">Tyre Serial
																								NO</label>
									...
									<div class="row">
										...
										<div class="col-md-5">
											<sec:authorize access="hasAuthority('RECEIVED_PURCHASE')">
												<c:if test="${!empty PurchaseOrderPart}">
													<form action="ReceivedPurchaseOrderTyre.in" method="post"
