				...
				<div class="col-md-4 col-sm-5 col-xs-12">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">REQUISITION</span> <span
			...
			<div class="row">
				<div class="main-body">
					...
					<c:if test="${!empty PurchaseOrder}">
						...
						<c:url var="firstUrl" value="/newPurchaseOrders/1" />
						<c:url var="lastUrl"
							value="/newPurchaseOrders/${deploymentLog.totalPages}" />
						<c:url var="prevUrl"
							value="/newPurchaseOrders/${currentIndex - 1}" />
						<c:url var="nextUrl"
							value="/newPurchaseOrders/${currentIndex + 1}" />
						<div class="text-center">
							<ul class="pagination pagination-lg pager">
								...
								<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
									<c:url var="pageUrl" value="/newPurchaseOrders/${i}" />
									<c:choose>
