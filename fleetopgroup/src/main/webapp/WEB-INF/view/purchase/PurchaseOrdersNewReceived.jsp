				...
				<div class="col-md-4 col-sm-5 col-xs-12">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">RECEIVED</span> <span
			...
			<div class="row">
				<div class="main-body">
							...
							<div class="row">
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation" class="active"><a
										href="<c:url value="/PurchaseOrders_RECEIVED/1.in"/>"
					...
					<c:if test="${!empty PurchaseOrder}">
									...
									<tbody>
										...
										<c:forEach items="${PurchaseOrder}" var="PurchaseOrder">
											...
											<tr data-object-id="" class="ng-scope">
												...
												<sec:authorize access="hasAuthority('EDIT_AFTER_RECEIVED_PURCHASE')">
													<c:if test="${PurchaseOrder.purchaseorder_statusId == 3}">		
														<td class="icon">
															<div class="btn-group ">
						...
						<c:url var="firstUrl" value="/PurchaseOrders_RECEIVED/1" />
						<c:url var="lastUrl"
							value="/PurchaseOrders_RECEIVED/${deploymentLog.totalPages}" />
						<c:url var="prevUrl"
							value="/PurchaseOrders_RECEIVED/${currentIndex - 1}" />
						<c:url var="nextUrl"
							value="/PurchaseOrders_RECEIVED/${currentIndex + 1}" />
						<div class="text-center">
							<ul class="pagination pagination-lg pager">
								...
								<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
									<c:url var="pageUrl" value="/PurchaseOrders_RECEIVED/${i}" />
									<c:choose>
