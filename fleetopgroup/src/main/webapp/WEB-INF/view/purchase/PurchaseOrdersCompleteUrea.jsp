								...
								<div id="work-order-statuses">
									...
									<sec:authorize access="hasAuthority('REOPEN_PURCHASE')">
										<c:if test="${PurchaseOrder.purchaseorder_vendor_approvalID <= 0 }">
											<a href="PurchaseOrders_Reopen.in?ID=${PurchaseOrder.purchaseorder_id}" data-disable-with="..." data-method="post" data-remote="true" rel="nofollow">
									...
									<c:choose>
										<c:when test="${PurchaseOrder.purchaseorder_document == true}">
											<sec:authorize access="hasAuthority('DOWNLOND_PURCHASE')">
												<a class="btn btn-default" style="width: 13%" href="${pageContext.request.contextPath}/download/PurchaseorderDocument/quotation/${PurchaseOrder.purchaseorder_id}.in">
													<span class="fa fa-download"> Quotation</span>
												</a>
												<a class="btn btn-default" style="width: 13%" href="${pageContext.request.contextPath}/download/PurchaseorderDocument/invoice/${PurchaseOrder.purchaseorder_id}.in">
						...
						<div class="panel panel-success">
							<div class="panel-body">
								<div class="col-md-11">
									<div class="box box-success">
										<h4>
											<span class="label label-success">Order Urea</span>
										</h4>
							...
							<div id="transferPart" class="table-responsive">
								...
								<table class="table">
									...
									<div class="box box-success">
										<h4> <span class="label label-danger">Return Urea</span> </h4>
										<div class="box-body no-padding">
											<div class="table-responsive">
												<table class="table" style="margin-bottom: 0px">
													<thead>
										...
										<table class="table">
											...
											<c:if test="${!poConfiguration.finalTotalCost}">
												...
												<tr class="row">
													...
													<a style="color: red;"><i
															class="fa fa-inr"></i>
															<fmt:formatNumber type="number" pattern="#.##" value="${PurchaseOrder.purchaseorder_total_debitnote_cost}" /></a>
													</td>
												</tr>
												<tr class="row">
...
<script
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/PO/PurchaseOrdersCompleteUrea.js" />"></script>