				...
				<div class="pull-left">
					...
					<div class="pull-right">
						<sec:authorize access="hasAuthority('CHANGE_PO_FROM_RECEIVED_TO_ORDERED')">
							<a class="btn btn-warning btn-sm" onclick="changePOToOrderedStatus()"
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="row">
							...
							<input type="hidden" id="allowToReceivePartial" name="statues" value="${allowToReceivePartial}">
										...
										<div class="form-horizontal ">
											<div class="row1">
												...
												<div class="I-size">
													...
													<c:choose>
														<c:when test="${poConfiguration.editInvoiceNoLength}">
															<input type="text" class="form-text" value=""
															id="invoiceno" required="required"
															name="purchaseorder_invoiceno" maxlength="512"
												...
												<c:if test="${!empty PurchaseOrderPart}">
													<c:forEach items="${PurchaseOrderPart}"
														...
														<tr data-object-id="" class="ng-scope">
															...
															<c:choose>
																<c:when test="${PurchaseOrderPart.approvalPartStatusId == 2 && (PurchaseOrderPart.quantity - PurchaseOrderPart.received_quantity) >0 }">
																	<td class="fit ar">
								...
								<div class="col-md-8">
									<div class="row">
										...
										<div class="col-md-5">
												...
												<div class="box-body no-padding">
													<table class="table table-striped">
														<tbody>
															...
															<tr class="row">
																<th class="key">Invoice NO :</th><!--latest in ending purchaseorder_orderd_remark original -->
																<td class="value"><c:out
											...
											<div class="box box-success">
												<div class="box-body no-padding"><!--check latest-->
													<table class="table table-striped" style="table-layout: fixed; width: 100%">
														<tbody>
															<tr class="row">
...
<script
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/PO/PurchaseOrdersReciveRemain.js" />"></script>