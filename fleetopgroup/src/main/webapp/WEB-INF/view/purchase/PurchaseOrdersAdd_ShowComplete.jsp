										...
										<c:when test="${PurchaseOrder.purchaseorder_document == true}">
											<sec:authorize access="hasAuthority('DOWNLOND_PURCHASE')">
												...
												<a class="btn btn-default" style="width: 13%"
													href="${pageContext.request.contextPath}/download/PurchaseorderDocument/quotation/${PurchaseOrder.purchaseorder_id}.in">
													<span class="fa fa-download"> Quotation</span>
												</a>
												<a class="btn btn-default" style="width: 13%"
													href="${pageContext.request.contextPath}/download/PurchaseorderDocument/invoice/${PurchaseOrder.purchaseorder_id}.in">
						...
						<div class="panel panel-success">
							<div class="panel-body">
								...
								<input type="hidden" id="purchaseOrderId" value="${PurchaseOrder.purchaseorder_id}">
									<div class="box box-success">
										<h4>
											<span class="label label-success">Order Parts</span>
										</h4>
																		...
																		<c:choose>
																			<c:when
																				...
																				<samp style="color: red;">
																					Already You have
																					${PurchaseOrderPart.inventory_all_quantity} ${PurchaseOrderPart.convertToStr}
																					Quantity in stock . <a
							...
							<h4>
								...
								<table class="table">
									...
									<div class="box box-success">
										<h4>
											<span class="label label-danger">Return Parts</span>
										</h4>
										<div class="box-body no-padding">
											<div class="table-responsive">
												<table class="table" style="margin-bottom: 0px">
							...
							<div class="row">
								<div class="col-md-8">
									<div class="row">
										<div class="col-md-5">
											<div class="box box-success">
												<div class="box-body no-padding"><!--latest Style-->
