												...
												<c:if test="${!empty PurchaseOrderPart}">
													<c:forEach items="${PurchaseOrderPart}"
														...
														<tr data-object-id="" class="ng-scope">
															...
															<td><c:out
																	value="${PurchaseOrderPart.clothTypeName}" />
																<br> </td>
															...
															<td class="fit ar"><a
																...
																href="javascript:toggleReceived_quantity('received_quantity${PurchaseOrderPart.purchaseorderto_partid}','received${PurchaseOrderPart.purchaseorderto_partid}');">
															...
															</a><a> ${PurchaseOrderPart.received_quantity}</a> <sec:authorize
																	...
																	<div class="popup-edit hide-on-escape"
																		...
																		<form
																			action="PurchaseOrdersUpdate_ReceivedQuantity.in"
																			method="post">
																			...
																			<div class="row1">
																				...
																				<div
																					...
																					<input name="purchaseorderto_partid" type="hidden"
																						required="required"
																						value="${PurchaseOrderPart.purchaseorderto_partid}">

																					<input class="form-text" name="received_quantity" onpaste="return false"  id="receivedQuantity1_${PurchaseOrderPart.purchaseorderto_partid}"
																						...
																						maxlength="10" max="${PurchaseOrderPart.quantity}"
																						value="${PurchaseOrderPart.received_quantity}"> <!-- step="0.01" -->
																				</div>
																			</div>
																			<div class="row1">
																				...
																				<div
																					...
																					<input class="form-text"
																						name="received_quantity_remark" type="text"
																						maxlength="199" placeholder="Remarks">
																				</div>
																			</div>
																			<div class="row1">
									...
									<div class="row">
										...
										<div class="col-md-5">
											<sec:authorize access="hasAuthority('RECEIVED_PURCHASE')">
												<c:if test="${!empty PurchaseOrderPart}">
													<form action="ReceivedPurchaseOrderCloth.in" method="post"
														...
														<div class="form-horizontal ">
															...
															<div class="row1">
																...
																<div class="I-size">
																	<input type="text" class="form-text" id="invoiceNo"
