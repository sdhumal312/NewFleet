				...
				<fieldset>
					...
					<div class="row">
						...
						<input type="hidden" id="purchaseOrderId" value="${PurchaseOrder.purchaseorder_id}">
														...
														<c:choose>
															<c:when
																...
																<samp style="color: red;">
																	Already You have
																	${PurchaseOrderPart.INVENTORY_TYRE_QUANTITY} Tyre in
																	stock (${PurchaseOrderPart.INVENTORY_TYRE_NEW_RT}). <a
																...
																<li><sec:authorize
																	...
																	<c:choose>
																			<c:when test="${PurchaseOrderPart.approvalPartStatusId == 1}">
																				<li>
																					<a href="#" onclick="editPurchaseOrderPartDetails('${PurchaseOrderPart.TYRE_MANUFACTURER_ID}', '${PurchaseOrderPart.TYRE_MANUFACTURER}','${PurchaseOrderPart.TYRE_MODEL_ID}', '${PurchaseOrderPart.TYRE_MODEL}','${PurchaseOrderPart.TYRE_SIZE_ID}', '${PurchaseOrderPart.TYRE_SIZE}','${PurchaseOrderPart.purchaseorderto_partid}','${PurchaseOrderPart.quantity}','${PurchaseOrderPart.parteachcost}','${PurchaseOrderPart.discount}','${PurchaseOrderPart.tax}','${PurchaseOrderPart.totalcost}')">Edit Tyre</a> 
																				</li>
																			</c:when>
																			<c:otherwise>
																			<li>
											...
											<td colspan="8">
												<div class="">
													<div id="changePart" style="display: none">
														<form action="savePurchaseOrderTyre.in" method="post">
															<input type="hidden" id="unique-one-time-token" name="unique-one-time-token" value="${accessToken}">
															<input type="hidden" id="validateDoublePost" name="validateDoublePost" value="true">
															<input type="hidden" id="vehicleModelTyreLayoutConfig" value="${tyreConfiguration.vehicleModelTyreLayout}">
															<div class="form-horizontal ">
																<input type="hidden" name="purchaseorder_id"
																	value="${PurchaseOrder.purchaseorder_id}"
																	id="PurchaseOrders_id">
																<c:if test="${!tyreConfiguration.vehicleModelTyreLayout}">
																	<div class="row1">
																...
																<div class="row1">
																	<label class="L-size control-label">Tyre Model
																		:<abbr title="required">*</abbr>
																	</label>
																	<div class="I-size">
																		<c:if test="${tyreConfiguration.vehicleModelTyreLayout}">
																			 <select style="width: 100%;"" id="tyremodel"  onchange="tyreModelChange();" name=TYRE_MODEL_ID>"
																			</select> 
																		</c:if>
																		<c:if test="${!tyreConfiguration.vehicleModelTyreLayout}">
																			<select style="width: 100%;" id="tyremodel"
																				name="TYRE_MODEL_ID" required="required">
																			</select>
																		</c:if>
																	</div>
																</div>
																<c:if test="${tyreConfiguration.vehicleModelTyreLayout}">
																	<div class="row1">
																		...
																		<div class="I-size">
																			<input type="hidden" id="manufacurer" readonly="readonly"
																				name="TYRE_MANUFACTURER_ID" style="width: 100%;"
																				required="required"
																				placeholder="Please Enter 2 or more Tyre Manufacturer Name" />
																		</div>
																...
																<div class="row1">
																	<label class="L-size control-label">Tyre Size :<abbr
																		title="required">*</abbr>
																	</label>
																	<div class="I-size">
																	<c:if test="${tyreConfiguration.vehicleModelTyreLayout}">
																		<input type="hidden" id="tyreSize" name="TYRE_SIZE_ID" readonly="readonly"
																			style="width: 100%;" required="required" onchange="getLastTyreCostDetails(this.id)"
																	...
																	<div class="I-size">
																		<div class="col-md-1">
																			...
																			<input type="text" class="form-text"
																				placeholder="Qty" name="quantity" onpaste="return false"
																				required="required" id="quantity" maxlength="10"
																				data-toggle="tip"
																		...
																		<div class="col-md-2"><!--onkeypress="return isNumberKeyEach(event);" Original -->
																			<input type="text" name="parteachcost"
																				class="form-text" placeholder="ech cost" onpaste="return false"
																				required="required" id="parteachcost" maxlength="7"
																				data-toggle="tip"
																		...
																		<div class="col-md-2"><!--onkeypress="return isNumberKeyDis(event);" Original -->
																			<div class="input-group">
																				<input type="text" class="form-text"
																					placeholder="Dis" name="discount" onpaste="return false"
																					required="required" id="discount" maxlength="5"
																					data-toggle="tip"
																		...
																		<div class="col-md-2">
																			<div class="input-group"><!--onkeypress="return isNumberKeyTax(event);" Original  -->
																				<input type="text" class="form-text"
																					placeholder="GST" name="tax" required="required" onpaste="return false"
																					id="tax" maxlength="5"
																					onkeypress="return isNumberKeyWithDecimal(event,this.id);"
																		...
																		<div class="col-md-2">
																			<input type="text" name="totalcost" data-toggle="tip"
																				...
																				required="required" id="tatalcost"
																				readonly="readonly">
																		</div>
																	</div>
																</div>
																<br> <label class="error" id="errorINEACH"
																	...
																	<div class="help-block" id="lastPOtyreDetails">
							...
							<h4>
								<span class="label label-danger">Rejected Tyre</span>
							</h4>
								<table class="table">
									<thead>
										<tr class="breadcrumb">
	...
	<div class="modal-dialog" style="width: 850px;">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="JobType">Tyre Details</h4>
			</div>
			<div class="modal-body">
				<div class="box">
					<div class="box-body">
						<div class="row1" id="grpselectVendor" class="form-group">
							<label class="L-size control-label" for="selectVendor">Tyre Manufacturer
								<abbr title="required">*</abbr>
							</label>
							<div class="I-size" >
								<input type="hidden" name="partid" id="editTyreManufacturer"
						...
						<br>
						<div class="row1" id="grpselectVendor" class="form-group">
							<label class="L-size control-label" for="selectVendor">Tyre Model
								<abbr title="required">*</abbr>
							</label>
							<div class="I-size" >
								<select style="width: 100%;" id="editTyreModel" required="required">
								</select>
							</div>
						</div>
						<br>
						<div class="row1" id="grpselectVendor" class="form-group">
							<label class="L-size control-label" for="selectVendor">Tyre Size
								<abbr title="required">*</abbr>
							</label>
							<div class="I-size" >
								<input type="hidden" name="partid" id="editTyreSize"
									required="required" style="width: 100%;"
									required="required"
									placeholder="Please Enter 2 or more Model Name" /> <span
									id="PurchaseOrders_idIcon" class=""></span>
								<div id="PurchaseOrders_idErrorMsg" class="text-danger"></div>
							</div>
						</div>
			...
			<div class="modal-footer">
				<button type="submit" id="saveVehiclePart" onclick="updatePurchaseOrderPartDetails();" class="btn btn-primary"> Update Tyre
				</button>
				<button type="button" class="btn btn-default" data-dismiss="modal">
					<span id="Close"><spring:message code="label.master.Close" /></span>
				</button>
									...
									<c:when test="${PurchaseOrderPart.approvalPartStatusId == 1}">
										<tr data-object-id="" class="ng-scope">
													<td class="fit">
														...
														<input type="hidden" id="approvalTyreManufacturerId${PurchaseOrderPart.purchaseorderto_partid}" value="${PurchaseOrderPart.TYRE_MANUFACTURER_ID}" name="approvalTyreManufacturerId"> 
														<input type="hidden" id="approvaltyreModalId${PurchaseOrderPart.purchaseorderto_partid}" value="${PurchaseOrderPart.TYRE_MODEL_ID}" name="approvaltyreModalId"> 
														<input type="hidden" id="approvalTyreSizeId${PurchaseOrderPart.purchaseorderto_partid}" value="${PurchaseOrderPart.TYRE_SIZE_ID}" name="approvalTyreSizeId"> 
														<a href="#" data-toggle="tooltip" title="Size: ${PurchaseOrderPart.TYRE_SIZE}"  onclick="getLocationWiseTyreQuantity(${PurchaseOrderPart.TYRE_MANUFACTURER_ID},${PurchaseOrderPart.TYRE_MODEL_ID},${PurchaseOrderPart.TYRE_SIZE_ID});">
													...
													<td class="fit"><input type="text" id="approvalPartQuantity${PurchaseOrderPart.purchaseorderto_partid}"
														class="form-text" style="width: 90%;" name="approvalQuantity"
													...
													<td class="fit"><input type="text" id="approvalPartCost${PurchaseOrderPart.purchaseorderto_partid}" 
														class="form-text" style="width: 90%;" name="approvalTotalCost"
													...
													<td class="fit" style="width: 12%;" >
														...
														<input type="hidden" name="vendorId" 		 id="partVendorId${PurchaseOrderPart.purchaseorderto_partid}" class="partVendorId"  onchange="createNewPurchaseOrder(${PurchaseOrderPart.purchaseorderto_partid});" style="width: 100%;" required="required" placeholder="Vendor Name" />
													</td>
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#tyremodel").select2();
		$("#editTyreModel").select2();
		$("#tagPicker").select2({
			closeOnSelect : !1
		})
	});
	
	$(document).ready(function(){$("#tyreSize ,#editTyreSize").change(function(){
		...
		if(r!=0&&null!=r)
		t='<p style="color: red;"> You have '+r+' Tyre in stock ( NEW= '+n+' & RT= '+i+' )   .<a href="showAvailableTyre.in?size='+d+'" target="_blank">View <i class="fa fa-external-link"></i></a></p>'
