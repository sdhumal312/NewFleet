		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('ADD_ROLE')">
				<div class="col-md-offset-1 col-xs-9">
					<div class="main-body">
						<form id="myForm" action="updateRole.html" method="post"
								...
								<div class="box-body">
									<div class="[ form-group ]">
										...
										<div class="row1">
											...
											<c:if
												test="${feildPrivilege.contains('VIEW_VEHICLE_BODY_MAKER')}">
												<label class="checkbox-inline"> <input
													type="checkbox" name="privileges"
													value="VIEW_VEHICLE_BODY_MAKER" id="vehicle"
													autocomplete="off" />Vehicle Body Maker
												</label>
											</c:if>
										</div>
										<div class="row1">
								...
								<c:if test = "${feildPrivilege.contains('FLAVOR_TWO_PRIVILEGE')}">
									...
									<c:if test = "${feildPrivilege.contains('FLAVOR_TWO_PRIVILEGE')}">		
										...
										<div class="row1">
											...
											<label class="checkbox-inline"> <input
												type="checkbox" name="privileges" value="TRIPSHEET_INCOME_REPORT_BY_INCOME_NAME"
												id="Report" autocomplete="off" /> Bording Point Wise Income Report
											</label>
											</c:if>
										</div>
										<div class="row1">
								...
								<div class="col-sm-5">
									<fieldset class="form-actions">
										<input class="btn btn-info" name="commit" type="submit"
											value="Update Role"> <a class="btn btn-link"
