		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('ADD_ROLE')">
				<div class="col-md-offset-1 col-xs-9">
					<div class="main-body">
						<form id="myForm" action="saveRole.html" method="post"
									...
									<div class="row1">
										...
										<div class="I-size">
											<input name="id" type="hidden" value="${role.id}"
												...
												required="required" placeholder="Enter Role Name" /> <label
												id="errorEditRole" class="error"></label>
						...
						<div class="box" style="display: none;">
								<div class="box-header">
									<h3 class="box-title">Different Flavors</h3>
								</div>
								<div class="box-body">
									<div class="[ form-group ]">
										<div class="row1">
											...
											<c:if test = "${feildPrivilege.contains('FLAVOR_ONE_PRIVILEGE')}">
												<label class="checkbox-inline"> <input
													type="checkbox" name="privileges" checked="checked"
													value="FLAVOR_ONE_PRIVILEGE" id="FLAVOR"  readonly="readonly" />
													Flavor Night Service
												</label>
											</c:if>
											<c:if test = "${feildPrivilege.contains('FLAVOR_TWO_PRIVILEGE')}">
												<label class="checkbox-inline"> <input
													type="checkbox" name="privileges" readonly="readonly" checked="checked"
													value="FLAVOR_TWO_PRIVILEGE" id="FLAVOR" />
													Flavor City Bus
												</label>
											</c:if>
										</div>
						...
						<c:if test = "${feildPrivilege.contains('VIEW_UREA_ENTRY')}">
							<div class="box" id="module_23" style="display: none;">
							<div class="box-header">
								...
								<div class="box-body">
									<div class="[ form-group ]">
										...
										<div class="row1">
											...
											<c:if test = "${feildPrivilege.contains('TRIPSHEET_BULK_ACC_CLOSE')}">
											<label class="checkbox-inline"> <input
												type="checkbox" name="privileges"
												value="TRIPSHEET_BULK_ACC_CLOSE" id="tripsheet_entries"
												autocomplete="off" /> Search Tripsheet A/C Closed
											</label>
											</c:if>
								...
								<div class="box-body">
									<div class="[ form-group ]">
										...
										<div class="row1">
											...
											<c:if test = "${feildPrivilege.contains('SHOW_VEHICLE_BREAKDOWN')}">
											<label class="checkbox-inline"> <input
												type="checkbox" name="privileges" value="SHOW_VEHICLE_BREAKDOWN"
												id="issues" autocomplete="off" /> Show vehicle breakDown
											</label>
											</c:if>
											<c:if test = "${feildPrivilege.contains('CHANGE_ISSUE_TYPE_BREAKDOWN')}">
												<label class="checkbox-inline"> <input
						...
						<div class="box" id="module_18" style="display: none;">
							...
							<div class="box" id="module_27" style="display: none;">
								...
								<div class="box-body">
									<div class="[ form-group ]">
										<div class="row1">
											<c:if test = "${feildPrivilege.contains('ALL_REQUISITION_PERMISSIONS')}">
											<label class="L-size control-label" for="vehicle_theft">
												</label> <label class="checkbox-inline">
												<input type="checkbox" name="privileges"
												value="ALL_REQUISITION_PERMISSIONS"
												id="REQUISITION" autocomplete="off" />Requisition Super Admin Permission
											</label>
											</c:if>
											<c:if
							...
							<div class="box">
								...
								<c:if test = "${feildPrivilege.contains('FLAVOR_TWO_PRIVILEGE')}">
										...
										<div class="row1">
											...
											<div class="row1">
												...
												<label class="L-size control-label" for="vehicle_theft">
													...
													<label class="checkbox-inline"> <input
														type="checkbox" name="privileges"
														value="VIEW_DSE_REPORT" id="Report" autocomplete="off" />
										...
										<div class="row1">
											...
											<c:if test = "${feildPrivilege.contains('VIEW_IS_RE_BY_REPORT')}">
											<label class="checkbox-inline"> <input
												type="checkbox" name="privileges"
										...
										<div class="row1">
											...
											<c:if test = "${feildPrivilege.contains('SHOW_USER_ACTIVITY_REPORT')}">	
												<label class="checkbox-inline"> <input
								...
								<div class="col-sm-5">
									<fieldset class="form-actions">
										<input class="btn btn-info" name="commit" type="submit"
											value="Add ROle"> <!-- <a class="btn btn-link"
											href="newRole.html">Cancel</a> <input type="button"
...
src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/header.js" />">
</script>
<script type="text/javascript">
	$(document).ready(
			function() {
				...
				$("#all-marquee_master").change(
					function() {
						$('input[id="marquee_master"]').prop('checked',
							$(this).prop("checked"));
					}),
