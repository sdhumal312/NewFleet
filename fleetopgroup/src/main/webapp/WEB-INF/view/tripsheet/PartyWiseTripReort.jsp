...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/pickAndDropReport.in"/>">PickUp & Drop Report </a> / 
					<span id="reportHead">Party Wise Trip Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Party Wise Trip Report')" id="exportExcelBtn">
							...
							<div class="row1">
								...
								<div class="I-size">
									<input type="hidden" name="vehicleName"
										id="vid"  style="width: 100%;" placeholder="All" />
								</div>
							</div>	
							...
							<div class="row1">
								...
								<div class="I-size">
									<input type="hidden" name="partyName"
										id="partyId"  style="width: 100%;" placeholder="All" />
								</div>
							</div>	
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/TS/PartyWiseTripReort.js" />"></script>
