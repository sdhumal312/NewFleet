...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/<span id="reportHead">Create Invoice </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'TripSheet Pick And Drop Report')" id="exportExcelBtn">
					...
					<div class="box-body">
						...
						<div class="panel panel-success hide"  id="settle-border-boxshadow">
							<div class="panel-heading text-center">
								<h4> Create Pick Or Drop Invoice
								</h4>
							</div>
						</div>	
						...
						<label class="L-size control-label" for="fuelDate">Invoice Date
							 <abbr title="required">*</abbr> </label>
						<div class="col-md-3">
							<div class="input-group input-append date" id="StartDate1">
								<input type="text" class="form-text" name="invoiceDate" 
									id="invoiceDate" data-inputmask="'alias': 'dd-mm-yyyy'" readonly="readonly"
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/TS/CreatePickOrDropInvoice.js" />"></script>
