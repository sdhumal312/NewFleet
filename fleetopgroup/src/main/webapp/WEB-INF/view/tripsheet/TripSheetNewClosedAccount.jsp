				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">Account Closed TripSheet</span> <span
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation" class="active"><a
										href="<c:url value="/newTripSheetEntries.in?loadTypeId=6"/>">Account
											Closed TripSheet <span data-toggle="tip" title=""
											class="badge bg-red"
			...
			<sec:authorize access="hasAuthority('VIEW_TRIPSHEET')">
				<div class="main-body">
					<c:if test="${!empty TripSheet}">
						<div class="box">
							<div class="box-body">
								<table id="TripSheetAccount" class="table  table-hover">
									<thead>
										<tr>
											<th class="fit"></th>
											<th>TS-Id</th>
						...
						<c:url var="firstUrl" value="/newtripsheetclosed/1" />
						<c:url var="lastUrl"
							value="/newtripsheetclosed/${deploymentLog.totalPages}" />
						<c:url var="prevUrl"
							value="/newtripsheetclosed/${currentIndex - 1}" />
						<c:url var="nextUrl"
							value="/newtripsheetclosed/${currentIndex + 1}" />
						<div class="text-center">
							<ul class="pagination pagination-lg pager">
								...
								<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
									<c:url var="pageUrl" value="/newtripsheetclosed/${i}" />
									<c:choose>
