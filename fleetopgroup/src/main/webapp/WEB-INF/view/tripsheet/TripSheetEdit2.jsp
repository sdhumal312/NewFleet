...
<div class="content-wrapper" onload="javascript:loadTripSheet();">
		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('EDIT_TRIPSHEET')">
				<div class="col-md-offset-1 col-md-9 col-sm-9 col-xs-12">
					<form action="uploadEditTripSheet.in" method="post">
						...
						<div class="form-horizontal">
							<fieldset>
								...
								<div class="box">
									<div class="box-body">
										...
										<input type="hidden" id="preVehicleGroupId" name="vehicleGroupId"
											value="${TripSheet.vehicleGroupId}">
										...
										<div class="row1">
											...
											<div class="I-size" id="vehicleSelect">
												<div class="col-md-8">
													...
													<!-- Old Trip Driver Select Details -->
													<input type="hidden" name="OldFristDriverID"
														value="${TripSheet.tripFristDriverID}" required="required">
													<input type="hidden" name="OldSecDriverID"
														value="${TripSheet.tripSecDriverID}" required="required">
													<input type="hidden" name="OldCleanerID"
														value="${TripSheet.tripCleanerID}" required="required">
													<input type="hidden" name="OldRouteID"
														value="${TripSheet.routeID}" required="required">
													<input type="hidden" name="OldSubRouteID"
														value="${TripSheet.subRouteID}" required="required">	
													<!-- registr -->
													<input type="hidden" id="vregist"
														value="${TripSheet.vehicle_registration}"
														required="required">
													<input type="hidden" id="prevehicle_group" name="prevehicle_group"
														value="${TripSheet.vehicle_Group}" required="required">
													<!-- Select vehicle -->
													
													
													<input type="hidden" id="tripStatusId" value="${TripSheet.closeTripStatusId}">
													 
													<c:if test="${configuration.allowToEditVehicleInTripSheet }">
													...
													<c:if test="${!configuration.allowToEditVehicleInTripSheet }">
													<input type="hidden" id="TripSelectVehicle" name="vid"
														style="width: 100%;" value="0" readonly="readonly"
														placeholder="Please Enter 2 or more Vehicle Name" />	
													</c:if>
														
												</div>
												<a class=" btn btn-link col-sm-offset-1"
													onclick="visibilityEdit('TripVehicle', 'vehicleSelect');">
										...
										<div class="row1">
											<label class="L-size control-label" for="Cleaner">Cleaner
												:</label>
								...
								<div class="box">
									<div class="box-body">
											...
											<div class="row1">
												...
												<div class="I-size">
													<input class="form-text" placeholder="" id="subRouteName"
														name="subRouteName" type="text" maxlength="50" value="${TripSheet.subRouteName}" > <label
										...
										<c:if test="${TripSheet.tripGpsOpeningKM != null && TripSheet.tripGpsOpeningKM > 0}">
											<div class="row1">
												<label class="L-size control-label">GPS Opening KM : </label>
												<div class="I-size">
													<input class="form-text" name="tripGpsOpeningKM" readonly="readonly"
														id="tripGpsOpeningKM" placeholder="" type="text"
														maxlength="50" onkeypress="return tripOpening(event);"
														value="${TripSheet.tripGpsOpeningKM}" ondrop="return false;">
												</div>
											</div>
										</c:if>
										<div class="row1">
							...
							<input type="hidden" value="${TripSheet.tripStutes}"
								name="tripStutesId" id="tripStutes">
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
				console.log('adasdadads ', ${configuration.hideGroupService});
