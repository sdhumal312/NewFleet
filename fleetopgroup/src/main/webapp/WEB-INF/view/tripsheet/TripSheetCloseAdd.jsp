...
<div class="content-wrapper">
					...
					<div class="boxinside">
						...
						<sec:authorize access="hasAuthority('CLOSE_TRIPSHEET')">
							...
							<div class="row">
								...
								<input type="hidden" id ="addInDriverbalanceAfterTripClose" value="${configuration.addInDriverbalanceAfterTripClose}">
								<input type="hidden" id ="driverTallyBalance" value="${TripSheet.tripTotalAdvance - TripSheet.tripTotalexpense}">
							</div>
										...
										<div class="row1">
											...
											<div class="col-md-3">
												<input class="string required form-text" id="closeTripAmount"
													...
													required="required"
													value='0' onblur="return validateCloseAmount();"
													onkeypress="return isNumberKeyWithDecimal(event,this.id)"
	...
	$(document).ready(function() {
		...
		if($('#validateTripRoutePoint').val() == 'true' || $('#validateTripRoutePoint').val() == true){
			  	$('#RoutePoint'+$('#driver1Id').val()).val(1);
			}
	});
	...
	function setPayToField(amount){
		...
		if($('#addInDriverbalanceAfterTripClose').val() == 'true' || $('#addInDriverbalanceAfterTripClose').val()){
			$("#closeTripStatusId").prop('disabled',true);
			$("#closeTripNameByIdselect").prop('disabled',true);
		}
	}
