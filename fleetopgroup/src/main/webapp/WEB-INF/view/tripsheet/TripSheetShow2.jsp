						...
						<sec:authorize access="hasAuthority('VIEW_TRIPSHEET')">
							<c:choose>
								...
								<c:if test="${configuration.dispatchTripPrint}">
									<a onclick="showDispatchTripPrint(${TripSheet.tripSheetID});" class="btn btn-default"><i
	...
	<section class="content">
		<div class="row">
			<div class="col-md-offset-1 col-md-9 col-sm-8 col-xs-12">
				...
				<c:if test="${param.ATTSUCESS eq true}">
					<div class="alert alert-success">
						<button class="close" data-dismiss="alert" type="button">x</button>
						This Trip Sheet Driver Account Attendance created Successfully.
					</div>
				</c:if>
				...
				<c:if test="${param.notCurrendDate eq true}">
					<div class="alert alert-danger">
						<button class="close" data-dismiss="alert" type="button">x</button>
						${VMandatory} Please change Journey end Date..
					</div>
				</c:if>
				...
				<c:if test="${param.closeStatus eq true}">
					<div class="alert alert-danger">
						<button class="close" data-dismiss="alert" type="button">x</button>
						You should be Delete first Driver Halt &amp; Fuel Entries inside
						Tripsheet ${CloseTS} <br> ${VMandatory}<br>You can't
						Delete.
					</div>
				</c:if>
					...
					<div class="boxinside">
						<div id="div_printTripsheet">
							...
							<sec:authorize access="hasAuthority('VIEW_TRIPSHEET')">
										...
										<c:choose>
											...
											<c:otherwise>
												<a style="color: #000000;"
													href="showVehicle.in?vid=${TripSheet.vid}"
								...
								<c:if test="${param.saveTripSheet eq true}">
									<div class="alert alert-success">
										<button class="close" data-dismiss="alert" type="button">x</button>
										This TripSheet Dispatched successfully .<br>
										${VMandatory}
									</div>
								</c:if>
									...
									<table class="table">
										<tbody>
											<tr>
												...
												<c:if test="${!configuration.hideGroupService}">
											...
											<c:if test="${TripSheet.tripGpsUsageKM != null || (TripSheet.tripGpsOpeningKM != null && TripSheet.tripGpsOpeningKM > 0)}">
												<tr>
											...
											<c:if test="${TripSheet.gpsCloseLocation != null}">
												<tr>
								...
								<table class="table">
									<tbody>
														...
														<tbody>
															...
															<c:forEach items="${TripSheetAdvance}"
																...
																<tr data-object-id="" class="ng-scope">
																	...
																	<c:if test="${configuration.showAdvanceDriver}">		
																		<td class="fit ar"><c:out
																			value="${TripSheetAdvance.driverName}" /></td>
																	</c:if>	
														...
														<tbody>
															...
															<c:forEach items="${TripSheetExpense}"
																...
																<tr  data-object-id="" class="ng-scope">
																	...
																	<td width="10%" class="fit ar"><c:out
																			value="${TripSheetExpense.created}" /></td>
														...
														<tbody>
															...
															<c:choose>
																...
																<tr style="background: #FFFF00; data-object-id="" class="ng-scope">
																	...
																	<c:if test="${TripSheetIncome.loadingSheetIncome}">
																		<td class="fit ar"><a href="#">${TripSheetIncome.incomeAmount}</a></td>
																	</c:if>
																	<c:if test="${!TripSheetIncome.loadingSheetIncome}">
																		<td class="fit ar"><c:out
																...
																<tr data-object-id="" class="ng-scope">
																	...
																	<td class="fit ar"><c:out
																			value="${TripSheetIncome.incomeRefence}" /></td>
																	<c:if test="${TripSheetIncome.loadingSheetIncome}">
																		<td class="fit ar"><a onclick="getLoadingSheetIncomeDetails(${TripSheetIncome.dispatchLedgerId});" href="#">${TripSheetIncome.incomeAmount}</a></td>
																	</c:if>
																	<c:if test="${!TripSheetIncome.loadingSheetIncome}">
																		<td class="fit ar"><c:out
																				value="${TripSheetIncome.incomeAmount}" /></td>
										...
										<tr>
											...
											<td><c:if test="${!empty TripSheetExtraOptionsReceived}"> 
													...
													<table class="table table-bordered table-striped">
														<thead>
															<tr class="breadcrumb">
																<th class="fit">No</th>
																<th class="fit ar">Extra Name</th>
																<th class="fit ar">Received Quantity</th>
																<th class="fit ar">Description</th>
																<th class="fit ar">Extra Date</th>
															</tr>
														</thead>
														<tbody>
															<%
																Integer hitsCount = 1;
															%>
															<c:forEach items="${TripSheetExtraOptionsReceived}"
																var="TripSheetExtraOptionsReceived">
																...
																<tr data-object-id="" class="ng-scope">
																	...
																	<td class="fit ar"><c:out
																			value="${TripSheetExtraOptionsReceived.tripsheetextraname}" /></td>
																	<td class="fit ar">
																	<c:out value="${TripSheetExtraOptionsReceived.tripSheetExtraQuantityReceived}" />
																	</td>
																	<td class="fit ar"><c:out
																			value="${TripSheetExtraOptionsReceived.tripsheetextradescription}" /></td>
																			
																	<td class="fit ar"><c:out
																			value="${TripSheetExtraOptionsReceived.created}" /></td>
																</tr>
										...
										<tr>
											<td>
												<!--  Trip Sheet closed  fuel entries --> 
													...
													<table class="table table-bordered table-striped">
														...
														<tbody>
															<tr class="breadcrumb">
																...
																<td><c:out
																		value=" =  ${TripSheet.routeTotalLiter - fTDiesel}" /></td>
															</tr>
															<tr class="breadcrumb">
																			...
																			<div class="pull-right">
																				...
																				<sec:authorize
																					...
																					<a class="btn btn-info btn-flat btn-xs"
																						href="#" onclick="removeTripComment('${TripComment.TRIPCID}');">
					...
					<c:choose>
						<c:when test="${TripSheet.tripStutesId ==1}">
							...
							<li><sec:authorize access="hasAuthority('EDIT_TRIPSHEET')">
									<a class="btn btn-success btn-sm"
										href="dispatchTripSheet.in?ID=${TripSheet.tripSheetID}"
										class="confirmation"
						...
						<c:when test="${TripSheet.tripStutesId == 2}">
							...
							<li><sec:authorize access="hasAuthority('CLOSE_TRIPSHEET')">
									<a class="btn btn-danger btn-sm"
										href="addCloseTripsheet.in?tripSheetID=${TripSheet.tripSheetID}">
						...
						<c:if test="${configuration.driverPenaltyDetails}">
							...
							<%--  <li><sec:authorize
									access="hasAuthority('ADD_EXPENSE_TRIPSHEET')">
									<a id="tollApi" style="display: none;" class="btn btn-success btn-sm"
										href="#"
										class="confirmation"
										onclick="return addTollExpensesDetails(${TripSheet.tripSheetID}, ${TripSheet.vid}, '${TripSheet.vehicle_registration}', '${TripSheet.dispatchedByTimeOn}', '${TripSheet.closetripDate}');"> <span
								 ...
								 <c:if test="${configuration.showExtraReceived}"> 
									<li><sec:authorize access="hasAuthority('EDIT_TRIPSHEET')">
										<a class="btn btn-warning btn-sm"
											href="addExtraOptions.in?tripSheetID=${TripSheet.tripSheetID}"
											class="confirmation"
								 ...
								 <c:if test="${configuration.addLhpvAfterTripSheet}"> 
									<li><sec:authorize access="hasAuthority('EDIT_TRIPSHEET')">
										<a class="btn btn-warning btn-sm"
											href="addLhpvDataToTripSheet.in?ID=${TripSheet.tripSheetID}&vid=${TripSheet.vid}"
											class="confirmation"
								 ...
								 <c:if test="${configuration.showPODdetails}"> 
									<li><sec:authorize access="hasAuthority('EDIT_TRIPSHEET')">
										<a class="btn btn-success btn-sm"
											href="addPOD.in?tripSheetID=${TripSheet.tripSheetID}"
											class="confirmation"
								  ...
								  <c:if test="${configuration.allowIVLoadingSheetEntry}"> 
									<li>
										<a class="btn btn-success btn-sm"
											href="#"
											class="confirmation"
											onclick="addIVCargoLOadingSheetDetails(${TripSheet.tripSheetID}, ${TripSheet.vid}, '${TripSheet.vehicle_registration}', '${TripSheet.dispatchedByTimeOn}', '${TripSheet.closetripDate}');">  Add IVCargo L S
										</a>
									</li>
								 </c:if>
