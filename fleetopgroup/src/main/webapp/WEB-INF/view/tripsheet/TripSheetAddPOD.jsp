...
<div class="content-wrapper">
						...
						<div class="box-header">
							<div class="pull-left">
								<a href="<c:url value="/open"/>"><spring:message
									...
									TripSheet</a> / <small>Add POD TripSheet</small>
							</div>
									...
									<div class="box-footer h-padded">
										<fieldset class="form-actions">
											<input class="btn btn-success" data-disable-with="Saving..." 
												name="commit" type="submit" value="Save POD" onclick=" return validatePOD();"> <a
												class="btn btn-link"
	...
	<script type="text/javascript">
		...
		function validatePOD(){
			...
			var POD = Number($('#noOfPOD').val());
			
			if(POD <= 0){
				showMessage('errors', 'Please Select POD!');
				return false;
			}
