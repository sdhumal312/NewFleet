...
<div class="content-wrapper">
		   ...
		   <%-- <form id="formDriver" action="<c:url value="/dispatchPickAndDropTrip.in"/>"
			...
			<div class="box-body" id="ElementDiv">
				<div class="form-horizontal ">
					...
					<div class="row1">
						<label class="L-size control-label">Vehicle Number : 
						 <abbr title="required">*</abbr></label>
						<div class="I-size">
							<input type="hidden" id="vid" name="vid"
								style="width: 100%;" placeholder="Please Enter Vehicle" />
						</div>
					</div>
					...
					<div class="row1">
						...
						<div class="I-size">
							<input type="hidden" id="tripFristDriverID" name="tripFristDriverID"
								style="width: 100%;" placeholder="Please Enter Driver" />
						</div>
					</div>
					
					<div class="row1 oldParty">
						<label class="L-size control-label">Party Name : 
						 <abbr title="required">*</abbr></label>
						<div class="I-size">
							<input type="hidden" id="vendorId" name="vendorId"
								style="width: 100%;" placeholder="Please Enter Vendor"
								 />
						</div>
					</div>
					
					<input type = hidden id="newPartyId" value="0">
					<div class="row1 party" class="form-group">
						<div class="L-size control-label">
							<a class=" btn btn-link"
								onclick="newParty();">
								<i class="fa fa-plus"> New Party Name</i>
							</a>
						</div>
					</div>
					...
					<div class="row1" id="grpfuelLiter" class="form-group">
						...
						<abbr title="required">*</abbr></label>
						<div class="I-size">
							<input type="text" maxlength="10" class="form-text" id="rate" name="rate" onkeypress="return isNumberKeyWithDecimal(event,this.id);" onchange="calAmnt()"> 
						</div>
					</div>
					...
					<div class="row1 pick">
						<label class="L-size control-label">PickUp Point : 
						 <abbr title="required">*</abbr></label>
						<div class="I-size">
					...
					<div class="row1 hide drop">
						<label class="L-size control-label">Drop Point : 
						 <abbr title="required">*</abbr></label>
						<div class="I-size">
					...
					<input type = hidden id="newLocationId" value="0">
					<div class="row1" class="form-group">
						<div class="L-size control-label">
							<a class=" btn btn-link"
								onclick="newLocation('routeEnter', 'routeSelect');">
								<i class="fa fa-plus"> New Pick/Drop Point</i>
							</a>
						</div>
					</div>
					...
					<div class="row1" id="grpfuelLiter" class="form-group">
						...
						<div class="I-size">
							<input type="text" class="form-text" maxlength="10" onkeypress="return isNumberKeyWithDecimal(event,this.id);"  id="tripTotalAdvance" name="tripTotalAdvance"> 
						</div>
					</div>
					...
					<div class="row1" id="grpfuelLiter" class="form-group">
						<div class="col-sm-offset-4 I-size">
							<button type="submit" class="btn btn-primary" onclick="dispatchPickAndDropTrip();">
								<span><spring:message code="Dispatch" /></span>
							</button>	
							<a class="btn btn-default" href="<c:url value="/newTripSheetPickAndDrop.in"/>">Cancel</a>
						</div>
					</div>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/TS/CreatePickAndDropTrip.js" />"></script>
	<script type="text/javascript"
