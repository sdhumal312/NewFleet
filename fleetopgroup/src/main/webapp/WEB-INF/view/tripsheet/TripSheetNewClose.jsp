				...
				<div class="col-md-3 col-sm-3 col-xs-12">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">Close TripSheet</span> <span
				...
				<div class="col-md-3 col-sm-4 col-xs-12">
					<div class="info-box">
						<div class="info-box-center">
							...
							<form action="<c:url value="/searchTSPayment.in"/>" method="post">
								<div class="input-group">
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation" class="active"><a
										href="<c:url value="/newTripSheetEntries.in?loadTypeId=4"/>">Advance Close
											...
											class="badge bg-red"
											data-original-title="${TripClose} Closed TripSheet">${TripClose}</span>
									</a></li>
			...
			<div class="row">
				<div class="main-body">
					<c:if test="${!empty TripSheet}">
						<div class="box">
							<div class="box-body">
								<table id="TripSheetClose" class="table table-hover table-bordered">
									<thead>
										<tr>
									...
									<tbody>
										<c:forEach items="${TripSheet}" var="TripSheet">
											<tr data-object-id="" class="ng-scope">
												...
												<td class="fit ar"><c:out
														value="${TripSheet.tripOpenDate}" /></td>
												...
												<td class="fit ar"><sec:authorize
														...
														<a class="btn btn-success btn-sm"
															href="<c:url value="/addCloseTripsheet.in?tripSheetID=${TripSheet.tripSheetID}"/>"
															class="confirmation"
					...
					<c:url var="firstUrl" value="/closeTripSheet/1" />
					<c:url var="lastUrl"
						value="/closeTripSheet/${deploymentLog.totalPages}" />
					<c:url var="prevUrl" value="/closeTripSheet/${currentIndex - 1}" />
					<c:url var="nextUrl" value="/closeTripSheet/${currentIndex + 1}" />
					<div class="text-center">
						<ul class="pagination pagination-lg pager">
							...
							<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
								<c:url var="pageUrl" value="/closeTripSheet/${i}" />
								<c:choose>
