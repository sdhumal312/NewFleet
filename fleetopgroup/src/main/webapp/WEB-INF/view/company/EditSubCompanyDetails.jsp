								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<fieldset class="form-actions">
											<button type="submit" id="updateSubCompany" class="btn btn-success">Update Sub Company</button>
...
<script type="text/javascript" src="resources/QhyvOb0m3EjE7A4/js/fleetop/MA/EditSubCompany.js"></script>
