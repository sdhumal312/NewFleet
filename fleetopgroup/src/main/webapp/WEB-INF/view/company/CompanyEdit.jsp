			...
			<div class="box-body">
				<div class="row">
					...
					<div class="pull-right">
						<a href="<c:url value="/newCompany"/>">Cancel</a>
					</div>
				</div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form id="formEditCreateCompany"
									action="<c:url value="/updateCompany.in"/>" method="post"
									...
									<div class="form-horizontal ">
										...
										<div class="row1" id="grpcompanyCode" class="form-group">
											<label class="L-size control-label">Company Login Code :<abbr
												title="required">*</abbr></label>
											<div class="I-size">
												<input type="text" class="form-text" name="companyCode" readonly="readonly"
													value="${Company.companyCode}"
													maxlength="200" id="companyCode"
													 />
											</div>
										</div> 
									<div class="row1" id="grpcompanyLogo" class="form-group">
