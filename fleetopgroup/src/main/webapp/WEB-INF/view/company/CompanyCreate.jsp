...
<div class="content-wrapper">
			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open.html"/>"><spring:message
						...
						href="<c:url value="/newCompany.in"/>">New Company</a>
				</div>
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/MA/CompanyValidate.js" />"></script>
