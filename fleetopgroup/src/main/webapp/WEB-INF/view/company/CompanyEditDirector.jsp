					...
					<div class="main-body">
						<div class="panel panel-default">
							<div class="panel-body">
								<form action="updateDirectorCompany" name="vehicleStatu"
									method="post" enctype="multipart/form-data">
									<div class="form-horizontal ">
										<fieldset>
											<legend>Edit Company Directors</legend>
											<div class="row1">
												<label class="L-size control-label">DIRECTORS NAME :<abbr
													title="required">*</abbr></label>
												<div class="I-size">

													<input type="hidden" class="form-text"
														name="com_directors_id"
														value="${director.com_directors_id}" required="required" />

													<input type="hidden" class="form-text" name="company_id"
														value="${director.company_id}" required="required" /> <input
														type="text" class="form-text" name="com_directors_name"
														required="required" placeholder="Enter DIRECTORS NAME:"
														maxlength="150" value="${director.com_directors_name}"
														id="pcName" onkeypress="return ADDRESS(event);"
														ondrop="return false;" /> <label id="errorRouteNo"
														class="error"></label>
												</div>
											</div>
											...
											<div class="row1">
												...
												<div class="I-size">
													<input type="text" class="form-text" name="com_designation"
														...
														value="${director.com_designation}" maxlength="150"
											...
											<div class="row1">
												...
												<div class="I-size">
													<input type="text" class="form-text"
														name="com_directors_mobile"
														value="${director.com_directors_mobile}"
														required="required" placeholder="Enter CONTACT NUMBER"
														maxlength="15" id="pcName"
											...
											<div class="row1">
												...
												<div class="I-size">
													<input type="email" class="form-text"
														...
														value="${director.com_directors_email}"
											...
											<div class="row1">
												<input type="hidden" class="form-text"
													name="com_directors_status" value="SUBCOMPANY"
													required="required" /> <input type="hidden"
													class="form-text" name="createdBy"
													value="${director.createdBy}" required="required" />
											</div>
										</fieldset>
