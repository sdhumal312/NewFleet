						...
						<div class="pull-left">
							...
							code="label.master.home" /></a> / <small><a
								...
								href="<c:url value="/newCompany.in"/>"><c:out
										value="${Company.company_name}" /></a></small> / <small>Edit Sub
								Company</small>
						</div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form id="formEditCreateCompany"
									action="<c:url value="/updateSubCompany.in"/>" method="post"
										...
										<div class="row1" id="grpcompanyName" class="form-group">
											...
											<div class="I-size">
												<input type="hidden" class="form-text" name="company_id"
													value="${Company.company_id}" required="required" />
												<!--  -->
												<input type="hidden" class="form-text"
													name="company_parentName"
													value="${Company.company_parentName}" maxlength="250"
													required="required" />
												<!--  -->
												<input type="hidden" class="form-text"
													name="company_parent_id"
													value="${Company.company_parent_id}" required="required" />
												<input type="text" class="form-text" name="company_name"
													readonly="readonly" placeholder="Enter company_name"
													maxlength="250" value="${Company.company_name}"
											...
											<div class="row1">
												...
												<div class="I-size">
													...
													<select style="width: 100%;" name="company_country"
														...
														<option value="${Company.company_country}">${Company.company_country}</option>
											...
											<div class="row1">
												...
												<div class="I-size">
													...
													<select name="company_state"
														...
														id="stateId">
														<option value="${Company.company_state}"
															selected="selected">${Company.company_state}</option>
											...
											<div class="row1">
												...
												<div class="I-size">
													...
													<select name="company_city"
														...
														<option value="${Company.company_city}"
															selected="selected">${Company.company_city}</option>
										...
										<fieldset>
											...
											<div class="row1">
												<input type="hidden" class="form-text" name="company_status"
													...
													value="${createdBy}" required="required" /> <input
