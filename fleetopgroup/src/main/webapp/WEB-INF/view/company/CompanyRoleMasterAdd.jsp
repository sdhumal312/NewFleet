		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('ADD_ROLE')">
				<div class="col-md-offset-1 col-xs-9">
					<div class="main-body">
						<form id="myForm" action="saveMasterRole.html" method="post"
								...
								<div class="box-body">
									<div class="[ form-group ]">
										...
										<div class="row1">
											...
											<label class="checkbox-inline"> <input
												type="checkbox" name="privileges" value="VIEW_INVENTORY"
									...
									<div class="[ form-group ]">
										...
										<div class="row1">
											...
											<label class="checkbox-inline"> <input
												...
												id="workorder" autocomplete="off" /> Re-open / on Hold Work
												Order Details
											</label>
											</c:if>
										</div>
