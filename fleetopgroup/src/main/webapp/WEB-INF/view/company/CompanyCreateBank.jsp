					...
					<div class="main-body">
						<div class="panel panel-default">
							<div class="panel-body">
								<form action="saveBankCompany" name="vehicleStatu" method="post">
									<div class="form-horizontal ">
										<fieldset>
											<legend>Create Company Bank Details</legend>
											<div class="row1">
												...
												<div class="I-size">
													<input type="hidden" class="form-text" name="company_id"
														...
														type="text" class="form-text" name="com_bank_name"
														required="required" placeholder="Enter BANK NAME"
														maxlength="200" id="pcName"
											...
											<div class="row1">
												...
												<div class="I-size">
													<input type="text" class="form-text" name="com_bank_bsr"
														placeholder="Enter BSR CODE" maxlength="30" id="pcName"
											...
											<div class="row1">
												...
												<div class="I-size">
													<input type="text" class="form-text" name="com_bank_branch"
														placeholder="ENTER BRANCH NAME" maxlength="200" id="pcName"
														required="required" onkeypress="return Email(event);"
														ondrop="return false;" /> <label id="errorEmail"
														class="error"></label>
												</div>
											...
											<div class="row1">
												<input type="hidden" class="form-text"
													name="com_bank_status" value="MAINCOMPANY"
											...
											<div class="col-sm-5">
												<fieldset class="form-actions">
													<input class="btn btn-info" name="commit" type="submit"
														value="Create Bank Details"> <a class="btn btn-link"
