							...
							<div class="row">
								<ul class="nav nav-tabs" role="tablist">
									...
									<%-- <li role="presentation"><a
										href="<c:url value="/VendorApprovalCreated/1.in"/>">Approved
											Entries</a></li> --%>
									<li role="presentation"><a
									...
									<tbody>
										<c:forEach items="${approval}" var="approval">
											...
											<tr data-object-id="" class="ng-scope">
												<td class="fit"><a
													href="<c:url value="/AddServiceApproval.in?approvalId=${approval.approvalId}"/>"><c:out
															value="A-${approval.approvalNumber}" /></a></td>
												<td><a
													href="<c:url value="/ShowVendor.in?vendorId=${approval.approvalvendorID}&page=1"/>"
													data-toggle="tip"
												...
												<td><c:choose>
														<c:when test="${approval.approvalStatusId == 6}">
															<div class="btn-group">
																...
																<ul class="dropdown-menu pull-right">
																	<li><%-- <sec:authorize
																			...
																			<a
																				href="<c:url value="/AddServiceApproval.in?approvalId=${approval.approvalId}"/>"
																				class="confirmation"
																				onclick="return confirm('Are you sure? Approve ')">
																				<span class="fa fa-trash"></span> Approve
																			</a>
																		<%-- </sec:authorize> --%></li>
																	<li><sec:authorize
																			access="hasAuthority('DELETE_APPROVEL_VENDOR')">
