                    ...
                    code="label.form.loginSpanish"></spring:message></a> --%>
						<form name='f' action="s_security_fleetop" method='POST'
							...
							<div class="row1 form-group has-feedback">
								...
								<input class="form-text" type='text' name='j_username' value='' id="email"
						...
						<h2>
							<a href="http://www.fleetop.in">By <img alt="fleetop.in"
...
<div class="container-fluid footer">
	<div class="row">
		<div class="col-md-12">
			<p>
				<span> Design: <a href="http://www.fleetop.in">IVFLEET</a>
				</span> Copyright &copy; IVFLEET 2018 By <a href="http://fleetop.com">www.fleetop.in</a>
			</p>
		</div>
	</div>
</div>
