...
<div class="content-wrapper">
	...
	<section class="content">
			                         ...
			                         <div class="form-group column">
			                            ...
			                            <div class="col-md-8 inputGroupContainer">
			                               ...
			                               <span class="input-group-addon">
			                              	...
			                              	<input id="ureaRequisitionSenderId" class="form-control" value="${requisitionSender}" type="text" style="width: 100%" readonly="readonly">
			                               </div>
			                            </div>
			                         </div>
			                         <div class="form-group column">
					...
					<div class="panel-footer">
						...
						<div class="I-size">
							<button type="submit" id="sendUreaRequisition" class="btn btn-success">Send Urea Requisition</button>
							<a class="btn btn-link" href="ureaRequisitionAndTransferDetails.in">Cancel</a>
						</div>
					</div>
		</section>	
    ...
    <script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/urea/UreaRequisitionAdd.js" />"></script>		
