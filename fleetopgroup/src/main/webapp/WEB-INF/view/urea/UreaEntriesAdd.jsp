...
<div class="content-wrapper">
	...
	<section class="content">
		<sec:authorize access="!hasAuthority('ADD_UREA_ENTRY')">
									...
									<div class="box-body">
										<div class="row1" id="grpvehicleNumber" class="form-group">
											...
											<div class="I-size">
												<input type="hidden" id="FuelSelectVehicle" name="vid"
													style="width: 100%;" required="required" onchange="vehicleOnchange();"
										...
										<div class="row1" id="grpfuelOdometer" class="form-group">
											<label class="L-size control-label" for="fuel_meter">Odometer<abbr
												title="required">*</abbr></label>
											<div class="I-size">
												<!-- <input id="fuel_meter_old" name="fuel_meter_old" type="hidden">  -->
												<input class="form-text" id="fuel_meter" name="fuel_meter" onkeyup="validateMaxOdameter();"
													type="number" min="0" max="" onkeypress="return isNumberKey(event);"
												...
												<input type="hidden" class="form-text" id="ureaOdometerOld" name="ureaOdometerOld" readonly="readonly">
											...
											<div class="col-md-4 col-sm-3 col-xs-12">
												<div class="help-block checkbox">
													<label for="fuel_meter_entry_attributes_void"> <input
														...
														name="meter_attributes" type="checkbox" value="1" onclick="validateMaxOdameter();">
							...
							<div class="panel-footer">
								...
								<div class="I-size">
									<div class="col-sm-offset-4 I-size">
										<input type="button" value="Submit" onclick="saveUreaEntry();" id="btnSubmit" class="btn btn-success" />	
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/urea/UreaAdd.js" />"></script>	
		<script type="text/javascript"
