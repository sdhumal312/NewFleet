				...
				<div class="pull-right">
					...
					<c:if test="${driver.driverStatusId != 6}">
						...
						<a class="btn btn-success"
							href="<c:url value="/addDriSalAdv.in?ID=${driver.driver_id}"/>"> <i
					...
					<div class="main-body">
						<div class="box">
							...
							<div class="box-body">
								...
								<sec:authorize access="hasAuthority('ADDEDIT_DRIVER_ADVANCE')">
									<form action="saveDriverSalaryAdvance.in" method="post">
										<div class="panel panel-default">
											<div class="panel-body">
												<div class="form-horizontal">
													<fieldset>
														<input name="DRIVER_ID" value="${driver.driver_id}"
															required="required" type="hidden"> <input
															name="DRIVER_NAME" required="required"
															value="${driver.driver_firstname}_${driver.driver_Lastname}" type="hidden">

														<div class="row1">
															<label class="L-size control-label">Old Advance Balance
																:<abbr title="required">*</abbr>
															</label>
															<div class="I-size">
																<input name="ADVANCE_BALANCE" required="required"
																	id="jamaBalance" value="${AdvanceBalance}"
																	type="hidden">
																<div class="partAction">
																	<h3>
																		<c:out value="${AdvanceBalance}" />
																	</h3>
																</div>
															</div>
														</div>
													</fieldset>
													<c:if test="${configuration.showDriverAdvancePaymentType}">
													<div class="row1">
														<label class="L-size control-label">Adavnce Type 
															<abbr title="required">*</abbr>
														</label>
														<div class="I-size">
															<select class="form-text" name="DRIVER_ADVANCE_TYPE_ID"
																id="driverAdvanceTYpe" required="required">
																<option value="1">Driver Advance</option>
																<option value="2">Driver Penalty</option>
													...
													<div class="row1">
														<div class="L-size control-label">
															<label>New Advance Amount : </label>
														</div>
														<div class="I-size">
															<input type="number" class="form-text" id="advanceAmount"
																 name="ADVANCE_AMOUNT"
																required="required" placeholder="eg: 1000"
													...
													<div class="row1">
														<label class="L-size control-label">Total Advance Balance
															:<abbr title="required">*</abbr>
														</label>
														<div class="I-size">
															<input name="driver_id" value="${AdvanceBalance}"
																type="hidden">
															<div class="partAction" id="totalBalance">
																<h3>0</h3>
															</div>
														</div>
													</div>
														...
														<div class="I-size">
															<div class="input-group input-append date" id="StartDate">
																<input type="text" class="form-text" name="ADVANCE_DATE"
																	id="fuelDate" required="required" readonly="readonly"
													...
													<div class="row1">
														...
														<div class="I-size">
															<textarea class="text optional form-text"
																id="initial_note" name="ADVANCE_REMARK" rows="3">
				                                            </textarea>
														</div>
													</div>
													<div class="row1">
														...
														<div class="I-size">
															<input class="btn btn-success"
																...
																type="submit" value="Save Advance" data-toggle="modal"  onclick ="return validateAdvanceDate();"        
		...
		<script>
			...
			function reminderBalance(e, n) {
				var i = document.getElementById(e).value, o = document
						...
						+ parseFloat(o);
				isNaN(s) || ($("#totalBalance").html('<h4>' + s + '</h4>'))
			}
		</script>
	</section>
</div>
