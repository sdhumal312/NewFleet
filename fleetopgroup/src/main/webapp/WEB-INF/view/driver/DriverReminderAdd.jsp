				...
				<div class="pull-left">
					<a href="<c:url value="/open.html"/>"><spring:message
						...
						href="<c:url value="/showDriver?driver_id=${driver.driver_id}"/>"><c:out
								...
								value="${driver.driver_Lastname}" /></a> / <small><a
							href="<c:url value="/ShowDriverReminder.in?driver_id=${driver.driver_id}"/>">Driver
								Reminder</a></small> / Add Driver Renewal Reminder</small>
				</div>
					...
					<div class="main-body">
						<div class="box">
							...
							<div class="box-body">
								...
								<sec:authorize access="hasAuthority('ADDEDIT_DRIVER_REMINDER')">
									<form action="saveDriverReminder.in" method="post"
													...
													<div class="row1">
														<div class="L-size">
															<label class="col-md-offset-3" id="target"
																for="grp_option">Number</label>
														</div>
														<div class="I-size">
															<input type="text" class="form-text"
																value="${driver.driver_dlnumber}" name="driver_dlnumber"
																id="id1" required="required" data-toggle="tip"
																...
																placeholder="eg: HJ6686GH" readonly> <label class="error"
																id="errorNumber" style="display: none"></label>
														</div>
													
														<input id ="dl_num" type = "hidden" value="${driver.driver_dlnumber}">
														<input id ="dl_badge_num" type="hidden" value="${driver.driver_badgenumber}">  
