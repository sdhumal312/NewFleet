...
<div class="content-wrapper">
				...
				<div class="pull-right">
					<sec:authorize access="hasAuthority('ADD_FUEL')">
						<a class="btn btn-success btn-sm"
							href="VehicleFuelDetailsAdd.in?vid=${fuel.vid}"> <i
							class="fa fa-plus"></i> Add Fuel
						</a>
					</sec:authorize>
					<a class="btn btn-info btn-sm"
						href="<c:url value="VehicleFuelDetails.in?vid=${fuel.vid}"/>">Cancel</a>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="content">
		<div class="row">
			...
			<sec:authorize access="hasAuthority('EDIT_FUEL')">
				<div
					class="col-md-offset-1 col-md-9 col-sm-offset-1 col-sm-10 col-xs-12">

					<form id="formEditFuel"
						action="<c:url value="/updateVehicleDetailsFuel.in"/>"
						...
						<input name="createdById" type="hidden" value="${fuel.createdById}">
						<input name="fuel_Number" type="hidden" value="${fuel.fuel_Number}">
								...
								<div class="box">
									<div class="box-body">
										<div class="row1" id="grpvehicleNumber" class="form-group">
											...
											<div class="I-size">
												<input type="hidden" name="vid" value="${fuel.vid}">
											...
											<div class="I-size">
												<div class="input-group input-append date" id="StartDate">
													<input type="text" class="form-text" name="fuel_date"
														maxlength="10" required="required" id="fuelDate"
										...
										<div class="row1" id="grpfuelOdometer" class="form-group">
											...
											<div class="I-size">
												...
												<input id="fuel_meter_old" name="fuel_meter_old"
													type="hidden" value="${fuel.fuel_meter}"> <input
										...
										<div class="row1" id="grpfuelType" class="form-group">
											...
											<input name="fuelTypeId" id="fuelTypeId" type="hidden" value="${fuel.fuelTypeId}" />
										</div>
										<div class="row1" id="grpfuelLiter" class="form-group">
											<label class="L-size control-label">Liter<abbr
												title="required">*</abbr></label>
											<div class="I-size">
										...
										<div class="row1" id="ShowOtherPayOptionEdit">
											...
											<div class="I-size">
												<div class="">
													<input type="hidden" value="${fuel.fuel_payment}"
														id="fuel_payment">
													<input type="hidden" value="${fuel.paymentTypeId}"
														id="paymentTypeId">
												...
												<div class="I-size">
													...
													<p class="help-block">
														...
														<!--  <a href="#" target="_blank" title=""
															rel="tooltip" data-original-title="Click for more info">
															<i class="fa fa-info-circle"></i> <small>What's
																this?</small>
														</a> -->
													</p>
												</div>
								...
								<div class="box">
									<div class="box-body">
										<div class="col-sm-offset-2">
											...
											<div class="row1">
												<!-- <img alt="g.satheesh76@gmail.com" class="img-circle media-object pull-left" src="#">
				 -->
												<div class="I-size">
													<textarea class="form-text" id="fuel_comments"
														...
														ondrop="return false;">
														<c:out value="${fuel.fuel_comments}" />
														</textarea>
							...
							<fieldset class="form-actions">
								<div class="col-sm-offset-4 I-size">
									...
									<a class="btn btn-default"
										href="<c:url value="/VehicleFuelDetails/1.in?vid=${fuel.vid}" />">Cancel</a>
								</div>
							</fieldset>
						</div>
					</form>
	...
	<script type="text/javascript">
	$(document).ready(function(){var h=$("#Ovid").val(),i=$("#enterVendorName").val();$("#selectVendor").select2("data",{id:h,text:i});var j=$("#Odid").val(),k=$("#Odname").val();$("#VehicleTODriverFuel").select2("data",{id:j,text:k});});
	</script>
	<script type="text/javascript">
	$(document).ready(function(){$(".select2").select2();$("#tagPicker").select2({closeOnSelect:!1})});	
	$(document).ready(function(){var t=document.getElementById("selectVendor").value;"0"!=t?($("#ShowOtherPayOptionEdit").show(),$("#PayModeOptionEdit").hide()):($("#ShowOtherPayOptionEdit").hide(),$("#PayModeOptionEdit").show()),$("#selectVendor").on("change",function(){var t=$(this).val();"0"!=t||null==t?($("#editOption").show(),$("#selectVen").hide(),$("#ShowOtherPayOptionEdit").show(),$("#PayModeOptionEdit").hide()):($("#editOption").hide(),$("#PayModeOptionEdit").show(),$("#ShowOtherPayOptionEdit").hide())})});
