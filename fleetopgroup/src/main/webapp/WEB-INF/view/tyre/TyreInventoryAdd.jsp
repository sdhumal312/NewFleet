			...
			<div class="row">
				<div class="col-md-offset-1 col-md-9">
					<form id="formTyreInventory"
						...
						enctype="multipart/form-data" name="formTyreInventory" role="form"    onsubmit="return validateTyreInventorySave();
									...
									<div class="box-body">
										<div class="panel panel-success">
											<div class="panel-body">
												...
												<c:if test="${!configuration.vehicleModelTyreLayout}">
													<div  id="grpmanufacturer">
														...
														<div class="col-md-3">
															<input type="hidden" id="manufacurer"
																name="TYRE_MANUFACTURER_ID" style="width: 100%;" class="tyreManufacturer"
												...
												<div  id="grptyreModel" >
														...
														<div class="col-md-3">
														<c:if test="${configuration.vehicleModelTyreLayout}">
															<select style="width: 100%;" id="tyremodel"  onchange="tyreModelChange();"
																name=TYRE_MODEL_ID>"
															</select> 
														</c:if>
															<c:if test="${!configuration.vehicleModelTyreLayout}">
														...
														</c:if>	<span id="tyreModelIcon" class=""></span>
													...
													<div id="grptyreSize">
														...
														<div class="col-md-3">
															<input type="hidden" id="tyreSize" name="TYRE_SIZE_ID"
																style="width: 100%;" class="tyreSize"
													...
													<div class="col-md-9">
														<div class="col-md-1">
															<input type="text" class="form-text" name="quantity_many"
																onkeypress="return isNumberKey(event);" id="quantity"
														...
														<div class="col-md-1">
															<input type="text" class="form-text" name="discount_many"
																min="0.0" id="discount" maxlength="8" onpaste="return false"
														...
														<div class="col-md-1">
															<input type="text" class="form-text" name="tax_many"
																id="tax" maxlength="8" min="0.0" placeholder="GST"
								...
								<div class="box">
									<div class="box-body">
										...
										<div class="row1">
											...
											<c:if test="${configuration.showPONumber}">
										...
										<div class="row1">
											...
											<div class="col-md-3">
												<input type="text" class="form-text" 
													value="0" id="invoiceAmount" maxlength="25" readonly="readonly" onpaste="return false"
													onkeypress="return isNumberKeyWithDecimal(event,this.id)"
													ondrop="return false;"> <label class="error"
													id="errorInvoicenumber" style="display: none"> </label>
											</div>
							...
							<fieldset class="form-actions">
								<div class="row1">
									<div class="col-md-10 col-md-offset-2">
										<button type="submit" class="btn btn-success" id="saveTyreInventory" >Create
											Inventory</button>
