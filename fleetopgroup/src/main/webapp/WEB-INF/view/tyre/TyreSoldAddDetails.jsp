							...
							<div class="col-md-11">
								<div class="row">
									<div class="col-md-7">
										<div class="row1">
											...
											<div class="I-size">
												<input type="hidden" id="inventoryRetreadTyreId" name="RID" value="${Retread.TYRE_ID}">
												<textarea rows="2" cols="2" class="form-text"
													name="DESCRIPTION" id="description" maxlength="250">${Retread.TYRE_ID}
								             </textarea>
											</div>
										</div>
										<br>
								...
								<div class="row">
									<div class="text-center">
										<button type="submit" id="btnSumbit"class=" btn btn-primary">
											<span>SOLD</span>
										</button>
									</div>
							</div>
...
<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/IT/TyreSoldAddDetails.js" />"></script>	
<script
