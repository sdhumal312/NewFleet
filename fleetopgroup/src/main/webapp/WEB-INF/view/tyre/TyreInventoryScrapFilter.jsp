			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open"/>"><spring:message
						...
						Inventory</a> / <span>Scrap Filter</span>
				</div>
								...
								<form action="<c:url value="/SearchScrapFilter.in"/>"
									...
									<div class="form-horizontal ">
										<fieldset>
											...
											<div class="row1">
												<label class="L-size control-label " title="required">Tyre Usage :<abbr
