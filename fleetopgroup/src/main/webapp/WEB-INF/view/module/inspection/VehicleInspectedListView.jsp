				...
				<div class="col-md-3 col-sm-3 col-xs-12">
					...
					<div class="info-box">
						<span class="info-box-icon bg-green"><i
							class="fa fa-info"></i></span>
						<div class="info-box-content">
							<span class="info-box-text">Todays skipped Inspection Vehicles</span> <a data-toggle="tip"
								data-original-title="Click Inspected Details"
							...
							<div class="table-responsive">
								<table class="table table-hover table-bordered">
									...
									<tbody>
											...
											<c:forEach items="${inspectedList}" var="inspectedList">
											...
											%>
												...
												<tr data-object-id="" class="ng-scope">
													...
													<td><a
														href="<c:url value="/showVehicle.in?vid=${inspectedList.vid}"/>"
														data-toggle="tip"
														data-original-title="Click this vehicle Details"> <c:out
																value="${inspectedList.vehicle_registration}" />

													</a></td>
													
													<c:choose>
														<c:when test="${inspectedList.completionDetailsId != null}">
														 <td><a class="btn btn-success"
															href="<c:url value="/viewInspectVehicleDetails?vid=${inspectedList.vid}&ID=${inspectedList.completionDetailsId}"/>"> View
													...
													<td><c:out value="${inspectedList.inspectionStatusName}" /></td>
