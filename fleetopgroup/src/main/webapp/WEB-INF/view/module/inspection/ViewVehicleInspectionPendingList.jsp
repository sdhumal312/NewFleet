		...
		<sec:authorize access="hasAuthority('VIEW_VEHICLE_INSPECTION_MODULE')">
			<div class="row">
				...
				<c:if test="${param.saved eq true}">
					...
					<div class="box">
						<div class="box-body">
						<c:if test="${!empty pendingInspectionList}">
							...
							<div class="table-responsive">
								<table class="table table-hover table-bordered">
									...
									<tbody>
											...
											<c:forEach items="${pendingInspectionList}" var="pendingInspectionList">
											...
											%>
												...
												<tr data-object-id="" class="ng-scope">
													...
													<td><a
														href="<c:url value="/showVehicle.in?vid=${pendingInspectionList.vid}"/>"
														data-toggle="tip"
														data-original-title="Click this vehicle Details"> <c:out
																value="${pendingInspectionList.vehicle_registration}" />

													</a></td>
													
													<c:choose>
														<c:when test="${pendingInspectionList.completionDetailsId != null}">
														 <td><a class="btn btn-success"
															href="<c:url value="/viewInspectVehicleDetails?vid=${pendingInspectionList.vid}&ID=${pendingInspectionList.completionDetailsId}"/>"> View
													...
													<c:choose>
														<c:when test="${pendingInspectionList.inspectionStatusId != 2}">
																
																<td><a class="btn btn-info"
																	href="<c:url value="/inspectVehicle?vid=${pendingInspectionList.vid}&ID=${pendingInspectionList.vehicleInspctionSheetAsingmentId}&DR=${currentDate}"/>"> Inspect
													...
													<c:choose>
														...
														<c:otherwise>
															...
															<td><a class="btn btn-info"
																			href="<c:url value="/editInspectionDetails?vid=${pendingInspectionList.vid}&ID=${pendingInspectionList.vehicleInspctionSheetAsingmentId}"/>"> Edit
	
																	</a></td>
														</c:otherwise>
													</c:choose>
													<td><c:out value="${pendingInspectionList.inspectionStatusName}" /></td>
