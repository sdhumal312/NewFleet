...
<div class="content-wrapper">
		...
		<sec:authorize access="hasAuthority('ADD_PARTS')">
			<div class="row">
				<div class="col-sm-8 col-md-12">
					...
					<input type="hidden" id="partsExtraDetailsId">
										...
										<div class="col col-sm-12 col-md-3">
										  ...
										  <c:if test="${configuration.showVehicleModel}">
										   ...
										   <%-- <c:if test="${configuration.showVehicleMake}">
											  <div class="col col-sm-12 col-md-3">
												  <label class="has-float-label">
												     <select style="height: 35px;" id="vehicleMake" class="browser-default custom-select">
													    <option selected value="-1"></option>
														<c:forEach items="${vehicleManufacturer}" var="vehicleManufacturer">
																	<option value="${vehicleManufacturer.vehicleManufacturerId}">
																		<c:out value="${vehicleManufacturer.vehicleManufacturerName}" />
																	</option>
														</c:forEach>
													</select>
												    <span style="color: #2e74e6;font-size: 14px;">Vehicle Make</span>
										  ...
										  <c:if test="${configuration.showVehicleModel}">
											   <div class="col col-sm-12 col-md-3">
												  <label class="has-float-label">
												     <select id="vehicleModel" class="browser-default custom-select">
													    <option selected value="-1"></option>
														<c:forEach items="${vehicleModel}" var="vehicleModel">
																	<option value="${vehicleModel.vehicleModelId}">
																		<c:out value="${vehicleModel.vehicleModelName}" />
																	</option>
														</c:forEach>
													</select>
												    <span style="color: #2e74e6;font-size: 14px;">Vehicle Model</span>
										  ...
										  <c:if test="${configuration.showWarranty}">
											   ...
											   <div  id="warrantyInMonthRow" class="col col-sm-12 col-md-3" style="display: none;">
												  <label class="has-float-label">
												    <input class="form-control" type="text" value=" " onkeypress="return isNumberKey(event,this);" id="warrantyInMonth"   placeholder="Warranty"/>
						...
						<div class="row" id="savePartRow">
							<fieldset class="form-actions">
								<div class="pull-center">
									<button type="submit" onclick="updateNewMasterPartsDetails();"  class="btn btn-success" >Update Part</button>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/module/partmaster/editPartMaster.js" />"></script>		
	<script
