...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					/<span>Pending Vendor Payment</span>
				</div>
							...
							<div class="box-body">
									<div class="form-horizontal ">
										<div class="row1" class="form-group">
													...
													<label class="L-size control-label" for="payMethod">Search All :
													</label>
													<div class="col-md-3">
														<div class="">
															<div class="btn-group"  >
																<label class="switch">
																	  <input id="byDateCheckBox" type="checkbox"  onclick="toggleDateDateOption();">
										...
										<div class="row1" id="dateRangeDiv">
											<label class="L-size control-label">Date range:</label>
											<div class="col-md-3">
							 ...
							 <input type="hidden" id="vendorId" name="vendorId">
								<div class="table-responsive">
									<div id="sorttable-div" align="center" style="font-size: 10px" class="table-responsive ">
										...
										<div class="row invoice-info" id="totalAmount" style="font-size: 15px; font-weight: bold;color: red;"> </div>
										<div class="row invoice-info" id="selectedAmount" style="font-size: 15px; font-weight: bold; color: blue;"> </div>
										...
										<div class="row1" style="text-align: left;">
												...
												<div class="I-size">
													<div class="pull-left">
														<button type="submit" name="commit"
															class="btn btn-success" onclick="createVendorApproval(1);" id="createApproval">
															 Create Approval
														</button>
														<button type="submit" name="commit"
															class="btn btn-primary" onclick="createVendorApproval(2);" id="createApproval">
															 Make Payment
														</button>
													</div>
												</div>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/module/vendorpayment/SearchPendingVendorPayment.js"/>"></script>
	<script type="text/javascript"
