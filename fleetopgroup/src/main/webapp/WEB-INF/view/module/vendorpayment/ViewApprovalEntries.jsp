...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<div class="pull-left">
					...
					<a href="<c:url value="/viewApprovalEntries.in"/>"> Approval Entries</a>
				</div>
							...
							<div class="row">
								<ul class="nav nav-tabs" role="tablist">
									<li role="presentation" id="open"><a
										onclick="showApprovalList(6,1)">Created Entries</a></li>
									<li role="presentation" id=inProcess><a
										onclick="showApprovalList(3,1)">Approved Entries</a></li>
									<li role="presentation" id="completed"><a
										onclick="showApprovalList(1,1)">Completed Approval</a></li>
								</ul>
							</div>
						</div>
					</sec:authorize>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/module/vendorpayment/ViewApprovalEntries.js" />"></script>	
	<script type="text/javascript"
