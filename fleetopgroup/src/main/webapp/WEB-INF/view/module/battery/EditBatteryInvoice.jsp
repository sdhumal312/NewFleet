...
<div class="content-wrapper">
			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open"/>"><spring:message
						...
						href="BatteryInventory.in">New Battery Inventory</a>
					/
					${batteryInvoice.batteryInvoiceNumber}
					/ Edit Battery Invoice
				</div>
								...
								<div class="box">
									<div class="box-body">
										...
										<div class="row1">
											<div id="grppartLocation" class="form-group">
												...
												<input type="hidden" id="roundupConfig" value="${configuration.roundupAmount}">
													<input type="hidden" name="batteryInvoiceId"
														value="${batteryInvoice.batteryInvoiceId}"> 
														<input type="hidden" id="warehouselocation" name="wareHouseLocation"
														value="${batteryInvoice.wareHouseLocation}"> <input type="text"
														class="form-text" name="batteryLocation"
														readonly="readonly" required="required"
														value="${batteryInvoice.batteryLocation}"
											...
											<input type="hidden" id="editSubLocationId" value="${batteryInvoice.subLocationId}">
											<input type="hidden" id="editSubLocation" value="${batteryInvoice.subLocation}">
										...
										<div class="row1">
											...
											<div class="col-md-3" id="vendorSelect">
												<div class="col-md-9">
													<input type="hidden" id="Venid" required="required"
														value="${batteryInvoice.vendorId}" />
													<%-- --%>
													<input type="hidden" id="Venname" required="required"
														value="${batteryInvoice.vendorName} - ${batteryInvoice.vendorLocation}" />
													<%-- --%>
													<input type="hidden" id="selectVendor" name="vendorId"
														style="width: 100%;" required="required"
														value="${batteryInvoice.vendorId}"
														placeholder="${batteryInvoice.vendorName}" /> <label
											...
											<div class="col-md-3" id="paymentDiv">
												<select class="form-text" name="paymentTypeId" id="renPT_option1" required="required">
													<option value="${batteryInvoice.paymentTypeId}">${batteryInvoice.paymentStatus} </option>
										...
										<div class="row1">
											...
											<div class="col-md-3">
												<input type="text" class="form-text" name="poNumber"
													value="${batteryInvoice.poNumber}" maxlength="25"
											...
											<div class="col-md-3">
												<input type="text" class="form-text" name="invoiceNumber"
													value="${batteryInvoice.invoiceNumber}" maxlength="25"
										...
										<div class="row1" id="grpinvoiceDate" class="form-group">
											...
											<div class="col-md-3">
												<div class="input-group input-append date" id="paidDate">
													<input type="text" class="form-text" name="invoiceDateStr"
														id="invoiceDate" value="${batteryInvoice.invoiceDateStr}"
											...
											<div class="col-md-3">
												<input type="text" class="form-text" name="invoiceAmount"
													value="${batteryInvoice.invoiceAmount}" maxlength="10" id="invoiceAmount"
										...
										<div class="row1">
											...
											<div class="col-md-3">
												<input type="number" class="form-text" readonly="readonly"
													value="${batteryInvoice.totalBatteryAmount}" maxlength="25" id="invoiceAmount"
														onkeypress="return isNumberKeyWithDecimal(event,this.id);"
													ondrop="return false;"> <label class="error"
													id="errorInvoicenumber" style="display: none"> </label>
											</div>
											...
											<div class="col-md-3">
												<input type="text" class="form-text" id="roundupTotal" name="invoiceAmount"
													value="${batteryInvoice.invoiceAmount}" maxlength="10" 
														onkeypress="return isNumberKeyWithDecimal(event,this.id);"
													ondrop="return false;"> <label class="error"
													id="errorInvoicenumber" style="display: none"> </label>
											</div>
										...
										<c:if test="${configuration.tallyIntegrationRequired}">
										   <input type="hidden" id="tallyIdEdit" value="${batteryInvoice.tallyCompanyId}">
										   <input type="hidden" id="tallyNameEdit" value="${batteryInvoice.tallyCompanyName}">
										...
										<c:if test="${configuration.editBatteryInventoryDocument}">
										...
										<div class="row1">
											...
											<div class="I-size">
												<textarea class="form-text" name="description" rows="3"
													...
													ondrop="return false;">${batteryInvoice.description} 
				                                </textarea>
							...
							<fieldset class="form-actions">
								<div class="row1">
									<div class="col-md-10 col-md-offset-2">
										<button type="submit" class="btn btn-success" onclick="return validateBatteryUpdate();">Update
											Invoice</button>
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/module/battery/editBatteryInventory.js" />"></script>
	<script type="text/javascript" 
		src="resources/QhyvOb0m3EjE7A4/js/fleetop/module/battery/batteryInventoryValidation.js"></script>
		<script type="text/javascript"
