		...
		<div class="box">
			<div class="box-header">
				<div class="pull-left">
					...
					/ <span>Add Battery Details</span>
				</div>
				<div class="pull-right">
					<% 
						Collection<GrantedAuthority>  permission = (Collection<GrantedAuthority>)request.getAttribute("permissions");
						if(permission.contains(new SimpleGrantedAuthority("DELETE_BATTERY_INVENTORY"))) {
						%>
					  		<a id="delete" onclick="deleteBatteryInventory();" class="btn btn-primary btn-sm" href="#">Delete Battery Invoice</a>
					<% } %>
			...
			<sec:authorize access="hasAuthority('VIEW_BATTERY_INVENTORY')">
				<div class="row">
					<div class="col-md-7 col-sm-7 col-xs-7">
						<!-- <div class="pull-left"> -->
						<h4>Battery Invoice <span id="batteryInvoiceNumber"></span></h4>
						<input type="hidden" id="invoiceId" value="${invoiceId}"/>
						<input type="hidden" id="rounupconfig" value="${configuration.roundupAmount}"/>
							...
							<div class="box-body no-padding">
								<table class="table">
									<tbody>
										...
										<tr class="row">
											<th class="key">Invoice Amount:</th>
											<td class="value" id="invoiceTotal"></td>
										</tr>
...
<!-- <script type="text/javascript"
	src="resources/QhyvOb0m3EjE7A4/js/fleetop/IT/InventoryTyreValidate.js"></script> -->
<script type="text/javascript">
...
<script
	src="resources/QhyvOb0m3EjE7A4/js/select/select2.min.AJAX.js"></script>
	<script type="text/javascript" src="resources/QhyvOb0m3EjE7A4/js/fleetop/module/battery/showBatteryInventory.js"></script>
