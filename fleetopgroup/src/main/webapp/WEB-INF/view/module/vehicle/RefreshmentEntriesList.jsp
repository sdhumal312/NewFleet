...
<div class="content-wrapper">
	<section class="panel panel-success">
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
						<a href="open" >Home</a>/ <a href="RefreshmentEntriesList.in">New Refreshment Entry</a>
				</div>
				<div class="pull-right">
						<% 
						Collection<GrantedAuthority>  permission = (Collection<GrantedAuthority>)request.getAttribute("permissions");
						if(permission.contains(new SimpleGrantedAuthority("ADD_REFRESHMENT_INVENTORY"))) {
						%>
						
  						<a class="btn btn-success btn-sm"
							href="<c:url value="refreshmentEntry"/>"> <span
							class="fa fa-plus"></span>Add Refreshment Entry
						</a>
  						<% } %>
				</div>
				<!-- <div class="col-md-3">
...
<script type="text/javascript" src="resources/QhyvOb0m3EjE7A4/js/fleetop/refreshment/ViewRefreshmentEntryList.js"></script>
<script src="resources/QhyvOb0m3EjE7A4/js/fleetop/refreshment/RefreshmentEntriesUtility.js"></script>