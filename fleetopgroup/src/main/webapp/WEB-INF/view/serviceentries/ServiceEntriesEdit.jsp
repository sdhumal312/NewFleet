			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open"/>"><spring:message
						...
						Entries</a> / <small>Edit Service Entries</small>
				</div>
				<div class="pull-right">
					<a class="btn btn-link"
						href="<c:url value="/newServiceEntries/1/1.in"/>">Cancel</a>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('EDIT_SERVICE_REMINDER')">
				<div class="col-md-offset-1 col-md-9">
					...
					<form id="formEditServiceEntries"
						action="<c:url value="/updateServiceEntries.in"/>" method="post"
						enctype="multipart/form-data" name="formEditServiceEntries"
								...
								<div class="box">
									<div class="box-body">
										...
										<div class="row1" id="grpvehicleNumber" class="form-group">
											...
											<div class="I-size">
												<input type="hidden"
													name="serviceEntries_id"
													value="${ServiceEntries.serviceEntries_id}">
												<input type="hidden"
													name="serviceEntries_Number"
													value="${ServiceEntries.serviceEntries_Number}">
												<%-- --%>
												<input type="hidden" id="Ovid" required="required"
													value="${ServiceEntries.vid}" />
												<%-- --%>
												<input type="hidden" id="Ovname" required="required"
										...
										<div class="row1">
											...
											<div class="I-size" id="driverSelect">
												<div class="col-md-9">
													...
													<input type="hidden" id="Did" required="required"
														value="${ServiceEntries.driver_id}" />
													<%-- --%>
													<input type="hidden" id="Dname" required="required"
												...
												<div class="I-size">
													<div class="col-md-9">
														<input class="form-text row1" name="driver_name"
															...
															value="${ServiceEntries.driver_name}"
															placeholder="Enter Fuel Driver Name" readonly="readonly"
										...
										<div class="row1" id="grpodoMeter" class="form-group">
											...
											<div class="I-size">
												<input class="form-text" id="vehicle_Odometer"
													placeholder="${ServiceEntries.vehicle_Odometer}"
													name="vehicle_Odometer"
													value="${ServiceEntries.vehicle_Odometer}" type="text">
											...
											<div class="I-size" id="vendorSelect">
												<div class="col-md-9">
													...
													<input type="hidden" id="Venid" required="required"
														value="${ServiceEntries.vendor_id}" />
													<%-- --%>
													<input type="hidden" id="Venname" required="required"
														value="${ServiceEntries.vendor_name} - ${ServiceEntries.vendor_location}" />
													<%-- --%>
												...
												<div class="I-size">
													<div class="col-md-9">
														<input class="form-text row1" name="Vendor_name"
															maxlength="25" type="text" id="enterVendorName"
															readonly="readonly" placeholder="Enter Fuel Vendor Name"
															value="${ServiceEntries.vendor_name}"
															onkeypress="return IsVendorName(event);"
															ondrop="return false;"> <label class="error"
															id="errorVendorName" style="display: none"> </label> <input
															class="form-text row1" name="Vendor_location"
															readonly="readonly" maxlength="25" type="text"
															id="enterVendorLocation"
										...
										<div class="row1" id="grpinvoiceNO" class="form-group">
											...
											<div class="I-size">
												...
												<input class="form-text" id="invoiceNumber"
													value="${ServiceEntries.invoiceNumber}" required="required"
													name="invoiceNumber" type="text"> <span
										...
										<div class="row1" id="grpinvoiceNO" class="form-group">
											...
											<div class="I-size">
												...
												<input class="form-text" id="invoiceNumber"
													value="${ServiceEntries.invoiceNumber}" 
													name="invoiceNumber" type="text"> <span
													id="invoiceNOIcon" class=""></span>
												<div id="invoiceNOErrorMsg" class="text-danger"></div>
											...
											<div class="I-size">
												<div class="input-group input-append date" id="StartDate">
													<input type="text" class="form-text" name="invoiceDate"
														id="invoicestartDate"  readonly="readonly"
														value="${ServiceEntries.invoiceDate}"  onchange="getVehicleTripSheetDetails();"
														data-inputmask="'alias': 'dd-mm-yyyy'" data-mask="" /> <span
														class="input-group-addon add-on"> <span
														class="fa fa-calendar"></span>
													</span>
										...
										<c:if test="${config.showTripSheet}">	
											<div class="row1">
												<label class="L-size control-label">TripSheet Number
													:
												</label>
												<div class="I-size">
										...
										<div class="row1">
											...
											<div class="I-size">
												<input class="string required form-text"
													value="${ServiceEntries.jobNumber}"
										...
										<div class="row1">
											...
											<div class="I-size">
												<select class="form-text" name="service_paymentTypeId"
													id="serviceEdit_option">
													<option value="${ServiceEntries.service_paymentTypeId}"
														selected="selected"><c:out
															value="${ServiceEntries.service_paymentType}" /></option>
										...
										<div class="row1">
											...
											<div class="I-size">
												<input type="text" class="form-text"
													...
													value="${ServiceEntries.service_PayNumber}"
											...
											<div class="I-size">
												<div class="input-group input-append date" id="paidDate">
													<input type="text" class="form-text" required="required"
														...
														value="${ServiceEntries.service_paiddate}"
										...
										<div class="row1">
											...
											<div class="I-size">
												<input type="text" class="form-text" name="service_paidby"
													value="${ServiceEntries.service_paidby}"
													readonly="readonly"
							...
							<fieldset class="form-actions">
								<div class="row">
									<div class="col-md-10 col-md-offset-2">
										<button type="submit" class="btn btn-success" onclick="return validateServiceEntry();"> Update
