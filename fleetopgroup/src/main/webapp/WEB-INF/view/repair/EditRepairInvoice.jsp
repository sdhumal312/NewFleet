...
<div class="content-wrapper">
						...
						<div class="box" >
							<div class="box-body">
								...
								<div class="col col-sm-1 col-md-3">
									<label class="has-float-label"> 
										<select name="purchaseorder_typeId" id="repairTypeId" class="browser-default custom-select" required="required">
	...
	<script type="text/javascript" 
		src="resources/QhyvOb0m3EjE7A4/js/fleetop/repair/EditRepairInvoice.js"></script>
	<script
