...
<div class="content-wrapper">
			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open"/>">
						...
						<a href="<c:url value="/viewRepairStockReport.in"/>">Repair Stock Report</a> / 
				</div>
		...
		<div class="panel box box-primary">
			<div class="box-body" id="ElementDiv">
				<div class="form-horizontal ">
					<div class="row1">
						<label class="L-size control-label">Repair Stock Type : </label>
						<div class="I-size">
							<select class="form-control" id="repairStockTypeId" onchange="displayStock();">
					...
					<div class="row1">
						<label class="L-size control-label">WorkShop: </label>
						<div class="I-size">
							<select class="form-control" id="workShopId" >
					...
					<div class="row1">
						<label class="L-size control-label">Location: </label>
						<div class="I-size">
							<input type="hidden" id="locationId" onchange="changeLocation();" style="width:100%">
						</div>
					</div> 
					<div class="row1" id="partDiv">
						<label class="L-size control-label">Part: </label>
						<div class="I-size">
							<input type="hidden" id="partId" style="width:100%">
						</div>
					</div> 
					<div class="row1" id="tyreDiv" style="display:none">
						<label class="L-size control-label">Tyre: </label>
						<div class="I-size">
							 <select  name="tyreId" id="tyreId" class="select" style="width:100%;" ></select>
						</div>
					</div>
					<div class="row1" id="batteryDiv" style="display:none">
						<label class="L-size control-label">Battery: </label>
						<div class="I-size">
							<select  name="batteryId" id="batteryId"  class="select" style="width:100%;" ></select>
						</div>
					</div>
				</div>
				<div class="row1">
	...
	<script type="text/javascript" src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/repair/ViewRepairStockReport.js"/>"></script>
