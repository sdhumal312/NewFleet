...
<div class="content-wrapper">
			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open"/>"><spring:message
						...
						href="<c:url value="/newBranch.in"/>">Branch Details</a></small> / <small><span
						id="NewVehicle">Create New Branch</span></small>
				</div>
	...
	<c:if test="${param.saveBranch eq true}">
						...
						<div class="box">
							<div class="box-body">
								<div class="container">
									...
									<form id="formBranch" action="<c:url value="/saveBranch.in"/>"
															...
															<div class="I-size">
																<div class="L-size">
																	<div class="input-group clockpicker">
																		<input type="text" class="form-text"  readonly="readonly" value="09:30"
																...
																<div class="L-size">
																	<div class="input-group clockpicker">
																		<input type="text" class="form-text"  readonly="readonly" value="20:30"
												...
												<div class="form-horizontal ">
													<fieldset>
														...
														<div class="row1" id="grpbranchRent" class="form-group">
															<label class="L-size control-label" for="branchRent">Monthly RENT:
																<abbr title="required">*</abbr>
															</label>
															<div class="I-size">
										...
										<fieldset class="form-actions">
											<div class="pull-left">
												...
												<button type="submit" class="btn btn-success" onclick="return branchDetailvalidate()">Create
													Branch</button>
