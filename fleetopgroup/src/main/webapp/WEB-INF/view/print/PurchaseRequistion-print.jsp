					...
					<div class="box-body no-padding">
						<table class="table table-bordered table-striped" style="table-layout: fixed; width: 100%">
							<tbody>
								<tr class="row">
									<th>Date Opened:</th>
									<td><c:out value="${PurchaseOrder.purchaseorder_created_on}" /></td>
									<th>Vendor :</th>
								...
								<tr class="row">
									<th>Required :</th>
									<td><c:out value="${PurchaseOrder.purchaseorder_requied_on}" /></td>
								<c:if test="${!poConfiguration.KHTCprintConfig}">
									<th>Terms :</th>
								...
								<tr class="row">
									<th>Quote No :</th>
									<td><c:out value="${PurchaseOrder.purchaseorder_quotenumber}" /></td>
									<th>WorkOrder No:</th>
									<td><c:out value="${PurchaseOrder.purchaseorder_workordernumber}" /></td>
								</tr>
								</c:if>
								...
								<tr class="row">
									<th>Buyer :</th>
									<td colspan="5">
										<c:out value="${PurchaseOrder.purchaseorder_buyer}" /><br> 
								...
								<c:if test="${poConfiguration.showShipvia }">
									...
									<th>Ship To:</th>
									<td><c:out value="${PurchaseOrder.purchaseorder_shiplocation}" /></td>
								</tr>
								...
								<c:if test="${poConfiguration.showShipAddress }">
									<th>Ship Address:</th>
									<td colspan="5">
										<c:out value="${PurchaseOrder.purchaseorder_shiplocation_address}" /><br>
								...
								<c:if test="${!empty PurchaseOrderPart}">
									<c:forEach items="${PurchaseOrderPart}" var="PurchaseOrderPart">
										<tr data-object-id="" class="ng-scope">
											<td>
												<c:if test="${PurchaseOrderTask.mark_complete == 1}">
											...
											<%-- <c:if test="${PurchaseOrderPart.purchaseorder_partname == null }">
												<td>
											...
											<td><i class="fa fa-inr"></i> ${PurchaseOrderPart.totalcost}</td>
										</tr>
									</c:forEach>
								</c:if>
								<c:if test="${empty PurchaseOrderPart}">
				...
				<div class="col-xs-12 table-responsive">
					<div class="col-sm-5 col-xs-5 invoice-col">
						<div class="box-body no-padding table-responsive">
							...
							<table class="table table-striped" style="table-layout: fixed; width: 100%"><!-- latest-->
								<tbody>
									<tr class="row">
