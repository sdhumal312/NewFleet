				...
				<div>
					<div class="box-body no-padding">
						<table class="table table-striped" style="width: 100%;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black">
							<tbody>
								<tr>
									<td style="text-align:center;" colspan="4"> <h4>Job Card for issue(I) ( 
										<c:forEach var="issue" items="${issueList}">${issue.ISSUES_NUMBER},</c:forEach>
								...
								<tr>
									...
									<tr><td style="width:35%;border-right: 1px solid black">Driver name & No: <c:out value="(I-${issue.ISSUES_NUMBER})"/></td><td> ${issue.ISSUES_DRIVER_NAME} & ${issue.driver_mobnumber}</td></tr>
									</c:forEach>
								...
								<table class="border-none" style="width: 100%;">
								<tr>
								<th style="text-align: center;" width="20%">Issue No., Type, Lable, Category :</th> 
								<th style="text-align: center;" >Issue Summary</th>
								</tr>
								<c:forEach items="${issueList}" var="issue">
								<tr>
								<td><c:out value="(I-${issue.ISSUES_NUMBER}),"/> <c:out value="${issue.ISSUES_TYPE}, ${issue.ISSUES_LABELS},${issue.partCategoryName}"/> </td>
								<td><c:out value="(I-${issue.ISSUES_NUMBER}),"/><c:out value="${issue.ISSUES_SUMMARY}"/></td>
								</tr>
								</c:forEach>
								</table>
								</td>
										...
										<tr>
											<td style="width: 50%; border-right: 1px solid">
												<table style="width: 50%;">
													...
													<c:forEach var="issue" items="${issueList}">
													<tr>
														<td>&nbsp;</td> <td style="border-left: 1px solid"> <c:out value="(I-${issue.ISSUES_NUMBER})"/></td>
													</tr>
													</c:forEach>
				...
				<div>
					<h2 class="page-header" style="text-align: center;">
						...
						<table class="table table-striped" style="width: 100%;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black">
							<tbody>
								<tr>
								<td style="text-align:center;" colspan="4"> <h4>Job Card for issue(II)(<c:forEach var="issue" items="${issueList}">${issue.ISSUES_NUMBER},</c:forEach>
