...
<div class="content-wrapper">
	...
	<c:if test="${param.Notauthorized eq true}">
		<div style="width:50%;margin-left:50p%;" class="alert alert-danger alert-sm" >
			<button class="close" data-dismiss="alert" type="button">x</button>
			You are Not Authorized to Transfer or Receive these Parts !
		</div>
	</c:if>
