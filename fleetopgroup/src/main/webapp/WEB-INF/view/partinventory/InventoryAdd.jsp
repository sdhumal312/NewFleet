							...
							<fieldset>
								...
								<div class="box">
									<div class="box-body">
										...
										<div class="row1">
										 <input type="hidden" id="validateVendor" value="${configuration.validateVendor}">
											<label class="L-size control-label">Vendor :<c:if test="${configuration.validateVendor}"><abbr title="required">*</abbr></c:if></label>
