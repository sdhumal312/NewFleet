...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm"
						onclick="advanceTableToExcel('tripCollExpenseName', 'Part Requisition Report')" id="exportExcelBtn">
									...
									<div class="form-horizontal ">
										<div class="row1">
											<label class="L-size control-label">Requisition
												location : </label>
											<div class="I-size">
												<input type="hidden" id="requisitionlocation" name="requisitionlocation"
													style="width: 100%;" placeholder="All" />
											</div>
										</div>
										<div class="row1">
												<label class="L-size control-label">Requisition Assigned To :</label>
												<div class="I-size">
													<input type="hidden" id="requisitionAssignedTo" name="requisitionAssignedTo"
	...
	<script type="text/javascript"
		src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/report/part/SearchPartRequisition.js"/>"></script>
