			...
			<div class="col-md-offset-1 col-md-9 col-sm-9 col-xs-12">
				...
				<sec:authorize access="hasAuthority('EDIT_TRIPSHEET')">
					<form id="formEditTripCollection"
						action="<c:url value="/updateTripCol.in"/>" method="post"
								...
								<div class="box">
									<div class="box-body">
										<div class="row1" id="grpvehicleName" class="form-group">
											...
											<input type="hidden" name="TRIPCOLLNUMBER"
												value="${TripCol.TRIPCOLLNUMBER}"> 
												<label
								...
								<div class="box">
									<div class="box-body">
											...
											<div class="I-size">
												<div class="input-group input-append date"
													...
													<input type="text" class="form-text" name="TRIP_OPEN_DATE"
														value="${TripCol.TRIP_OPEN_DATE}" id="tripDate"
										...
										<div class="row1">
											...
											<div class="I-size">
												<input class="form-text" name="TRIP_OPEN_KM"
													value="${TripCol.TRIP_OPEN_KM}" id="tripOpeningKM"
													placeholder="" type="text" maxlength="50"
										...
										<div class="row1" id="grptripliter" class="form-group">
											...
											<div class="I-size">
												<input class="form-text" name="TRIP_DIESEL_LITER"
													 id="tripliter" placeholder=""
													type="text" maxlength="50"
													value="${TripCol.TRIP_DIESEL_LITER}"
													onkeypress="return tripOpening(event);"
										...
										<div class="row1" id="grptripSingl" class="form-group">
											<label class="L-size control-label">Singl :<abbr
												title="required">*</abbr></label>
											<div class="I-size">
												<input class="form-text" name="TRIP_SINGL"
													value="${TripCol.TRIP_SINGL}" 
													id="tripSingl" placeholder="" type="text" maxlength="50"
													onkeypress="return tripOpening(event);"
										...
										<div class="row1">
											...
											<div class="I-size">
												<textarea class="form-text" id="fuel_comments"
													...
													ondrop="return false;">${TripCol.TRIP_REMARKS}
