				...
				<div class="col-md-3 col-sm-4 col-xs-12">
					<div class="info-box">
						<div class="info-box-center">
							...
							<form action="<c:url value="/searchTripClosed.in"/>"
								method="post">
							...
							<div class="row">
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation" class="active"><a
										href="<c:url value="/closeTripCol/1.in"/>"> Close Trip <span
		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('VIEW_TRIPSHEET')">
				<div class="main-body">
									...
									<tbody>
										<c:forEach items="${TripCol}" var="TripCol">
											<tr data-object-id="" class="ng-scope">
												...
												<td><a
													href="<c:url value="/copyTripCol.in?ID=${TripCol.TRIPCOLLID}"/>"
													class="btn-sm btn btn-info" data-toggle="tip" data-original-title="Copy Old to Create New"><span class="fa fa-copy"></span></a></td>
												<td class="fit"><a
					...
					<c:url var="firstUrl" value="/closeTripCol/1" />
					<c:url var="lastUrl"
						value="/manageTripCol/${deploymentLog.totalPages}" />
					<c:url var="prevUrl" value="/closeTripCol/${currentIndex - 1}" />
					<c:url var="nextUrl" value="/closeTripCol/${currentIndex + 1}" />
					<div class="text-center">
						<ul class="pagination pagination-lg pager">
							...
							<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
								<c:url var="pageUrl" value="/closeTripCol/${i}" />
								<c:choose>
