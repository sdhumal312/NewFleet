...
<div class="content-wrapper">
	...
	<section class="content">
				...
				<div class="col-md-offset-1 col-md-9">
					...
					<form method="POST" enctype="multipart/form-data" id="fileUploadForm">	
						<div class="form-horizontal ">
							...
							<input type="hidden" value="${renewalVehicleId}" id="renewalVehicleId" />
							<input type="hidden" value="${renewalSubTypeId}" id="mandatoryRenewalSubTypeId" />
							...
							<input type="hidden" value="${configuration.stopIvCargoCashBookEntries}" id="stopIvCargoCashBookEntries">
											...
											<div class="I-size">
												...
												<div class="col-md-4">
													<select class="form-text" id="renewal_periedthreshold"
														...
														<option value="28" selected="selected">Month(s)</option>
													</select>
												</div>
											</div>
							...
							<div class="panel-footer">
								...
								<div class="I-size">
									<div class="col-sm-offset-4 I-size">
										<input type="button" value="Create Renewal Reminder" id="btnSubmit" class="btn btn-success" />	
										<c:if test="${empty vehicle.vid}">
											<a class="btn btn-danger" href="<c:url value="/viewRenewalReminder.in"/>">Cancel </a>
										</c:if>
										<c:if test="${!empty vehicle.vid}">
		...
		<script type="text/javascript"
			src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/RR/RenewalReminderAjaxAdd.js" />"></script>
