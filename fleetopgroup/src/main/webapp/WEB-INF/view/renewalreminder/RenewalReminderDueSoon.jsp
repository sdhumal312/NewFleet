		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('VIEW_RENEWAL')">
				<div class="main-body">
					...
					<c:url var="firstUrl" value="/RenewalDueSoon/${SelectStatus}/1" />
					<c:url var="lastUrl"
						value="/RenewalDueSoon/${SelectStatus}/${deploymentLog.totalPages}" />
					<c:url var="prevUrl"
						value="/RenewalDueSoon/${SelectStatus}/${currentIndex - 1}" />
					<c:url var="nextUrl"
						value="/RenewalDueSoon/${SelectStatus}/${currentIndex + 1}" />
					<div class="text-center">
						<ul class="pagination pagination-lg pager">
							...
							<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
								<c:url var="pageUrl"
									value="/RenewalDueSoon/${SelectStatus}/${i}" />
								<c:choose>
