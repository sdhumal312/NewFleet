								...
								<table id="RenewalReminderTable" class="table table-hover table-bordered">
									<thead>
										<tr>
											...
											<th class="fit ar">ApprovalID</th>
											<th class="fit ar">Upload</th>
										</tr>
									</thead>
									<tbody>
										<c:if test="${!empty renewal}">
											<c:forEach items="${renewal}" var="renewal">
												...
												<tr data-object-id="" class="ng-scope">
													...
													<td class="fit"><a
														href="<c:url value="/3/ShowRenRemApproval.in?AID=${renewal.renewal_approvedID}&page=1" />"
														data-toggle="tip" data-original-title="Click this Details"><c:out
																value="RA-${renewal.renewalAproval_Number}" /> </a></td>

													<td class="fir"><sec:authorize access="hasAuthority('ADD_RENEWAL')">
