...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
					...
					<span> Revise Renewal Reminder</span>
				</div>
	...
	<section class="content">
											...
											<div class="col-md-3">
												<div class="input-group input-append date">
													<input type="text" class="form-text" name="renewal_from"
														data-inputmask="'mask': ['99-99-9999  to  99-99-9999']" readonly='readonly'
														data-mask="" required id="reservation" maxlength="26" readonly="readonly">
							...
							<div class="panel-footer">
								...
								<div class="I-size">
									<div class="col-sm-offset-4 I-size">
										<input type="button" value="Revise Renewal Reminder" id="btnSubmit" class="btn btn-success" />	
		...
		<script type="text/javascript"
			src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/RR/RenewalReminderAjaxRevise.js" />"></script>
