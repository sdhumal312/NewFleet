		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('EDIT_RENEWAL')">
				<div class="col-md-offset-1 col-md-9">
					<form id="formRenewal"
						action="<c:url value="ReUploadRenewalReminder.in"/>" method="post"
						...
						<input type="hidden" class="form-control" name="renewal_document"
							value="${renewalReminder.renewal_document}" id="renewal_document">
						<input type="hidden" class="form-control" name="renewal_document_id"
							value="${renewalReminder.renewal_document_id}" id="renewal_document_id">
							...
							<div class="box">
								<div class="box-body">
									<div class="row1" id="grprenewalDate" class="form-group">
										...
										<div class="I-size">
											<div class="input-group input-append date">
												<input readonly="readonly" type="text" class="form-text" name="renewal_from"
									...
									<div class="row" id="grprenewalTime" class="form-group">
										...
										<div class="I-size">
											<div class="col-md-4">
												<input readonly="readonly" type="text" class="form-text"
											...
											<div class="col-md-4">
												<select class="form-text" name="renewal_periedthreshold"
													name="renewal_periedthreshold" readonly="readonly"
							...
							<div class="box">
								<div class="box-body">
									...
									<div class="row1" id="grprenewalReceipt" class="form-group">
										...
										<div class="I-size">
											<input readonly="readonly" type="text" class="form-text" name="renewal_receipt"
									...
									<div class="row1" id="grprenewalAmount" class="form-group">
										...
										<div class="I-size">
											<input readonly="readonly" type="number" class="form-text" name="renewal_Amount"
									...
									<div class="row1">
										...
										<div class="I-size">
												<select class="form-text" name="paymentTypeId"
													id="renPT_option" readonly="readonly" >
									...
									<div class="row1">
										<label class="L-size control-label">Cashier | Paid By
											: </label>
										<div class="I-size">
											<input readonly="readonly" type="text" class="form-text" name="renewal_paidby"
								...
								<div class="box-body">
									<div class="row1" id="grprenewalFile" class="form-group">
										<label class="L-size control-label" for="renewalFile">File
											:</label>
										<div class="I-size">
											<input required="required" type="file" id="renewalFile" name="input-file-preview" />
