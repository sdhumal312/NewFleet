			...
			<div class="box-body">
				<div class="pull-left">
					<a href="<c:url value="/open"/>"><spring:message
						...
						href="<c:url value="/mailbox/1.in"/>">MailBox</a>
				</div>
	...
	<section class="content">
		...
		<div class="row">
				...
				<div class="box box-solid">
					...
					<div class="box-body no-padding">
						<ul class="nav nav-pills nav-stacked">
							<li class="active"><a
								href="<c:url value="/mailbox/1.in"></c:url>"><i
					...
					<div class="box-body no-padding">
						<ul class="nav nav-pills nav-stacked">
							...
							<li><a href="<c:url value="/subscribebox" />"><i
									class="fa fa-calendar-plus-o text-yellow"></i> Subscribe <span
									data-toggle="tip" title="" class="badge bg-red"
									data-original-title="${SubscribeCount} Subscribe for you">${SubscribeCount}</span></a></li>
			...
			<div class="col-md-9 col-sm-8 col-xs-12">
				<div class="box box-primary">
					<div class="box-body no-padding">
						<form id="frm-example" action="<c:url value="/deleteinboxbox"/>" method="post">
													...
													<c:when test="${mail.MAIL_IS_SEEN == false}">
														<tr class="success">
															...
															<td class="mailbox-name"><a
																...
																href="<c:url value="/readmailbox?id=${mail.MAILBOX_ID_Encode}" />">From:
				...
				<!-- /. box -->
				<c:url var="firstUrl" value="/mailbox/1" />
				<c:url var="lastUrl" value="/mailbox/${deploymentLog.totalPages}" />
				<c:url var="prevUrl" value="/mailbox/${currentIndex - 1}" />
				<c:url var="nextUrl" value="/mailbox/${currentIndex + 1}" />
				<div class="text-center">
					<ul class="pagination pagination-lg pager">
						...
						<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
							<c:url var="pageUrl" value="/mailbox/${i}" />
							<c:choose>
