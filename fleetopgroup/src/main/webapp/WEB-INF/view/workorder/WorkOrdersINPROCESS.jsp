		...
		<sec:authorize access="hasAuthority('VIEW_WORKORDER')">
				...
				<div class="col-md-4 col-sm-5 col-xs-12">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">IN Process Work Orders</span> <span
			...
			<div class="row">
				<div class="main-body">
									...
									<tbody>
										<c:forEach items="${WorkOrder}" var="WorkOrder">
											<tr data-object-id="" class="ng-scope">
												...
												<td><c:choose>
														<c:when
															test="${WorkOrder.workorders_document == true}"><sec:authorize
													...
													</sec:authorize></c:when></c:choose></td>
												<td class="icon">
													<div class="btn-group">
					...
					<c:url var="firstUrl" value="/WorkOrdersINPROCESS/1" />
					<c:url var="lastUrl"
						value="/WorkOrdersINPROCESS/${deploymentLog.totalPages}" />
					<c:url var="prevUrl"
						value="/WorkOrdersINPROCESS/${currentIndex - 1}" />
					<c:url var="nextUrl"
						value="/WorkOrdersINPROCESS/${currentIndex + 1}" />
					<div class="text-center">
						<ul class="pagination pagination-lg pager">
							...
							<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
								<c:url var="pageUrl" value="/WorkOrdersINPROCESS/${i}" />
								<c:choose>
