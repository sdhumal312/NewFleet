		...
		<sec:authorize access="hasAuthority('VIEW_WORKORDER')">
				...
				<div class="col-md-4 col-sm-5 col-xs-12">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">Open Work Orders</span> <span
			...
			<c:if test="${param.danger eq true}">
				<div class="alert alert-danger">
					<button class="close" data-dismiss="alert" type="button">x</button>
					This Work Order Already Created.
				</div>
			</c:if>
			<c:if test="${param.alreadyDeleted eq true}">
				<div class="alert alert-danger">
					<button class="close" data-dismiss="alert" type="button">x</button>
					This Work Order Details Already Deleted.
				</div>
			</c:if>
			...
			<c:if test="${param.deleteAllTask eq true}">
				<div class="alert alert-danger">
					<button class="close" data-dismiss="alert" type="button">x</button>
					Please Delete all Job Task and Sub Job Task...
				</div>
			</c:if>
												...
												<td class="icon">
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-right">
															<li><sec:authorize
																	access="hasAuthority('EDIT_WORKORDER')">
																	<a
																		href="<c:url value="/editWorkOrders.in?ID=${WorkOrder.workorders_id}"/>"
																		class="confirmation"
			...
			<c:url var="firstUrl" value="/viewWorkOrder" />
			<c:url var="lastUrl"
				value="/newWorkOrders/${deploymentLog.totalPages}" />
			<c:url var="prevUrl" value="/newWorkOrders/${currentIndex - 1}" />
			<c:url var="nextUrl" value="/newWorkOrders/${currentIndex + 1}" />
			<div class="text-center">
				<ul class="pagination pagination-lg pager">
					...
					<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
						<c:url var="pageUrl" value="/newWorkOrders/${i}" />
						<c:choose>
