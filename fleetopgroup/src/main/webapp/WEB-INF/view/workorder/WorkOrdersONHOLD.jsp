		...
		<sec:authorize access="hasAuthority('VIEW_WORKORDER')">
				...
				<div class="col-md-4 col-sm-5 col-xs-12">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">On-Hold Work Orders</span> <span
			...
			<div class="row">
				<div class="main-body">
					...
					<c:url var="firstUrl" value="/WorkOrdersONHOLD/1" />
					<c:url var="lastUrl"
						value="/WorkOrdersONHOLD/${deploymentLog.totalPages}" />
					<c:url var="prevUrl" value="/WorkOrdersONHOLD/${currentIndex - 1}" />
					<c:url var="nextUrl" value="/WorkOrdersONHOLD/${currentIndex + 1}" />
					<div class="text-center">
						<ul class="pagination pagination-lg pager">
							...
							<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
								<c:url var="pageUrl" value="/WorkOrdersONHOLD/${i}" />
								<c:choose>
