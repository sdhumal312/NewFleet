							...
							<div id="work-order-statuses">
								...
								<div id="status-close">
									...
									<sec:authorize access="hasAuthority('DOWNLOAD_WORKORDER')">
										<c:choose>
										    <c:when test="${configuration.showCompanyWisePrint}">
																			...
																			<div class="panel-body">
																				<div class="form-horizontal">
																					...
																					<div class="row1">
																						...
																						<div class="I-size">
																							<input type="text" class="form-text" name="taskRemark" id="taskRemark_${WorkOrderTask.workordertaskid}"
																							...
																							<div class="row">
																								<div class="col-md-5">
																									<input type="hidden" name="workorders_id"
																									 ...
																									 javascript:getlastdetails('${WorkOrderTask.job_typetask}','${WorkOrderTask.job_subtypetask}','${WorkOrder.vehicle_vid}', 'last_occurred${WorkOrderTask.workordertaskid}');"
																										placeholder="Please Enter 2 or more Part Name" />

																									<%-- <select
																									class="form-text select2" name="partid"
																									id="inventory_name${WorkOrderTask.workordertaskid}"
																									required="required"
																									onchange="javascript:getQuantity('inventory_name${WorkOrderTask.workordertaskid}', 'parteachcost${WorkOrderTask.workordertaskid}', 'quantity${WorkOrderTask.workordertaskid}');"
																									style="width: 100%;">
																								...
																								<div class="col-md-1">
																									<input type="number" class="form-text"
																										...
																										id="quantity${WorkOrderTask.workordertaskid}"
																										min="0.0">
																								</div>


																								<%-- onkeyup="javascript:sumthere('quantity${WorkOrderTask.workordertaskid}', 'parteachcost${WorkOrderTask.workordertaskid}', 'tatalcost${WorkOrderTask.workordertaskid}');" --%>
																								<%-- <div class="col-md-1">
																								<input type="hidden" name="parteachcost"
																									class="form-text" placeholder="ech cost"
																									required="required"
																									id="parteachcost${WorkOrderTask.workordertaskid}"
																									onkeyup="javascript:sumthere('quantity${WorkOrderTask.workordertaskid}', 'parteachcost${WorkOrderTask.workordertaskid}', 'tatalcost${WorkOrderTask.workordertaskid}');"
																									readonly="readonly">
																							</div> --%>
																								<%-- <div class="col-md-2">
																								<input type="text" name="tatalcost"
																									class="form-text" required="required"
																									id="tatalcost${WorkOrderTask.workordertaskid}"
																									readonly="readonly">
																							</div> --%>
																								<div class="col-md-3">
																									<div class="row">
																										<input type="checkbox" name="oldpart"
																											class="L-size form-text" value="RECEIVED"
																							...
																							<div class="row">
																								<div class="col-md-2">
																									<input type="hidden" name="workorders_id"
																										...
																										value="${WorkOrderTask.workordertaskid}"
																										id="workordertaskid"> <input
																										type="text" class="form-text" name="labername"
															...
															<div class="row">
																...
																<div class="input float optional work_order_tax_cost">
																	<input autofocus="autofocus" class="form-text"
																		name="totalworktax_cost" step="any" type="number"
																		value="0.00">
																</div>
															</div>
															<div class="row">
