		...
		<div class="box">
			<div class="box-body">
				...
				<div class="col-md-off-5">
					...
					<c:if test="${configuration.showApprovalButton}">
					...
					<c:if test="${CashBook.CASH_STATUS_ID == 1 }">
						<sec:authorize access="hasAuthority('EDIT_CASHBOOK')">
						<a class="btn btn-warning btn-sm" href="<c:url value="/editCashBookEntry.in?Id=${CashBook.CASHID}"/>">
			...
			<c:choose>
				<c:when test="${CashBook.CASH_APPROVAL_STATUS_ID == 1 }">
					<div class="box">
						...
						<div class="box-body">
							<form action="approveCashBook.in" method="post"
									...
									<table class="table table-hover table-striped table-bordered">
										...
										<tbody>
											...
											<tr>
												...
												<td colspan="2"><b><c:out
															value="${CashBook.CASH_REFERENCENO}" escapeXml="false" /></b></td>
