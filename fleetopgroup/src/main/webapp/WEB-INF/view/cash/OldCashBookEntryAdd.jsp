...
<div class="content-wrapper">
		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('ADD_CASHBOOK')">
				<div class="col-md-offset-1 col-md-9">
					...
					<form action="<c:url value="/SCashBookEntry.html"/>"
						...
						<div class="form-horizontal ">
						  ...
						  <input type="hidden" id="oldCashbookBackDateStart" value="${oldCashbookBackDateStart}">
						  <input type="hidden" id="oldCashbookBackDateEnd" value="${oldCashbookBackDateEnd}">
									...
									<div class="box-body">
										...
										<c:if test="${configuration.isAutoVoucherNumber }">
											...
											<div class="row1">
												...
												<div class="I-size">
													<input class="form-text" id="CASH_AMOUNT" name="CASH_AMOUNT" type="text" maxlength="8" min="0" 
														placeholder="20000" required="required" onkeypress="return isNumberKeyWithDecimal(event,id);"
														ondrop="return false;"> <label class="error"
							...
							<div class="row1" id="saveCashBook">
								<div class="col-md-offset-5 col-md-7">
									<input class="btn btn-success" name="commit" type="submit" 
										...
										href="<c:url value="/addOldCashBookEntry.in"/>">Reset</a>
								</div>
							</div>
						</div>
					</form>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			var oldCashbookBackDateStart = $("#oldCashbookBackDateStart").val();
			var oldCashbookBackDateEnd = $("#oldCashbookBackDateEnd").val();
			...
			$("#CashPaymentDateOld").datepicker({
				autoclose : !0,
				format : "dd-mm-yyyy",
				startDate : oldCashbookBackDateEnd,
				endDate : oldCashbookBackDateStart
			}); 
