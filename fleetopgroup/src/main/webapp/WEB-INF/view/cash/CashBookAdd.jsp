		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('ADD_CASHBOOK')">
				<div class="col-md-offset-1 col-md-9">
					...
					<form action="<c:url value="/WithApprovalCashBook.html"/>"
							...
							<div class="row1">
								<div class="col-md-offset-5 col-md-7">
									<input class="btn btn-success"
										...
										type="submit" value="Save Today CashBook Entries"> <a
										class="btn btn-info" href="<c:url value="/addCashBook.in"/>">Reset</a>
								</div>
							</div>
						</div>
					</form>
