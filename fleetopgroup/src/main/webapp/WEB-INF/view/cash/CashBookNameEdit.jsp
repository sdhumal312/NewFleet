										...
										<div class="row" id="grpVehicleGroup">
												<div class="form-group">
													...
													<div class="I-size">
														...
														<option value="${CashBook.VEHICLE_GROUP_ID}">
																		<c:out value="${CashBook.VEHICLE_GROUP}" />
														</option>
										...
										<div class="row">
											...
											<div class="I-size">
												<input type="text" class="form-text" name="CASHBOOK_CODE"
													...
													value="${CashBook.CASHBOOK_CODE}" maxlength="50"
													id="cashBookCode"
											...
											<div class="col-sm-5">
												<fieldset class="form-actions">
													<input class="btn btn-success"
														onclick="return validateCashBookEdit()" name="commit"
