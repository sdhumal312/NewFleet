		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('VIEW_CASHBOOK')">
				<div class="main-body">
					...
					<c:url var="firstUrl" value="/CashBook/1" />
					<c:url var="lastUrl" value="/CashBook/${deploymentLog.totalPages}" />
					<c:url var="prevUrl" value="/CashBook/${currentIndex - 1}" />
					<c:url var="nextUrl" value="/CashBook/${currentIndex + 1}" />
					<div class="text-center">
						<ul class="pagination pagination-lg pager">
							...
							<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
								<c:url var="pageUrl" value="/CashBook/${i}" />
								<c:choose>
