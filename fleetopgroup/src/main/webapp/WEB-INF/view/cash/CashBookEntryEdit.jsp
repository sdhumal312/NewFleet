...
<div class="content-wrapper">
		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('EDIT_CASHBOOK')">
				<div class="col-md-offset-1 col-md-9">
					<form action="updateCashBookEntry.in" method="post">
									...
									<div class="box-body">
										...
										<div id="HideDibit">
											...
											<div class="row1">
												...
												<div class="I-size">
													<input class="form-text" id="fuel_price" name="CASH_AMOUNT"
														...
														required="required" onkeypress="return isNumberKeyWithDecimal(event,id);"
														> <label class="error"
											...
											<div class="row1">
												...
												<div class="I-size">
													<input class="form-text" id="fuel_reference" maxlength="50"
														name="CASH_REFERENCENO"
														value="${CashBook.CASH_REFERENCENO}" type="text"
											...
											<div class="row1">
												<div class="col-md-offset-5 col-md-7">
													<input class="btn btn-success"
														...
														type="submit" value="Update CashBook Entries"><a
														class="btn btn-info"
														href="<c:url value="/addCashBookEntry.in"/>">Cancel</a>
												</div>
											</div>
										</div>
									</div>
	...
	<script type="text/javascript">
		$(document)
				.ready(
						function() {
							var a = $("#paymentType").val();
							switch (a) {
							case "DEBIT":
										document
												.getElementById("paymentDebitEdit").style.display = "block",
										$("#paymentCreditEdit").html(""),
										document.getElementById("Credit").className += " disabled";
								var b = $("#OldPaymentType").val();
								var y = $("#OldPaymentTypeId").val();
								$("#NatureDebitPayment").select2("data", {
									id : y,
									text : b
								});
								break;
							case "CREDIT":
										document
												.getElementById("paymentCreditEdit").style.display = "block",
										$("#paymentDebitEdit").html(""),
										document.getElementById("Debit").className += " disabled";
								var c = $("#OldPaymentType").val();
								var z = $("#OldPaymentTypeId").val();
								$("#NatureCreditPayment").select2("data", {
									id : z,
									text : c
								})
							}
