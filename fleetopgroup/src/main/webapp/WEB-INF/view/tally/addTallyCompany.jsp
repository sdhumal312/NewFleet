...
<div class="content-wrapper">
	<section class="panel panel-success">
		<div class="box">
			<div class="box-body">
				<div class="pull-left">
						<a href="open" >Home</a>/ <a href="addTallyCompany.in">Tally Company Master</a>
				</div>
				<div class="pull-right">
			
						<% 
						Collection<GrantedAuthority>  permission = (Collection<GrantedAuthority>)request.getAttribute("permissions");
						if(permission.contains(new SimpleGrantedAuthority("TALLY_COMPANY_MASTER"))) {
						%>
						
  						<button type="button" class="btn btn-success" data-toggle="modal"
							data-target="#addManufacturer" data-whatever="@mdo">
							<span class="fa fa-plus" id="AddJobType"> Add Company </span>
						</button>
  						<% } %>
					...
					<div class="info-box">
						...
						<div class="info-box-content">
						 <input
							...
							<span id="totalTallyCompany" class="info-box-number"></span>
						</div>
					</div>
				</div>
	...
	<div class="modal fade" id="addManufacturer" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
						...
						<div class="modal-header">
							...
							<h4 class="modal-title" id="JobType">Create Tally
								Company</h4>
						</div>
						<div class="modal-body">
						
							<div class="row">
								<label class="L-size control-label" id="Type"> Company Name :
								<abbr title="required">*</abbr>
								</label>
								<div class="I-size">
									<input type="text" class="form-text" required="required"
										maxlength="150" name="tallyCompanyName" id="tallyCompanyName"
						...
						<div class="modal-footer">
							<button type="submit" class="btn btn-primary" onclick="saveTallyCompany();">
		...
		<div class="modal fade" id="editTallyComp" role="dialog">
			<div class="modal-dialog">
				<!-- Modal content-->
				<div class="modal-content">
						<input type="hidden" id="editTallyCompanyId">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"
								aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
							<h4 class="modal-title" id="JobType">Edit Tally
								Company</h4>
						</div>
						...
						<div class="modal-body">
							<div class="row">
								...
								<div class="I-size">
									<input type="text" class="form-text" required="required"
										maxlength="150" name="editTallyCompany" id="editTallyCompany"
										placeholder="Enter Company Name" />
								</div>
							</div>
							<br/>
						...
						<div class="modal-footer">
							<button type="submit" class="btn btn-primary" onclick="updateTallyCompany();">
								<span>Update</span>
							</button>
							<button type="button" class="btn btn-default"
								data-dismiss="modal">
...
<script type="text/javascript" src="resources/QhyvOb0m3EjE7A4/js/fleetop/tally/addTallyCompany.js"></script>