							...
							<fieldset>
								...
								<div class="box">
									<div class="box-body">
										...
										<input value="${TripDaily.VEHICLE_GROUP_ID}" id="VEHICLE_GROUP_ID" name="VEHICLE_GROUP_ID"  type="hidden"/>
										</div>
								...
								<div class="box">
									<div class="box-body">
										...
										<div class="row1">
											...
											<div class="I-size">
												<input class="form-text" name="TRIP_OPEN_KM" value="${CurrentOdometer}"
										...
										<div class="row1" id="grptripSingl" class="form-group">
											...
											<div class="I-size">
												<input class="form-text" name="TRIP_RFIDPASS" id="tripSingl"
													placeholder="enter RFID pass " type="text" maxlength="10"
													onkeypress="return tripOpening(event);"
										...
										<div class="row1" id="grptripAmount" class="form-group">
											...
											<div class="I-size">
												<input class="form-text" name="TRIP_RFID_AMOUNT" id="tripAmount"
													placeholder="enter RFID Amount " type="text" maxlength="10"
													onkeypress="return tripOpening(event);"
