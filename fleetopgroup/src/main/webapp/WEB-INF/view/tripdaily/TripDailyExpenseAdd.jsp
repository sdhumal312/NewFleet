				...
				<div class="box">
					<div class="boxinside">
						...
						<sec:authorize access="hasAuthority('ADD_EXPENSE_TRIPSHEET')">
												...
												<tbody>
													...
													<c:forEach items="${TripColExpense}" var="TripColExpense">
														<tr data-object-id="" class="ng-scope">
															...
															<td class="fit ar"><a onclick="this.style.visibility = 'hidden'" 
																href="removeDailyExpense.in?ID=${TripColExpense.tripExpenseID}"
							...
							<form action="updateDailyExpense.in" method="post">
									...
									<div class="box-footer h-padded">
										<fieldset class="form-actions">
											<input class="btn btn-success"
												onclick="return validateExpenseAndAmount();" name="commit"
