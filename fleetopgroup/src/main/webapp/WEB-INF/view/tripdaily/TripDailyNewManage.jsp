		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('VIEW_TRIPSHEET')">
				<div class="main-body">
											...
											<tr data-object-id="" class="ng-scope">
												...
												<td class="fit ar"><sec:authorize
														...
														<a class="btn btn-warning btn-sm"
															href="<c:url value="/addDailyExpense.in?ID=${TripDaily.TRIPDAILYID}"/>">
												...
												<td class="fit ar"><sec:authorize
														...
														<a class="btn btn-info btn-sm"
															href="<c:url value="/addDailyIncome.in?ID=${TripDaily.TRIPDAILYID}"/>">
					...
					<c:url var="firstUrl" value="/manageTripDaily/1" />
					<c:url var="lastUrl"
						value="/manageTripDaily/${deploymentLog.totalPages}" />
					<c:url var="prevUrl" value="/manageTripDaily/${currentIndex - 1}" />
					<c:url var="nextUrl" value="/manageTripDaily/${currentIndex + 1}" />
					<div class="text-center">
						<ul class="pagination pagination-lg pager">
							...
							<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
								<c:url var="pageUrl" value="/manageTripDaily/${i}" />
								<c:choose>
