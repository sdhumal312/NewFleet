							...
							<div class="row">
								<ul class="nav nav-tabs" role="tablist">
									<li role="presentation" class="active"><a
										href="<c:url value="/TDAllGroup/1.in"/>">Manage Trip <span
											data-toggle="tip" title="" class="badge bg-red"
											data-original-title="${TripManage} Manage Trip">${TripManage}</span>
									</a></li>
									<li role="presentation"><a
										href="<c:url value="/closeTDAllGroup/1.in"/>"> Close Trip</a></li>
									<%-- <li role="presentation"><a
										href="<c:url value="/YeTrDay.in"/>"> Yesterday Closed Trip</a></li> --%>
								</ul>
							</div>
						</div>
					</sec:authorize>
		...
		<div class="row">
			...
			<sec:authorize access="hasAuthority('VIEW_TRIPSHEET')">
				<div class="main-body">
										...
										<c:forEach items="${TDAllDay}" var="TDAllDay">
											<tr data-object-id="" class="ng-scope">
												...
												<td class="fir ar"><span
													class="label label-pill label-danger"><c:out
					...
					<c:url var="firstUrl" value="/TDAllGroup/1" />
					<c:url var="lastUrl"
						value="/TDAllGroup/${deploymentLog.totalPages}" />
					<c:url var="prevUrl" value="/TDAllGroup/${currentIndex - 1}" />
					<c:url var="nextUrl" value="/TDAllGroup/${currentIndex + 1}" />
					<div class="text-center">
						<ul class="pagination pagination-lg pager">
							...
							<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
								<c:url var="pageUrl" value="/TDAllGroup/${i}" />
								<c:choose>
