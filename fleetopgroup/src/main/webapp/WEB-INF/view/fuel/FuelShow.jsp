										...
										<table class="table table-striped">
											<tbody>
												...
												<c:if test="${configuration.showPaymentMode}">
													...
													<c:choose>
														<c:when test="${fuel.paidByBranchId>0}">
															<tr class="row">
																<th class="key">Paid By Branch :</th>
																<td class="value"><c:out value="${fuel.paidByBranchStr}" /></td>
															</tr>
														</c:when>
														<c:otherwise>
															<c:choose>
																<c:when test="${fuel.paymentTypeId !=1}">
																	<tr class="row">
																		<th class="key">Paid By :</th>
																		<td class="value">CashLess Payment</td>
																	</tr>
																</c:when>
																<c:otherwise>
																	<tr class="row">
																		<th class="key">Paid By Driver :</th>
