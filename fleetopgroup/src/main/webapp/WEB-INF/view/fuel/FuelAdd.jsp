...
<div class="content-wrapper">
	...
	<c:if test="${param.closeStatus eq true}">
		<div class="alert alert-danger">
			...
			${VMandatory} You should be close first TripSheet or change status or
			close workOrder .
		</div>
	</c:if>
	<c:if test="${param.Success eq true}">
		<div class="alert alert-success">
			<button class="close" data-dismiss="alert" type="button">x</button>
			${Number} This Fuel Entries created successfully .
		</div>
	</c:if>
							...
							<div class="panel-footer">
								...
								<div class="I-size">
									<div class="col-sm-offset-4 I-size">
										<button onclick="return validateMaxOdameter();" type="submit" class="btn btn-success">Create
											Fuel Entry</button>
