...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/FR.in"/>">Fuel </a> / <span id="reportHead">Driver Wise Fuel Entry Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'Driver Wise Fuel Entry Report')" id="exportExcelBtn">
				...
				<div class="form-horizontal ">
					...
					<c:if test="${configuration.showRoute }">
						<div class="row1">
							...
							<div class="I-size">
								<input type="text" id="routeId" name="TRIP_ROUTE"
	...
	<%-- <script type="text/javascript" 
	src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/FU/DateWiseFuelEntryReport.js"/>"></script> --%>
