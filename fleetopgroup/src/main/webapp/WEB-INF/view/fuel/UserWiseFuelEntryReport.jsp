...
<div class="content-wrapper">
		...
		<div class="box">
			<div class="box-body">
				...
				<a href="<c:url value="/open"/>"><spring:message
					...
					/ <a href="<c:url value="/FR.in"/>">Fuel </a> / <span id="reportHead">User Wise Fuel Entry Report </span>
				</div>
				<div class="pull-right">
					...
					<button class="btn btn-default btn-sm hide"
						onclick="advanceTableToExcel('tripCollectionExpenseList', 'User Wise Fuel Entry Report')" id="exportExcelBtn">
			...
			<div class="box-body" id="ElementDiv">
				<input type="hidden" id="showBranchToUserWiseReport" value="${configuration.showBranchToUserWiseReport}">
				<div class="form-horizontal ">
				<c:if test="${!configuration.showBranchToUserWiseReport}">
					<div class="row1">
						<label class="L-size control-label"> User
							Name <abbr title="required">*</abbr>
						</label>
						<div class="I-size">
							<input class="" placeholder="users Name" id="subscribe"
							...
							<p class="help-block">Please Select User name</p>
						</div>
					</div>
				</c:if>
				<c:if test="${configuration.showBranchToUserWiseReport}">
					<div class="row1">
						...
						<div class="I-size">
							<input class="" placeholder="Branch Name" id="branchnamelist"
								type="hidden" style="width: 100%" name="branchId"
								 ondrop="return false;">
							<p class="help-block">Please Select Branch name</p>
						</div>
					</div>
					...
					<div class="row1">
						...
						<div class="I-size" >
							<select  id="subscribeByBranchId" style="width: 100%">
	...
	<script type="text/javascript" 
	src="<c:url value="/resources/QhyvOb0m3EjE7A4/js/fleetop/FU/UserWiseFuelEntryReport.js"/>"></script>+
	<script
