...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleUserNotFound(final RuntimeException ex, final WebRequest request, HttpServletRequest request2) {
    	  int statusCodew	=	getErrorCode(request2);
    	  logger.error("statusCode "+ statusCodew);
    ...
    public ResponseEntity<Object> handleInternal(final RuntimeException ex, final WebRequest request, HttpServletRequest	request2) {
        logger.error("500 Status Code", ex);
        int statusCodew	=	getErrorCode(request2);
  	  logger.error("statusCode "+ statusCodew);
