...
public class AlertNotificationsController {
	...
	@Autowired	private	IVendorApprovalService		vendorApprovalService;
	@Autowired	private IFuelService				fuelService;
	@Autowired  private IVehicleModelTyreLayoutService	layoutService;
	...
	@RequestMapping(value="insertMissingCashPayment", produces="application/json", method=RequestMethod.GET)
	public String  insertMissingCashPayment(@RequestParam HashMap<Object, Object> allRequestParams) throws Exception {
		try {
	...
	@RequestMapping(value="driverBalanceTest", produces="application/json", method=RequestMethod.GET)
	public String  driverBalanceTest(@RequestParam HashMap<Object, Object> allRequestParams) throws Exception {
		try {
			
			List<TripSheetExpenseDto>	test =	vendorApprovalService.findVendorPaymentListATC("2023-05-01 00:00:00", "2023-05-05 23:59:59", 46,
								"ATC 2023 24");
