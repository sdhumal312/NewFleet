...
public class FileUtility {
	...
	public static String getContentType(String fileExtension)throws Exception{
		...
		try{
			...
			if(fileExtension.equals(FILE_EXTENSION_PNG)){
				fileNewExtension = FILE_CONTENT_TYPE_PNG;
			}
