...
public class VendorLorryHireBL {
	...
	public VendorMarketLorryHireDetails	getVendorMarketLorryHireDetails(ValueObject	valueObject) throws Exception{
		...
		try {
			...
			hireDetails.setVendorId(valueObject.getInt("vendorId",0));
			hireDetails.setVid(valueObject.getInt("vid",0));
			hireDetails.setLorryHire(valueObject.getDouble("lorryHire"));
			hireDetails.setAdvanceAmount(valueObject.getDouble("advanceAmount",0));
			hireDetails.setPaidAmount(valueObject.getDouble("advanceAmount",0));
			...
			hireDetails.setIncomeId(valueObject.getInt("incomeId",0));
