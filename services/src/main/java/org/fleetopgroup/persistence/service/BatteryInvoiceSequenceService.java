...
@Service
public class BatteryInvoiceSequenceService implements IBatteryInvoiceSequenceService {
	...
	public BatteryInvoiceSequenceCounter findNextInvoiceNumber(Integer companyId) throws Exception {
		BatteryInvoiceSequenceCounter counter = sequenceRepository.findNextInvoiceNumber(companyId);
		if(counter != null)
