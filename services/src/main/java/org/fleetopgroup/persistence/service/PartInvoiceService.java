	...
	public PartInvoiceDto details_of_PartInvoice(Long partInvoice_id, Integer companyId) throws Exception {
		...
		Query query = entityManager.createQuery(
				"SELECT PI.partInvoiceId, PI.partInvoiceNumber, PI.invoiceNumber, PI.invoiceDate, PI.invoiceAmount, "
						...
						+ " LEFT JOIN VendorSubApprovalDetails VSA ON VSA.invoiceId = PI.partInvoiceId AND VSA.approvalPlaceId = "+ApprovalType.APPROVAL_TYPE_INVENTORY_PART_INVOICE+" AND VSA.markForDelete = 0 "
						+ " LEFT JOIN VendorApproval VA ON VA.approvalId = VSA.approvalId AND VA.markForDelete = 0"
						+ " WHERE PI.companyId = " + companyId
