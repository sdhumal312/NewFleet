...
public class VehicleModelService implements IVehicleModelService {
	...
	public ValueObject deleteVehicleModel(ValueObject valueObject) throws Exception {
		...
		try {
			...
			vehicleConfiguration			= companyConfigurationService.getCompanyConfiguration(userDetails.getCompany_id(), PropertyFileConstants.VEHICLE_CONFIGURATION_CONFIG);
			...
			if ((boolean) vehicleConfiguration.getOrDefault("vehicleModelTyreLayout", false)) {
