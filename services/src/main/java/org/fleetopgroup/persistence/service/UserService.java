...
public class UserService implements IUserService {
	...
	public ValueObject registerUserAccount(ValueObject valueObject) throws EmailExistsException {
		...
		try {
			System.err.println("valueObject user save : "+valueObject);
			...
			System.err.println("branchMapper user save : "+branchMapper);
			...
			if (validate == null || valueObject.getBoolean("fromEdit", false)) {
				...
				if(validate != null) {
					...
					saveUSERProfiel	= userProfileService.getUserProfileByUser_id(validate.getId(), companyMapper.getFleetCompanyId());
				}
