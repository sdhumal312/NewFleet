...
public class DriverLedgerDto {
	...
	public String toString() {
		return "DriverLedgerDto [driverLedgerId=" + driverLedgerId + ", driverId=" + driverId + ", companyId="
				+ companyId + ", transactionAmount=" + transactionAmount + ", openingBalance=" + openingBalance
				+ ", closingBalance=" + closingBalance + ", transactionId=" + transactionId + ", txnTypeId=" + txnTypeId
				+ ", txnTypeStr=" + txnTypeStr + ", txnDateTime=" + txnDateTime + ", txnDateStr=" + txnDateStr
				+ ", subTransactionId=" + subTransactionId + ", description=" + description + ", createdById="
				+ createdById + ", updatedById=" + updatedById + ", createdOn=" + createdOn + ", modifiedOn="
				+ modifiedOn + ", markForDelete=" + markForDelete + ", driverName=" + driverName + ", creditAmount="
				+ creditAmount + ", debitAmount=" + debitAmount + ", transactionNo=" + transactionNo + ", tripsheetId="
				+ tripsheetId + "]";
	}
}
