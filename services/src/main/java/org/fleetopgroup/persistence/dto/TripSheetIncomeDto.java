...
public class TripSheetIncomeDto {
	...
	public String toString() {
		return "TripSheetIncomeDto [tripincomeID=" + tripincomeID + ", incomeName=" + incomeName + ", incomeId="
				...
				+ ", driverExcludedStr=" + driverExcludedStr + ", tripDateTime=" + tripDateTime + ", lsSourceBranch="
				+ lsSourceBranch + ", billType=" + billType + ", billSelectionId=" + billSelectionId
				+ ", lsDestinationBranch=" + lsDestinationBranch + "]";
	}
