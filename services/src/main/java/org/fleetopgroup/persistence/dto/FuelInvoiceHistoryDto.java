...
public class FuelInvoiceHistoryDto {
	...
	public String toString() {
		return "FuelInvoiceHistoryDto [fuelInvoiceHistoryId=" + fuelInvoiceHistoryId + ", fuelInvoiceId="
				+ fuelInvoiceId + ", fuelInvoiceNumber=" + fuelInvoiceNumber + ", quantity=" + quantity + ", rate="
				+ rate + ", discount=" + discount + ", gst=" + gst + ", discountGstTypeId=" + discountGstTypeId
				...
				+ petrolPumpId + ", petrolPumpName=" + petrolPumpName + ", paymentType=" + paymentType + ", vendorName="
				+ vendorName + ", invoiceDateStr=" + invoiceDateStr + ", tallyCompanyName=" + tallyCompanyName
				...
				+ ", stockTypeId=" + stockTypeId + ", stockType=" + stockType + ", remark=" + remark + "]";
	}
