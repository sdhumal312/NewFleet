...
public interface ICashBookService {
	...
	public void Update_DEBIT_CashBalance_SubtrackBalance_Details(short CashBookAPPROVAL_ID, String cashDate, Integer CASH_BOOK_ID, short PAYMENT_TYPE_ID, Long CBID);

	/** This get CashBook Balance To Update CREDIT Values */
	public void Update_CREDIT_CashBalance_AddBalance_Details(short CashBookAPPROVAL_ID, String cashDate, Integer CASH_BOOK_ID, short PAYMENT_TYPE_ID, Long CBID);
