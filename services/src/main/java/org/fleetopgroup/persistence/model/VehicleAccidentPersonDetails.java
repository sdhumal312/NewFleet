...
@Entity
@Table(name = "VehicleAccidentPersonDetails")
public class VehicleAccidentPersonDetails implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "vehicleAccidentPersonDetailsId")
	private Long vehicleAccidentPersonDetailsId;

	@Column(name = "accidentDetailsId")
	private Long accidentDetailsId;
	
	@Column(name = "vehicleAccidentPersonTypeId")
	private short vehicleAccidentPersonTypeId;
	
	@Column(name = "vehicleAccidentPersonStatusId")
	...
	public VehicleAccidentPersonDetails() {
		super();
