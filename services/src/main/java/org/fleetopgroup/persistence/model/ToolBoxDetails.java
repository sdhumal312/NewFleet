...
@Entity
@Table(name="ToolBoxDetails")
public class ToolBoxDetails implements Serializable
{
	...
	public ToolBoxDetails() {
		super();
	}

	public ToolBoxDetails(Long toolBoxDetailsId, Integer vid, Long toolBoxId, Double quantity, String description,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ToolBoxDetails other = (ToolBoxDetails) obj;
	...
	public String toString() {
		return "ToolBoxDetails [ToolBoxDetailsId=" + ToolBoxDetailsId + ", vid=" + vid + ", toolBoxId=" + toolBoxId
