...
public class Vehicle implements Serializable {
	...
	@Column(name = "vehicleTollId")
	private String vehicleTollId;

	@Column(name = "subCompanyId")
	private Integer subCompanyId;
	
	@Column(name = "driverMonthlyBhatta")
	private Double driverMonthlyBhatta;
	...
	public Double getDriverMonthlyBhatta() {
		return driverMonthlyBhatta;
	}



	public void setDriverMonthlyBhatta(Double driverMonthlyBhatta) {
	...
	public String toString() {
		...
		builder.append(driverMonthlySalary);
		builder.append(", Subcompany_Id=");
		builder.append(subCompanyId);
		builder.append(", driverMonthlyBhatta=");
		builder.append(driverMonthlyBhatta);
