...
@Entity
@Table(name = "VehicleTyreModelTypeHistory")
public class VehicleTyreModelTypeHistory implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "Vehicle_Tyre_Model_Type_History_Id")
	private Integer Vehicle_Tyre_Model_Type_History_Id;
	...
	public Integer getVehicle_Tyre_Model_Type_History_Id() {
		return Vehicle_Tyre_Model_Type_History_Id;
	}

	public void setVehicle_Tyre_Model_Type_History_Id(Integer vehicle_Tyre_Model_Type_History_Id) {
		Vehicle_Tyre_Model_Type_History_Id = vehicle_Tyre_Model_Type_History_Id;
	}
