...
@Entity
@Table(name = "CashBookHistory")
public class CashBookHistory implements Serializable{
	...
	@Column(name = "CASHHISTORYID")
	private long CASHHISTORYID;
	
	@Column(name = "CASHID", nullable = false)
	private long CASHID;
	...
	public CashBookHistory() {
		super();
	}
	
	
	
	public CashBookHistory(long cASHHISTORYID, long cASHID, long cASH_NUMBER, String cASH_BOOK_NO, Integer cASH_BOOK_ID,
			short pAYMENT_TYPE_ID, Date cASH_DATE, String cASH_VOUCHER_NO, Double cASH_AMOUNT,
			String cASH_NATURE_PAYMENT, Integer cASH_NATURE_PAYMENT_ID, String cASH_PAID_RECEIVED, String cASH_PAID_BY,
			short cASH_STATUS_ID, short cASH_APPROVAL_STATUS_ID, String cASH_APPROVALBY, String cASH_APPROVALCOMMENT,
			Date cASH_APPROVALDATE, String cASH_REFERENCENO, String cASH_GSTNO, boolean cASH_DOCUMENT,
			Long cASH_DOCUMENT_ID, Integer cOMPANY_ID, Integer dRIVER_ID, String cREATEDBY, String lASTMODIFIEDBY,
			boolean markForDelete, Date cREATED_DATE, Date lASTUPDATED_DATE) {
		super();
	...
	public long getCASHHISTORYID() {
		return CASHHISTORYID;
	}



	public void setCASHHISTORYID(long cASHHISTORYID) {
		CASHHISTORYID = cASHHISTORYID;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CashBookHistory other = (CashBookHistory) obj;
	...
	public String toString() {
		...
		builder.append("CashBook [CASHHISTORYID=");
		builder.append(CASHHISTORYID);
