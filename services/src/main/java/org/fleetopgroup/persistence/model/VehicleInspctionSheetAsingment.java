...
@Entity
@Table(name="VehicleInspctionSheetAsingment")
public class VehicleInspctionSheetAsingment {
	...
	public VehicleInspctionSheetAsingment() {
		super();
	}
	
	

	public VehicleInspctionSheetAsingment(Long vehicleInspctionSheetAsingmentId, Integer vid,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VehicleInspctionSheetAsingment other = (VehicleInspctionSheetAsingment) obj;
		if (assignById == null) {
	...
	public String toString() {
		return "VehicleInspctionSheetAsingment [vehicleInspctionSheetAsingmentId=" + vehicleInspctionSheetAsingmentId
