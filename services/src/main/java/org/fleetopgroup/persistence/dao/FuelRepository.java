...
public interface FuelRepository extends JpaRepository<Fuel, Long> {
	...
	@Query("from Fuel as F where F.fuel_TripsheetID= ?1 AND F.companyId = ?2 AND F.markForDelete = 0")
	public List<Fuel> getTotalFuelAmount(Long Tripsheet_Id, Integer companyId) throws Exception;
