...
public interface ApprovalRequisitionRepository extends JpaRepository<ApprovedRequisitionDetails, Long> {
	...
	public void updateApprovalStatusAndReceiveQty(long approvedRequisitionId ,int companyId,Long lastModifiedById,Date lastUpdatedOn,Short approvalStatus,Integer receivedQuantity);
	...
	public void updateApprovalStatusAndReceiveQty(long approvedRequisitionId ,int companyId,Long lastModifiedById,Date lastUpdatedOn,Short approvalStatus,Integer receivedQuantity,String remark);
