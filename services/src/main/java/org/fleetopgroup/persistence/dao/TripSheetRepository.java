...
*/
	...
	@Query("select T FROM TripSheet T WHERE T.tripSheetID  = ?1 AND T.markForDelete = 0")
	public TripSheet getTripSheetByTripsheetId(Long trisheetId) throws Exception;
