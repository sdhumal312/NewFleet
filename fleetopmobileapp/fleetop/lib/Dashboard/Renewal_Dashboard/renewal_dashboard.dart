...
import 'package:fleetop/Dashboard/Renewal_Dashboard/renewallistview.dart';
...
class RenewalReminderDashboard extends StatefulWidget {
  ...
  @override
  _RenewalReminderDashboardState createState() => _RenewalReminderDashboardState();
}

class _RenewalReminderDashboardState extends State<RenewalReminderDashboard>
  ...
  String renewalCreatedCount;
  String todaysRenewalCount;
  String selectedDate;
  bool showdate = false;
  Map renewalReminderData = Map();
  ...
  setInitialData() {
    setState(() {
      ...
      renewalReminderData = widget.renewalReminderData;
    });
    getRenewalReminderData(startDate, endDate);
  }
    ...
    showDialog(
      ...
      builder: (BuildContext context) => CalendarPopupView(
        ...
        onApplyClick: (DateTime startData, DateTime endData) {
          ...
          getRenewalReminderData(startData, endData);
        },
        onCancelClick: () {},
      ),
    );
  ...
  getRenewalReminderData(startDate, endDate) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    companyId = prefs.getString("companyId");
    ...
    if (data != null) {
      setState(() {
        ...
        renewalCreatedCount =
            data["renewalCreatedOnVehicle"].toString();
        todaysRenewalCount = 
            data["renewalNotCreatedOnVehicle"].toString();
        showdate = true; 
      });
      listViews.clear();
      addAllListData();
  ...
  setPieChartData() {
    bardata = [
      SummaryBar(
          summaryName: "Vehicles With RR",
          summaryCount: renewalCreatedCount,
          barColor: charts.ColorUtil.fromDartColor(Colors.blueAccent)),
      SummaryBar(
          summaryName: "Vehicles Without RR ",
          summaryCount: todaysRenewalCount,
  ...
  addAllListData() {
    ...
    listViews.add(Container(
      ...
      child: RenewalReminderListView(
        ...
        renewalReminderData: renewalReminderData,
      ),
    ));
    ...
    listViews.add(Container(
      padding: EdgeInsets.only(top: 40),
      child: DaysWiseRenewalReminderListView(
        startSelectedDate: startDate,
        endSelectedDate: endDate,
        mainScreenAnimation: widget.mainScreenAnimation,
        mainScreenAnimationController: widget.mainScreenAnimationController,
    ...
    listViews.add(Center(child: PieChartSummary(data: bardata,title : "Renewal Reminder Status")));
  }
