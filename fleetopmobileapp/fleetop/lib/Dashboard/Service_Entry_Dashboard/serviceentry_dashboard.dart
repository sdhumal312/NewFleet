...
import 'package:fleetop/Dashboard/Service_Entry_Dashboard/serviceentrylistview.dart';
...
class ServiceEntryDashboard extends StatefulWidget {
  ...
  @override
  _ServiceEntryDashboardState createState() => _ServiceEntryDashboardState();
}

class _ServiceEntryDashboardState extends State<ServiceEntryDashboard>
  ...
  String seOpenCounts;
  String seProcessCounts;
  String seCloseCounts;
  String selectedDate;
  bool showdate = false;
  Map serviceEntryData = Map();
  ...
  setInitialData() {
    setState(() {
      ...
      serviceEntryData = widget.serviceEntryData;
    });
    getServiceEntryData(startDate, endDate);
  }
    ...
    showDialog(
      ...
      builder: (BuildContext context) => CalendarPopupView(
        ...
        onApplyClick: (DateTime startData, DateTime endData) {
          ...
          getServiceEntryData(startData, endData);
        },
        onCancelClick: () {},
      ),
    );
  ...
  getServiceEntryData(startDate, endDate) async {
  SharedPreferences prefs = await SharedPreferences.getInstance();
  companyId = prefs.getString("companyId");
    ...
    if (data != null) {
      ...
      seOpenCounts =
          data["SEOpenCounts"].toString();
      seProcessCounts =
          data["SEProcessCounts"].toString();
      seCloseCounts =
          data["SECloseCounts"].toString();
      showdate = true;
      });
      listViews.clear();
      addAllListData();
  ...
  addAllListData() {
    ...
    listViews.add(Container(
      padding: EdgeInsets.only(top: 40),
      child: DaysWiseServiceEntryListView(
        startSelectedDate: startDate,
        endSelectedDate: endDate,
        mainScreenAnimation: widget.mainScreenAnimation,
        mainScreenAnimationController: widget.mainScreenAnimationController,
    ...
    listViews.add(Center(child: PieChartSummary(data: bardata,title : "Service Entry Status")));
  }
