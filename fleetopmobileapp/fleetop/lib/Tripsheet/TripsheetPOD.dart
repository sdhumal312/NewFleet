...
class TripsheetPOD extends StatefulWidget {

  final Function tripsheetShowData;

  TripsheetPOD({this.tripsheetShowData, this.tripsheetId});
  final int tripsheetId;

  @override
  _TripsheetPODState createState() => _TripsheetPODState();
}

class _TripsheetPODState extends State<TripsheetPOD> {
  ...
  TextEditingController numberOfPOD = new TextEditingController();
  ...
  getTripsheetShowData(int tripId) async {
    ...
    var response = await ApiCall.getDataFromApi(
        URI.ADD_POD_TRIPSHEET, data, URI.LIVE_URI, context);
  ...
  Future addPOD() async {
    if (!fieldValidation()) {
      ...
      var podData = {
        ...
        'noOfPOD': numberOfPOD.text,
      };

      var response = await ApiCall.getDataFromApi(
          URI.SAVE_POD_TRIPSHEET, podData, URI.LIVE_URI, context);

      FlutterAlert.onSuccessAlert(context, " Tripsheet POD Updated Successfully !", " Tripsheet POD ");
      refreshData();
  ...
  bool fieldValidation() {
    ...
    if (numberOfPOD.text == '' ) {
      FlutterAlert.onErrorAlert(
          context, "Please Enter Number Of POD !", "Error");
      return false;
    }
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              showTripExtraDetails(context, "Driver Details");
                            },
                          ),
                        ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              showTripExtraDetails(context, "Dispatch Details");
                            },
                          ),
                        ),
