...
class TripsheetShowAccountClose extends StatefulWidget {

  final Function tripsheetShowData;

  TripsheetShowAccountClose({this.tripsheetShowData, this.tripsheetId, this.navigateToSearch, this.accountCloseBySearch});
  final int tripsheetId;
  final bool navigateToSearch;
  final bool accountCloseBySearch;

  @override
  _TripsheetShowAccountCloseState createState() => _TripsheetShowAccountCloseState();
}

class _TripsheetShowAccountCloseState extends State<TripsheetShowAccountClose> {
  ...
  void initState() {
    ...
    print("1  = ${widget.tripsheetId}");
    print("2  = $navigateToSearch");
    print("3  = $accountCloseBySearch");
  ...
  getTripsheetShowData(int tripId) async {
    ...
    var response = await ApiCall.getDataFromApi(
        URI.SHOW_ACCOUNT_CLOSE_TRIPSHEET, data, URI.LIVE_URI, context);
    ...
    tripTotalIncome = response['tripTotalincome'].toString();
    ...
    setState(() {
      ...
      print("4.....${tripList['closeACCtripDate']} ");
    });
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          child: Align(
                            alignment: Alignment.center,
                            child: Text(
                                "Account Close Tripsheet Details ",
                                style: new TextStyle(
                                  color: Colors.pink,
                                  fontWeight: FontWeight.w700,
                                  fontSize: 15,
                                  ...
                                  child:  RichText(
                                    text: TextSpan(
                                      children: <TextSpan>[
                                        ...
                                        new TextSpan(
                                            text: "${tripList['closeACCTripNameBy']} ",
                                            style: new TextStyle(
                                              color: AppTheme.darkText,
                                              fontWeight: FontWeight.w700,
                                              fontSize: 15,
                                  ...
                                  child:  RichText(
                                    text: TextSpan(
                                      children: <TextSpan>[
                                        ...
                                        new TextSpan(
                                            text: "${tripList['closeACCTripReference']} ",
                                            style: new TextStyle(
                                              color: AppTheme.darkText,
                                              fontWeight: FontWeight.w700,
                                              fontSize: 15,
                                  ...
                                  child:  RichText(
                                    text: TextSpan(
                                      children: <TextSpan>[
                                        ...
                                        new TextSpan(
                                            text: tripList['closeACCtripDate'] != null ? (DateFormat("yyyy-MM-dd HH:mm:ss").format( new DateTime.fromMicrosecondsSinceEpoch( (tripList['closeACCtripDate']) * 1000) ) ).toString() : '',
                                            style: new TextStyle(
                                              color: AppTheme.darkText,
                                              fontWeight: FontWeight.w700,
                                              fontSize: 15,
