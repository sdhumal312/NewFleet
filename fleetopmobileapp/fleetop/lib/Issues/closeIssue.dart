...
class CloseIssue extends KFDrawerContent {

  final String issueId;
  bool navigateValue;
  CloseIssue({Key key, this.issueId, this.navigateValue});

  @override
  _CloseIssueState createState() => _CloseIssueState();
}

class _CloseIssueState extends State<CloseIssue> with TickerProviderStateMixin {
  ...
  Future _handleSubmitted() async {
     ...
     var issueDetails = {
      ...
      var data = await ApiCall.getDataFromApi(
          URI.CLOSE_ISSUES_DETAILS, issueDetails, URI.LIVE_URI, context);
      ...
      if (data != null) {
             if (data['save'] == true) {
              ...
              FlutterAlert.onInfoAlert(
                  context, "Issue Not Closed, Please contact on Support !", "Info");
            }
        } else {
  ...
  Future<bool> redirectToDisplay(issueId) async => Alert(
        ...
        title: "Success",
        desc: "Issue Successfully Closed !",
        buttons: [
          DialogButton(
            child: Text(
              "OK",
