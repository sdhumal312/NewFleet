...
class ReOpenIssue extends KFDrawerContent {

  final String issueId;
  bool navigateValue;
  ReOpenIssue({Key key, this.issueId, this.navigateValue});

  @override
  _ReOpenIssueState createState() => _ReOpenIssueState();
}

class _ReOpenIssueState extends State<ReOpenIssue> with TickerProviderStateMixin {
  ...
  Future _handleSubmitted() async {
     ...
     var issueDetails = {
      ...
      var data = await ApiCall.getDataFromApi(
          URI.REOPEN_ISSUES_DETAILS, issueDetails, URI.LIVE_URI, context);
      ...
      if (data != null) {
             if (data['save'] == true) {
              ...
              FlutterAlert.onInfoAlert(
                  context, "Issue Not ReOpened, Please contact on Support !", "Info");
            }
        } else {
  ...
  Future<bool> redirectToDisplay(issueId) async => Alert(
        ...
        title: "Success",
        desc: "Issue Successfully ReOpened !",
        buttons: [
          DialogButton(
            child: Text(
              "OK",
