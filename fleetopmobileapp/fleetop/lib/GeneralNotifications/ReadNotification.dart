...
class ReadNotification extends StatefulWidget {
  @override
  _ReadNotificationState createState() => _ReadNotificationState();
}
...
class _ReadNotificationState extends State<ReadNotification> {
  ...
  onPressButton() async {
    ...
    var response = await ApiCall.getDataFromApi(
        URI.GET_READ_NOTI, data, URI.LIVE_URI, context);
  ...
  String maekNotificationString(Map data) {
    ...
    try {
      if (data != null && data.isNotEmpty) {
        ...
        st2 = "Number   : " +
            Utility.checkAndSet(data["partRequisitionNumber"].toString());
