...
class OpenStatusOrder extends StatefulWidget {
  @override
  _OpenStatusOrderState createState() => _OpenStatusOrderState();
}

class _OpenStatusOrderState extends State<OpenStatusOrder> {
  String companyId;
  String userId;
  String email;
  ...
  Widget build(BuildContext context) {
    return WorkOrderUtility.renderMainBodyNew(WorkOrderUtility.OPEN_WO, context,
        openWOList, data, onPressButton, workOrderCount);
  }
}
